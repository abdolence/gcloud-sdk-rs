...
pub struct Session {
    ...
    #[prost(enumeration = "session::Result", tag = "8")]
    pub result: i32,
    ...
    #[prost(string, tag = "12")]
    pub resultdb_root_invocation_id: ::prost::alloc::string::String,
    /// Optional. The ResultDB work unit ID for the session.
    #[prost(string, tag = "15")]
    pub resultdb_work_unit_id: ::prost::alloc::string::String,
    /// Input only. The ResultDB work unit update token for the session.
    #[prost(string, tag = "16")]
    pub resultdb_work_unit_update_token: ::prost::alloc::string::String,
    /// Optional. The type of the test.
    #[prost(enumeration = "session::Type", tag = "13")]
    pub r#type: i32,
...
pub struct TradefedTest {
    ...
    pub shard_args: ::std::collections::HashMap<i32, ::prost::alloc::string::String>,
}
...
pub mod test_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn get_session(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.chromeos.moblab.v1beta1.TestService/GetSession",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/google.chromeos.moblab.v1beta1.TestService/ListSessions",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
