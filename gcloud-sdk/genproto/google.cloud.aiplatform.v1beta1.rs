...
pub struct BatchPredictionJob {
    ...
    pub model_monitoring_stats_anomalies: ::prost::alloc::vec::Vec<
        ModelMonitoringStatsAnomalies,
    >,
    /// Output only. The running status of the model monitoring pipeline.
    #[prost(message, optional, tag = "32")]
    pub model_monitoring_status: ::core::option::Option<
...
pub struct StudySpec {
    ...
    #[prost(message, optional, tag = "10")]
    pub transfer_learning_config: ::core::option::Option<
        study_spec::TransferLearningConfig,
    >,
