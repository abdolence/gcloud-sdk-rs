...
pub struct GmailAdInfo {
    ...
    #[prost(string, optional, tag = "13")]
    pub marketing_image_description: ::core::option::Option<
        ::prost::alloc::string::String,
    >,
    /// Display-call-to-action of the marketing image.
    #[prost(message, optional, tag = "6")]
    pub marketing_image_display_call_to_action: ::core::option::Option<
        DisplayCallToAction,
    >,
...
pub struct RuleBasedUserListInfo {
    ...
    pub rule_based_user_list: ::core::option::Option<
        rule_based_user_list_info::RuleBasedUserList,
    >,
}
