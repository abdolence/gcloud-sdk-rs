...
pub struct AgentAnomaly {
    ...
    pub detector_references: ::prost::alloc::vec::Vec<DetectorReference>,
    /// References to the OpenTelemetry invocations.
    #[prost(message, repeated, tag = "3")]
    pub invocation_references: ::prost::alloc::vec::Vec<InvocationReference>,
}
/// Represents a reference to a specific anomaly detector.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct DetectorReference {
    /// The severity of the detector.
    #[prost(enumeration = "detector_reference::Severity", tag = "1")]
    pub severity: i32,
...
/// Nested message and enum types in `DetectorReference`.
...
pub struct Finding {
    ...
    pub agent_sessions: ::prost::alloc::vec::Vec<AgentSession>,
    /// Details about behavior anomalies detected in AI agents.
    #[prost(message, optional, tag = "90")]
    pub agent_anomaly: ::core::option::Option<AgentAnomaly>,
}
