...
pub mod live_session {
    ...
    pub struct GamSettings {
        ...
        #[prost(oneof = "gam_settings::ManifestFields", tags = "2, 3")]
        pub manifest_fields: ::core::option::Option<gam_settings::ManifestFields>,
    }
    /// Nested message and enum types in `GamSettings`.
    pub mod gam_settings {
        ...
        pub struct GamDash {
            ...
            #[prost(string, tag = "1")]
            pub period_template_uri: ::prost::alloc::string::String,
        }
        /// Extra manifest type specific fields.
        #[allow(clippy::derive_partial_eq_without_eq)]
        #[derive(Clone, PartialEq, ::prost::Oneof)]
        pub enum ManifestFields {
