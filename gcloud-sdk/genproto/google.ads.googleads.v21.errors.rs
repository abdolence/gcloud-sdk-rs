...
pub mod ad_error_enum {
    ...
    pub enum AdError {
        ...
        InvalidYoutubeVideoAssetIdForVideoAdsSequencing = 157,
    }
    impl AdError {
        /// String value of the enum field names used in the ProtoBuf definition.
        ///
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::InvalidYoutubeVideoAssetIdForVideoAdsSequencing => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "INVALID_YOUTUBE_VIDEO_ASSET_ID_FOR_VIDEO_ADS_SEQUENCING" => {
                    Some(Self::InvalidYoutubeVideoAssetIdForVideoAdsSequencing)
                }
                _ => None,
            }
        }
    ...
    impl AdGroupError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::InvalidStatus => "INVALID_STATUS",
                Self::InvalidStepIdForVideoAdsSequencing => {
                    "INVALID_STEP_ID_FOR_VIDEO_ADS_SEQUENCING"
                }
                Self::InvalidAdGroupTypeForVideoAdsSequencing => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "INVALID_STATUS" => Some(Self::InvalidStatus),
                "INVALID_STEP_ID_FOR_VIDEO_ADS_SEQUENCING" => {
                    Some(Self::InvalidStepIdForVideoAdsSequencing)
                }
                "INVALID_AD_GROUP_TYPE_FOR_VIDEO_ADS_SEQUENCING" => {
                    Some(Self::InvalidAdGroupTypeForVideoAdsSequencing)
                }
                "DUPLICATE_STEP_ID" => Some(Self::DuplicateStepId),
                _ => None,
            }
        }
    }
...
pub mod asset_error_enum {
    ...
    pub enum AssetError {
        ...
        PromotionBarcodeInvalidFormat = 42,
        /// Barcode type is not supported.
        UnsupportedBarcodeType = 43,
        /// Promotion QR code cannot contain links.
        PromotionQrCodeCannotContainLinks = 44,
        /// Failed to encode promotion QR code: Invalid format.
        PromotionQrCodeInvalidFormat = 45,
    }
    impl AssetError {
        /// String value of the enum field names used in the ProtoBuf definition.
        ///
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::PromotionBarcodeCannotContainLinks => {
                    "PROMOTION_BARCODE_CANNOT_CONTAIN_LINKS"
                }
                Self::PromotionBarcodeInvalidFormat => "PROMOTION_BARCODE_INVALID_FORMAT",
                Self::UnsupportedBarcodeType => "UNSUPPORTED_BARCODE_TYPE",
                Self::PromotionQrCodeCannotContainLinks => {
                    "PROMOTION_QR_CODE_CANNOT_CONTAIN_LINKS"
                }
                Self::PromotionQrCodeInvalidFormat => "PROMOTION_QR_CODE_INVALID_FORMAT",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "PROMOTION_BARCODE_CANNOT_CONTAIN_LINKS" => {
                    Some(Self::PromotionBarcodeCannotContainLinks)
                }
                "PROMOTION_BARCODE_INVALID_FORMAT" => {
                    Some(Self::PromotionBarcodeInvalidFormat)
                }
                "UNSUPPORTED_BARCODE_TYPE" => Some(Self::UnsupportedBarcodeType),
                "PROMOTION_QR_CODE_CANNOT_CONTAIN_LINKS" => {
                    Some(Self::PromotionQrCodeCannotContainLinks)
                }
                "PROMOTION_QR_CODE_INVALID_FORMAT" => {
                    Some(Self::PromotionQrCodeInvalidFormat)
                }
                _ => None,
            }
        }
...
pub mod bidding_error_enum {
    ...
    pub enum BiddingError {
        ...
        TargetRoasTolerancePercentMillisMustBeInteger = 42,
    }
    impl BiddingError {
        /// String value of the enum field names used in the ProtoBuf definition.
        ///
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::TargetRoasTolerancePercentMillisMustBeInteger => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "TARGET_ROAS_TOLERANCE_PERCENT_MILLIS_MUST_BE_INTEGER" => {
                    Some(Self::TargetRoasTolerancePercentMillisMustBeInteger)
                }
                _ => None,
            }
        }
    ...
    impl CampaignBudgetError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::BudgetBelowPerDayMinimum => "BUDGET_BELOW_PER_DAY_MINIMUM",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "BUDGET_BELOW_PER_DAY_MINIMUM" => Some(Self::BudgetBelowPerDayMinimum),
                _ => None,
            }
        }
    }
    ...
    impl CampaignError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::ThirdPartyIntegrationPartnerNotAllowed => {
                    "THIRD_PARTY_INTEGRATION_PARTNER_NOT_ALLOWED"
                }
                Self::ThirdPartyIntegrationPartnerShareCostNotAllowed => {
                    "THIRD_PARTY_INTEGRATION_PARTNER_SHARE_COST_NOT_ALLOWED"
                }
                Self::DuplicateInteractionType => "DUPLICATE_INTERACTION_TYPE",
                Self::InvalidInteractionType => "INVALID_INTERACTION_TYPE",
                Self::VideoSequenceErrorSequenceDefinitionRequired => {
                    "VIDEO_SEQUENCE_ERROR_SEQUENCE_DEFINITION_REQUIRED"
                }
                Self::AiMaxMustBeEnabled => "AI_MAX_MUST_BE_ENABLED",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "THIRD_PARTY_INTEGRATION_PARTNER_NOT_ALLOWED" => {
                    Some(Self::ThirdPartyIntegrationPartnerNotAllowed)
                }
                "THIRD_PARTY_INTEGRATION_PARTNER_SHARE_COST_NOT_ALLOWED" => {
                    Some(Self::ThirdPartyIntegrationPartnerShareCostNotAllowed)
                }
                "DUPLICATE_INTERACTION_TYPE" => Some(Self::DuplicateInteractionType),
                "INVALID_INTERACTION_TYPE" => Some(Self::InvalidInteractionType),
                "VIDEO_SEQUENCE_ERROR_SEQUENCE_DEFINITION_REQUIRED" => {
                    Some(Self::VideoSequenceErrorSequenceDefinitionRequired)
                }
                "AI_MAX_MUST_BE_ENABLED" => Some(Self::AiMaxMustBeEnabled),
                _ => None,
            }
        }
    }
...
pub mod criterion_error_enum {
    ...
    pub enum CriterionError {
        ...
        ListingGroupErrorInAnotherOperation = 169,
        ...
        ListingGroupTreeWasInvalidBeforeMutation = 170,
    ...
    impl CriterionError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::OnlyInclusionBrandListAllowedForAdGroups => {
                    "ONLY_INCLUSION_BRAND_LIST_ALLOWED_FOR_AD_GROUPS"
                }
                Self::CannotAddRemovedPlacementListSharedSet => {
                    "CANNOT_ADD_REMOVED_PLACEMENT_LIST_SHARED_SET"
                }
                Self::PlacementListSharedSetDoesNotExist => {
                    "PLACEMENT_LIST_SHARED_SET_DOES_NOT_EXIST"
                }
                Self::AiMaxMustBeEnabled => "AI_MAX_MUST_BE_ENABLED",
                Self::NotAvailableForAiMaxCampaigns => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "LISTING_GROUP_ERROR_IN_ANOTHER_OPERATION" => {
                    Some(Self::ListingGroupErrorInAnotherOperation)
                }
                "INVALID_LISTING_GROUP_HIERARCHY" => {
                    Some(Self::InvalidListingGroupHierarchy)
                }
                "LISTING_GROUP_TREE_WAS_INVALID_BEFORE_MUTATION" => {
                    Some(Self::ListingGroupTreeWasInvalidBeforeMutation)
                }
                "LISTING_GROUP_UNIT_CANNOT_HAVE_CHILDREN" => {
                ...
                "ONLY_INCLUSION_BRAND_LIST_ALLOWED_FOR_AD_GROUPS" => {
                    Some(Self::OnlyInclusionBrandListAllowedForAdGroups)
                }
                "CANNOT_ADD_REMOVED_PLACEMENT_LIST_SHARED_SET" => {
                    Some(Self::CannotAddRemovedPlacementListSharedSet)
                }
                "PLACEMENT_LIST_SHARED_SET_DOES_NOT_EXIST" => {
                    Some(Self::PlacementListSharedSetDoesNotExist)
                }
                "AI_MAX_MUST_BE_ENABLED" => Some(Self::AiMaxMustBeEnabled),
                "NOT_AVAILABLE_FOR_AI_MAX_CAMPAIGNS" => {
                    Some(Self::NotAvailableForAiMaxCampaigns)
                }
                "MISSING_EU_POLITICAL_ADVERTISING_SELF_DECLARATION" => {
...
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct FinalUrlExpansionAssetViewErrorEnum {}
/// Nested message and enum types in `FinalUrlExpansionAssetViewErrorEnum`.
pub mod final_url_expansion_asset_view_error_enum {
    ...
    impl FinalUrlExpansionAssetViewError {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::RequiresAdvertisingChannelTypeFilter => {
                    "REQUIRES_ADVERTISING_CHANNEL_TYPE_FILTER"
                }
                Self::InvalidAdvertisingChannelTypeInFilter => {
                    "INVALID_ADVERTISING_CHANNEL_TYPE_IN_FILTER"
                }
                Self::CannotSelectAssetGroup => "CANNOT_SELECT_ASSET_GROUP",
                Self::CannotSelectAdGroup => "CANNOT_SELECT_AD_GROUP",
                Self::RequiresFilterBySingleResource => {
                    "REQUIRES_FILTER_BY_SINGLE_RESOURCE"
                }
                Self::CannotSelectBothAdGroupAndAssetGroup => {
                    "CANNOT_SELECT_BOTH_AD_GROUP_AND_ASSET_GROUP"
                }
                Self::CannotFilterByBothAdGroupAndAssetGroup => {
        ...
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "UNSPECIFIED" => Some(Self::Unspecified),
                "UNKNOWN" => Some(Self::Unknown),
                "MISSING_REQUIRED_FILTER" => Some(Self::MissingRequiredFilter),
                "REQUIRES_ADVERTISING_CHANNEL_TYPE_FILTER" => {
                    Some(Self::RequiresAdvertisingChannelTypeFilter)
                }
                "INVALID_ADVERTISING_CHANNEL_TYPE_IN_FILTER" => {
                    Some(Self::InvalidAdvertisingChannelTypeInFilter)
                }
                "CANNOT_SELECT_ASSET_GROUP" => Some(Self::CannotSelectAssetGroup),
                "CANNOT_SELECT_AD_GROUP" => Some(Self::CannotSelectAdGroup),
                "REQUIRES_FILTER_BY_SINGLE_RESOURCE" => {
                    Some(Self::RequiresFilterBySingleResource)
                }
                "CANNOT_SELECT_BOTH_AD_GROUP_AND_ASSET_GROUP" => {
                    Some(Self::CannotSelectBothAdGroupAndAssetGroup)
                }
                "CANNOT_FILTER_BY_BOTH_AD_GROUP_AND_ASSET_GROUP" => {
                    Some(Self::CannotFilterByBothAdGroupAndAssetGroup)
                }
                _ => None,
            }
        }
...
pub mod error_code {
    ...
    pub enum ErrorCode {
        ...
        #[prost(
            enumeration = "super::final_url_expansion_asset_view_error_enum::FinalUrlExpansionAssetViewError",
            tag = "193"
        )]
        FinalUrlExpansionAssetViewError(i32),
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct BudgetPerDayMinimumErrorDetails {
    ...
    #[prost(int64, tag = "2")]
    pub budget_per_day_minimum_micros: i64,
    ...
    /// field value.
    #[prost(int64, tag = "4")]
    pub minimum_budget_total_amount_micros: i64,
    ...
    /// value.
    #[prost(int64, tag = "5")]
    pub failed_budget_amount_micros: i64,
