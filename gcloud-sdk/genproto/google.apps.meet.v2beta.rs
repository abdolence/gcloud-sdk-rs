...
/// of a space.
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ConnectActiveConferenceRequest {
    /// Required. Resource name of the space.
...
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct ConnectActiveConferenceResponse {
...
pub mod spaces_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// overview](https://developers.google.com/meet/media-api/guides/overview) for
        /// more details about this connection.
        pub async fn connect_active_conference(
            &mut self,
            request: impl tonic::IntoRequest<super::ConnectActiveConferenceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ConnectActiveConferenceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
