...
pub struct AgentGateway {
    ...
    #[deprecated]
    #[prost(
        enumeration = "agent_gateway::Protocol",
        repeated,
        packed = "false",
        tag = "12"
    )]
    ...
    pub registries: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    /// Optional. Network configuration for the AgentGateway.
    #[prost(message, optional, tag = "10")]
    pub network_config: ::core::option::Option<agent_gateway::NetworkConfig>,
    /// Output only. Field for populated AgentGateway card.
    #[prost(message, optional, tag = "11")]
    pub agent_gateway_card: ::core::option::Option<
        agent_gateway::AgentGatewayOutputCard,
    >,
    /// Deployment mode of the network proxy. Exactly one of the fields in this
    /// `oneof` must be set.
    #[prost(oneof = "agent_gateway::DeploymentMode", tags = "8, 9")]
    pub deployment_mode: ::core::option::Option<agent_gateway::DeploymentMode>,
}
/// Nested message and enum types in `AgentGateway`.
pub mod agent_gateway {
    ...
    pub struct GoogleManaged {
        ...
        #[prost(enumeration = "google_managed::GovernedAccessPath", tag = "1")]
        pub governed_access_path: i32,
    }
    /// Nested message and enum types in `GoogleManaged`.
    pub mod google_managed {
        ...
        impl GovernedAccessPath {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    Self::Unspecified => "GOVERNED_ACCESS_PATH_UNSPECIFIED",
                    Self::AgentToAnywhere => "AGENT_TO_ANYWHERE",
            ...
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    "GOVERNED_ACCESS_PATH_UNSPECIFIED" => Some(Self::Unspecified),
                    "AGENT_TO_ANYWHERE" => Some(Self::AgentToAnywhere),
                    "CLIENT_TO_AGENT" => Some(Self::ClientToAgent),
                    _ => None,
                }
            }
        }
    ...
    pub struct NetworkConfig {
        ...
        pub egress: ::core::option::Option<network_config::Egress>,
        /// Optional. Optional DNS peering configuration for connectivity to your
        /// private VPC network.
        #[prost(message, optional, tag = "2")]
        pub dns_peering_config: ::core::option::Option<network_config::DnsPeeringConfig>,
    }
    ...
    pub mod network_config {
        ...
        pub struct Egress {
            ...
            #[prost(message, optional, tag = "2")]
            pub trust_config: ::core::option::Option<egress::TrustConfig>,
        }
        ...
        pub mod egress {
            ...
            pub struct TrustConfig {
                ...
                pub pem_certificates: ::prost::alloc::vec::Vec<
                    ::prost::alloc::string::String,
                >,
            }
        }
    ...
    pub struct AgentGatewayOutputCard {
        ...
        #[prost(string, tag = "1")]
        pub mtls_endpoint: ::prost::alloc::string::String,
        /// Output only. Root Certificates for Agents to validate this AgentGateway
        #[prost(string, repeated, tag = "5")]
        pub root_certificates: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
        /// Output only. Service Account used by Service Extensions to operate.
        #[prost(string, tag = "4")]
        pub service_extensions_service_account: ::prost::alloc::string::String,
    }
...
pub struct ListAgentGatewaysResponse {
    ...
    pub agent_gateways: ::prost::alloc::vec::Vec<AgentGateway>,
...
pub struct CreateAgentGatewayRequest {
    ...
    #[prost(string, tag = "2")]
    pub agent_gateway_id: ::prost::alloc::string::String,
    /// Required. AgentGateway resource to be created.
    #[prost(message, optional, tag = "3")]
    pub agent_gateway: ::core::option::Option<AgentGateway>,
}
...
pub mod extension_chain {
    ...
    pub struct Extension {
        ...
        pub forward_attributes: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
        ...
        #[prost(enumeration = "super::BodySendMode", tag = "14")]
        pub request_body_send_mode: i32,
        ...
        #[prost(enumeration = "super::BodySendMode", tag = "15")]
        pub response_body_send_mode: i32,
...
impl WireFormat {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::ExtAuthzGrpc => "EXT_AUTHZ_GRPC",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            ...
            "EXT_AUTHZ_GRPC" => Some(Self::ExtAuthzGrpc),
            _ => None,
        }
    }
}
...
impl BodySendMode {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "BODY_SEND_MODE_UNSPECIFIED",
            Self::Streamed => "BODY_SEND_MODE_STREAMED",
            Self::FullDuplexStreamed => "BODY_SEND_MODE_FULL_DUPLEX_STREAMED",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
        match value {
            "BODY_SEND_MODE_UNSPECIFIED" => Some(Self::Unspecified),
            "BODY_SEND_MODE_STREAMED" => Some(Self::Streamed),
            "BODY_SEND_MODE_FULL_DUPLEX_STREAMED" => Some(Self::FullDuplexStreamed),
            _ => None,
        }
    }
}
...
pub struct TlsRoute {
    ...
    #[prost(string, repeated, tag = "13")]
    pub target_proxies: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
...
pub mod network_services_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn list_agent_gateways(
            &mut self,
            request: impl tonic::IntoRequest<super::ListAgentGatewaysRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListAgentGatewaysResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_agent_gateway(
            &mut self,
            request: impl tonic::IntoRequest<super::GetAgentGatewayRequest>,
        ) -> std::result::Result<tonic::Response<super::AgentGateway>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
        ...
        pub async fn create_agent_gateway(
            &mut self,
            request: impl tonic::IntoRequest<super::CreateAgentGatewayRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
        ...
        pub async fn update_agent_gateway(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateAgentGatewayRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
        ...
        pub async fn delete_agent_gateway(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteAgentGatewayRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::super::super::longrunning::Operation>,
            tonic::Status,
        > {
