...
pub struct JobStatistics2 {
    ...
    pub object_storage_stats: ::prost::alloc::vec::Vec<ObjectStorageStats>,
}
...
pub struct ObjectStorageStats {
    ...
    #[prost(enumeration = "object_storage_stats::CloudProvider", optional, tag = "1")]
    pub cloud_provider: ::core::option::Option<i32>,
    /// Total bytes read directly from the cloud provider's storage.
    #[prost(int64, optional, tag = "2")]
    pub object_storage_bytes_read: ::core::option::Option<i64>,
    /// Total bytes read from the GCP Lakehouse-internal cache, avoiding an
    /// object storage read.
    #[prost(int64, optional, tag = "3")]
    pub cache_bytes_read: ::core::option::Option<i64>,
}
/// Nested message and enum types in `ObjectStorageStats`.
...
pub struct CopyJobStatistics {
    ...
    /// in-region copy jobs.
    #[prost(string, tag = "3")]
    pub remote_destination_region: ::prost::alloc::string::String,
}
...
pub struct JobStatistics {
    ...
    pub global_query_remote_regions: ::prost::alloc::vec::Vec<
        ::prost::alloc::string::String,
    >,
    /// Output only. The global query that created this job.
    #[prost(message, optional, tag = "28")]
    pub parent_global_query_job: ::core::option::Option<JobReference>,
}
...
pub struct QueryRequest {
    ...
    ///
    /// This feature is not yet available.
    #[prost(enumeration = "query_request::QueryResultsFormat", tag = "29")]
    pub query_results_format: i32,
    /// Results serialization options for `query_results_format` other than
    /// `STRUCT_ENCODING`.
    ///
    /// This feature is not yet available.
    #[prost(oneof = "query_request::ResultsFormatSerializationOptions", tags = "30")]
    pub results_format_serialization_options: ::core::option::Option<
...
pub mod query_request {
    ...
    impl QueryResultsFormat {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "QUERY_RESULTS_FORMAT_UNSPECIFIED",
                Self::StructEncoding => "STRUCT_ENCODING",
                Self::Arrow => "ARROW",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "QUERY_RESULTS_FORMAT_UNSPECIFIED" => Some(Self::Unspecified),
                "STRUCT_ENCODING" => Some(Self::StructEncoding),
...
pub struct QueryResponse {
    ...
    ///
    /// This feature is not yet available.
    #[prost(oneof = "query_response::ResultsSchema", tags = "23")]
    pub results_schema: ::core::option::Option<query_response::ResultsSchema>,
    /// Row data is returned in format when `query_results_format` has been
    /// specified with value other than default `STRUCT_ENCODING`.
    ///
    /// This feature is not yet available.
    #[prost(oneof = "query_response::Results", tags = "24")]
    pub results: ::core::option::Option<query_response::Results>,
}
...
pub mod routine {
    ...
    pub struct Argument {
        ...
        #[prost(message, optional, tag = "7")]
        pub table_type: ::core::option::Option<super::StandardSqlTableType>,
        ...
        impl ArgumentKind {
            ...
            pub fn as_str_name(&self) -> &'static str {
                match self {
                    ...
                    Self::FixedTable => "FIXED_TABLE",
                    Self::AnyTable => "ANY_TABLE",
                }
            }
            /// Creates an enum from field names used in the ProtoBuf definition.
            pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
                match value {
                    ...
                    "FIXED_TABLE" => Some(Self::FixedTable),
                    "ANY_TABLE" => Some(Self::AnyTable),
                    _ => None,
                }
            }
        }
