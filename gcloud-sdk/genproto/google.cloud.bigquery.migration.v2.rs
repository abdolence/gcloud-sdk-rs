...
pub struct AssessmentTaskDetails {
    ...
    pub feature_handle: ::core::option::Option<AssessmentFeatureHandle>,
}
...
pub struct AssessmentFeatureHandle {
    ...
    pub add_shareable_dataset: ::core::option::Option<bool>,
}
...
pub struct TranslationDetails {
    ...
    #[prost(message, optional, tag = "6")]
    pub suggestion_config: ::core::option::Option<SuggestionConfig>,
}
/// The configuration for the suggestion if requested as a target type.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct SuggestionConfig {
    ...
    #[prost(message, repeated, tag = "1")]
    pub skip_suggestion_steps: ::prost::alloc::vec::Vec<SuggestionStep>,
}
/// Suggestion step to skip.
#[derive(Clone, Copy, PartialEq, Eq, Hash, ::prost::Message)]
pub struct SuggestionStep {
    /// The type of suggestion.
    #[prost(enumeration = "suggestion_step::SuggestionType", tag = "1")]
    pub suggestion_type: i32,
    /// The rewrite target.
    #[prost(enumeration = "suggestion_step::RewriteTarget", tag = "2")]
    pub rewrite_target: i32,
}
/// Nested message and enum types in `SuggestionStep`.
pub mod suggestion_step {
    ...
    pub enum SuggestionType {
        ...
        Unspecified = 0,
        /// Query customization.
        QueryCustomization = 1,
        /// Translation explanation.
        TranslationExplanation = 2,
    }
    impl SuggestionType {
        /// String value of the enum field names used in the ProtoBuf definition.
        ///
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::QueryCustomization => "QUERY_CUSTOMIZATION",
                Self::TranslationExplanation => "TRANSLATION_EXPLANATION",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                ...
                "QUERY_CUSTOMIZATION" => Some(Self::QueryCustomization),
                "TRANSLATION_EXPLANATION" => Some(Self::TranslationExplanation),
                _ => None,
            }
        }
    }
    ...
    impl RewriteTarget {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::Unspecified => "REWRITE_TARGET_UNSPECIFIED",
                Self::SourceSql => "SOURCE_SQL",
                Self::TargetSql => "TARGET_SQL",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
            match value {
                "REWRITE_TARGET_UNSPECIFIED" => Some(Self::Unspecified),
                "SOURCE_SQL" => Some(Self::SourceSql),
                "TARGET_SQL" => Some(Self::TargetSql),
                _ => None,
            }
        }
    }
...
pub struct SourceSpec {
    ...
    #[prost(oneof = "source_spec::Source", tags = "1, 2, 4")]
...
pub mod source_spec {
    ...
    pub enum Source {
        ...
        #[prost(string, tag = "4")]
        GcsFilePath(::prost::alloc::string::String),
    }
}
...
pub struct MigrationTask {
    ...
    #[prost(oneof = "migration_task::TaskDetails", tags = "12, 14, 16")]
