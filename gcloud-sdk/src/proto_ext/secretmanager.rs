...
impl prost::Message for SecretPayload {
    ...
    fn merge_field<B>(&mut self, tag: u32,
        ...
        match tag {
            1u32 => {
                ::prost::encoding::bytes::merge(wire_type, self.data.ref_sensitive_value_mut(), buf,
            ...
            2u32 => {
                ...
                ::prost::encoding::int64::merge(wire_type,
                                                ...
                                                buf,
                                                ctx).map_err(|mut error|
                    { error.push(STRUCT_NAME, "data_crc32c"); error })
            }
            _ =>
    ...
    fn encoded_len(&self) -> usize {
        0 +
            ...
            self.data_crc32c.as_ref().map_or(0,
                                             |value| ::prost::encoding::int64::encoded_len(2u32, value))
    }
    fn clear(&mut self) {
