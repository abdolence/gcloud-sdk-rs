...
pub mod google {
    ...
    pub mod analytics {
        ...
        pub mod cloud {
            #[cfg(any(feature = "google-analytics-cloud"))]
            include_proto!("google.analytics.cloud");
        }
        pub mod data {
            pub mod v1alpha {
    ...
    pub mod api {
        #[cfg(
            any(
                ...
                feature = "google-cloud-productregistry-v1",
    ...
    pub mod backstory {
        #[cfg(any(feature = "google-backstory"))]
        include_proto!("google.backstory");
    }
    pub mod bigtable {
        pub mod admin {
            pub mod v2 {
    ...
    pub mod cloud {
        ...
        pub mod agentregistry {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-agentregistry-v1"))]
                include_proto!("google.cloud.agentregistry.v1");
            }
        }
        pub mod aiplatform {
            pub mod logging {
        ...
        pub mod apihub {
            pub mod v1 {
                ...
                include_proto!("google.cloud.apihub.v1");
            }
        }
        pub mod apiregistry {
            pub mod v1 {
        ...
        pub mod appoptimize {
            pub mod v1beta {
                #[cfg(any(feature = "google-cloud-appoptimize-v1beta"))]
                include_proto!("google.cloud.appoptimize.v1beta");
            }
        }
        pub mod apptopology {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-apptopology-v1"))]
                include_proto!("google.cloud.apptopology.v1");
            }
        }
        pub mod asset {
            pub mod v1 {
        ...
        pub mod auditmanager {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-auditmanager-v1"))]
                include_proto!("google.cloud.auditmanager.v1");
            }
        }
        pub mod automl {
            pub mod v1 {
        ...
        pub mod biglake {
            ...
            pub mod v1 {
                ...
                include_proto!("google.cloud.biglake.v1");
            }
        }
        pub mod bigquery {
        ...
        pub mod capacityplanner {
            pub mod v1beta {
                #[cfg(any(feature = "google-cloud-capacityplanner-v1beta"))]
                include_proto!("google.cloud.capacityplanner.v1beta");
            }
        }
        ...
        pub mod chronicle {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-chronicle-v1"))]
                include_proto!("google.cloud.chronicle.v1");
            }
        }
        ...
        pub mod cloudsecuritycompliance {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-cloudsecuritycompliance-v1"))]
                include_proto!("google.cloud.cloudsecuritycompliance.v1");
            }
        }
        pub mod cloudsetup {
            pub mod logging {
        ...
        pub mod commerceproducer {
            pub mod v1beta {
                #[cfg(any(feature = "google-cloud-commerceproducer-v1beta"))]
                include_proto!("google.cloud.commerceproducer.v1beta");
            }
        }
        pub mod common {
            #[cfg(
        ...
        pub mod databasecenter {
            pub mod v1beta {
                #[cfg(any(feature = "google-cloud-databasecenter-v1beta"))]
                include_proto!("google.cloud.databasecenter.v1beta");
            }
        }
        pub mod datacatalog {
            pub mod lineage {
        ...
        pub mod devicestreaming {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-devicestreaming-v1"))]
                include_proto!("google.cloud.devicestreaming.v1");
            }
        }
        pub mod dialogflow {
            pub mod cx {
        ...
        pub mod eventarc {
            pub mod logging {
                pub mod v1 {
                    #[cfg(any(feature = "google-cloud-eventarc-logging-v1"))]
                    include_proto!("google.cloud.eventarc.logging.v1");
                }
            }
            pub mod publishing {
                pub mod v1 {
        ...
        pub mod faulttesting {
            pub mod v1alpha {
                #[cfg(any(feature = "google-cloud-faulttesting-v1alpha"))]
                include_proto!("google.cloud.faulttesting.v1alpha");
            }
        }
        pub mod filestore {
            pub mod v1 {
        ...
        pub mod financialservices {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-financialservices-v1"))]
                include_proto!("google.cloud.financialservices.v1");
            }
        }
        pub mod ftp {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-ftp-v1"))]
                include_proto!("google.cloud.ftp.v1");
            }
        }
        pub mod functions {
            pub mod v1 {
        ...
        pub mod gkerecommender {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-gkerecommender-v1"))]
                include_proto!("google.cloud.gkerecommender.v1");
            }
        }
        ...
        pub mod iamconnectorcredentials {
            pub mod v1alpha {
                #[cfg(any(feature = "google-cloud-iamconnectorcredentials-v1alpha"))]
                include_proto!("google.cloud.iamconnectorcredentials.v1alpha");
            }
        }
        pub mod iap {
            pub mod v1 {
        ...
        pub mod licensemanager {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-licensemanager-v1"))]
                include_proto!("google.cloud.licensemanager.v1");
            }
        }
        ...
        pub mod locationfinder {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-locationfinder-v1"))]
                include_proto!("google.cloud.locationfinder.v1");
            }
        }
        pub mod lustre {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-lustre-v1"))]
                include_proto!("google.cloud.lustre.v1");
            }
        }
        pub mod maintenance {
            pub mod api {
        ...
        pub mod managedkafka {
            pub mod schemaregistry {
                pub mod v1 {
                    #[cfg(any(feature = "google-cloud-managedkafka-schemaregistry-v1"))]
                    include_proto!("google.cloud.managedkafka.schemaregistry.v1");
                }
            }
            pub mod v1 {
        ...
        pub mod numberregistry {
            pub mod v1alpha {
                #[cfg(any(feature = "google-cloud-numberregistry-v1alpha"))]
                include_proto!("google.cloud.numberregistry.v1alpha");
            }
        }
        ...
        pub mod parametermanager {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-parametermanager-v1"))]
                include_proto!("google.cloud.parametermanager.v1");
            }
        }
        ...
        pub mod productregistry {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-productregistry-v1"))]
                include_proto!("google.cloud.productregistry.v1");
            }
        }
        pub mod pubsublite {
            pub mod v1 {
        ...
        pub mod saasplatform {
            pub mod saasservicemgmt {
                ...
                pub mod v1beta1 {
                    ...
                    include_proto!("google.cloud.saasplatform.saasservicemgmt.v1beta1");
                }
            }
        }
        pub mod scheduler {
        ...
        pub mod storagebatchoperations {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-storagebatchoperations-v1"))]
                include_proto!("google.cloud.storagebatchoperations.v1");
            }
        }
        ...
        pub mod universalledger {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-universalledger-v1"))]
                include_proto!("google.cloud.universalledger.v1");
            }
        }
        ...
        pub mod workloadidentity {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-workloadidentity-v1"))]
                include_proto!("google.cloud.workloadidentity.v1");
            }
        }
        pub mod workloadmanager {
            pub mod v1 {
                #[cfg(any(feature = "google-cloud-workloadmanager-v1"))]
                include_proto!("google.cloud.workloadmanager.v1");
            }
        }
    ...
    pub mod compute {
        pub mod logging {
            pub mod agentcontrolplane {
                pub mod v1 {
                    #[cfg(any(feature = "google-compute-logging-agentcontrolplane-v1"))]
                    include_proto!("google.compute.logging.agentcontrolplane.v1");
                }
            }
            pub mod dr {
                pub mod v1 {
    ...
    pub mod devtools {
        pub mod artifactregistry {
            pub mod logging {
                pub mod v1 {
                    #[cfg(any(feature = "google-devtools-artifactregistry-logging-v1"))]
                    include_proto!("google.devtools.artifactregistry.logging.v1");
                }
            }
            pub mod v1 {
    ...
    pub mod maps {
        ...
        pub mod areainsights {
            pub mod v1 {
                ...
                include_proto!("google.maps.areainsights.v1");
            }
        }
        pub mod geocode {
            pub mod v4 {
                #[cfg(any(feature = "google-maps-geocode-v4"))]
                include_proto!("google.maps.geocode.v4");
            }
        }
        pub mod isochrones {
            pub mod v1 {
                #[cfg(any(feature = "google-maps-isochrones-v1"))]
                include_proto!("google.maps.isochrones.v1");
            }
        }
        pub mod mapmanagement {
            pub mod v2 {
        ...
        pub mod navconnect {
            pub mod v1 {
                #[cfg(any(feature = "google-maps-navconnect-v1"))]
                include_proto!("google.maps.navconnect.v1");
            }
        }
        pub mod places {
            pub mod v1 {
        ...
        pub mod weather {
            pub mod v1 {
                #[cfg(any(feature = "google-maps-weather-v1"))]
                include_proto!("google.maps.weather.v1");
            }
        }
    }
    ...
    pub mod security {
        ...
        pub mod safebrowsingohttpgateway {
            pub mod v1 {
                #[cfg(any(feature = "google-security-safebrowsingohttpgateway-v1"))]
                include_proto!("google.security.safebrowsingohttpgateway.v1");
            }
        }
    }
    pub mod spanner {
        pub mod adapter {
            pub mod v1 {
                #[cfg(any(feature = "google-spanner-adapter-v1"))]
                include_proto!("google.spanner.adapter.v1");
            }
        }
        pub mod admin {
            pub mod database {
    ...
    pub mod storage {
        ...
        pub mod platformlogs {
            pub mod v1 {
                #[cfg(any(feature = "google-storage-platformlogs-v1"))]
                include_proto!("google.storage.platformlogs.v1");
            }
        }
        pub mod v1 {
