...
pub struct V1LogEntry {
    ...
    pub http_request:
        Option<Box<crate::google_rest_apis::servicecontrol_v1::models::V1HttpRequest>>,
    ...
    pub monitored_resource_labels: Option<::std::collections::HashMap<String, String>>,
    /// Required. The log to which this log entry belongs. Examples: `\"syslog\"`, `\"book_log\"`.
    #[serde(rename = "name", skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[serde(rename = "operation", skip_serializing_if = "Option::is_none")]
    pub operation:
        Option<Box<crate::google_rest_apis::servicecontrol_v1::models::V1LogEntryOperation>>,
    ...
    pub source_location:
        Option<Box<crate::google_rest_apis::servicecontrol_v1::models::V1LogEntrySourceLocation>>,
