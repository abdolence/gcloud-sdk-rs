...
pub struct LogEntry {
    ...
    pub http_request: Option<Box<models::HttpRequest>>,
    ...
    pub operation: Option<Box<models::LogEntryOperation>>,
    ...
    pub source_location: Option<Box<models::LogEntrySourceLocation>>,
