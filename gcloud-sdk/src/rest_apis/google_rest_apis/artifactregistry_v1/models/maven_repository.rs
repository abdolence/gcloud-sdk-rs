...
pub struct MavenRepository {
    ...
    pub custom_repository: Option<Box<models::GoogleDevtoolsArtifactregistryV1RemoteRepositoryConfigMavenRepositoryCustomRepository>>,
