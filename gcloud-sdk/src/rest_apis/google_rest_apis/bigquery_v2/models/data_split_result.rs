...
pub struct DataSplitResult {
    ...
    pub test_table: Option<Box<crate::google_rest_apis::bigquery_v2::models::TableReference>>,
    #[serde(rename = "trainingTable", skip_serializing_if = "Option::is_none")]
    pub training_table: Option<Box<crate::google_rest_apis::bigquery_v2::models::TableReference>>,
}
