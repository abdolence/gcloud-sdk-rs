...
pub struct ArimaForecastingMetrics {
    ...
    pub arima_fitting_metrics:
        Option<Vec<crate::google_rest_apis::bigquery_v2::models::ArimaFittingMetrics>>,
    /// Repeated as there can be many metric sets (one for each model) in auto-arima and the large-scale case.
    #[serde(
        rename = "arimaSingleModelForecastingMetrics",
        skip_serializing_if = "Option::is_none"
    )]
    pub arima_single_model_forecasting_metrics: Option<
        Vec<crate::google_rest_apis::bigquery_v2::models::ArimaSingleModelForecastingMetrics>,
    >,
    ...
    pub non_seasonal_order: Option<Vec<crate::google_rest_apis::bigquery_v2::models::ArimaOrder>>,
