...
pub struct TrainingRun {
    ...
    pub class_level_global_explanations:
        Option<Vec<crate::google_rest_apis::bigquery_v2::models::GlobalExplanation>>,
    #[serde(rename = "dataSplitResult", skip_serializing_if = "Option::is_none")]
    pub data_split_result:
        Option<Box<crate::google_rest_apis::bigquery_v2::models::DataSplitResult>>,
    #[serde(rename = "evaluationMetrics", skip_serializing_if = "Option::is_none")]
    pub evaluation_metrics:
        Option<Box<crate::google_rest_apis::bigquery_v2::models::EvaluationMetrics>>,
    #[serde(
        rename = "modelLevelGlobalExplanation",
        skip_serializing_if = "Option::is_none"
    )]
    pub model_level_global_explanation:
        Option<Box<crate::google_rest_apis::bigquery_v2::models::GlobalExplanation>>,
    /// Output only. Output of each iteration run, results.size() <= max_iterations.
    #[serde(rename = "results", skip_serializing_if = "Option::is_none")]
    pub results: Option<Vec<crate::google_rest_apis::bigquery_v2::models::IterationResult>>,
    /// Output only. The start time of this training run.
    #[serde(rename = "startTime", skip_serializing_if = "Option::is_none")]
    pub start_time: Option<String>,
    #[serde(rename = "trainingOptions", skip_serializing_if = "Option::is_none")]
    pub training_options:
        Option<Box<crate::google_rest_apis::bigquery_v2::models::TrainingOptions>>,
