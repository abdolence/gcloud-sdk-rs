...
pub struct ExternalDataConfiguration {
    ...
    pub avro_options: Option<Box<crate::google_rest_apis::bigquery_v2::models::AvroOptions>>,
    #[serde(rename = "bigtableOptions", skip_serializing_if = "Option::is_none")]
    pub bigtable_options:
        Option<Box<crate::google_rest_apis::bigquery_v2::models::BigtableOptions>>,
    ...
    pub csv_options: Option<Box<crate::google_rest_apis::bigquery_v2::models::CsvOptions>>,
    ...
    pub google_sheets_options:
        Option<Box<crate::google_rest_apis::bigquery_v2::models::GoogleSheetsOptions>>,
    #[serde(
