...
pub struct QueryParameterType {
    ...
    pub array_type: Option<Box<crate::google_rest_apis::bigquery_v2::models::QueryParameterType>>,
    /// [Optional] The types of the fields of this struct, in order, if this is a struct.
    #[serde(rename = "structTypes", skip_serializing_if = "Option::is_none")]
    pub struct_types: Option<
        Vec<crate::google_rest_apis::bigquery_v2::models::QueryParameterTypeStructTypesInner>,
    >,
