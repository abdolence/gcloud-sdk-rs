...
pub struct Model {
    ...
    pub feature_columns:
        Option<Vec<crate::google_rest_apis::bigquery_v2::models::StandardSqlField>>,
    /// Optional. A descriptive name for this model.
    #[serde(rename = "friendlyName", skip_serializing_if = "Option::is_none")]
    pub friendly_name: Option<String>,
    #[serde(rename = "hparamSearchSpaces", skip_serializing_if = "Option::is_none")]
    pub hparam_search_spaces:
        Option<Box<crate::google_rest_apis::bigquery_v2::models::HparamSearchSpaces>>,
    ...
    pub hparam_trials: Option<Vec<crate::google_rest_apis::bigquery_v2::models::HparamTuningTrial>>,
    /// Output only. Label columns that were used to train this model. The output of the model will have a \"predicted_\" prefix to these columns.
    #[serde(rename = "labelColumns", skip_serializing_if = "Option::is_none")]
    pub label_columns: Option<Vec<crate::google_rest_apis::bigquery_v2::models::StandardSqlField>>,
    ...
    pub model_reference: Option<Box<crate::google_rest_apis::bigquery_v2::models::ModelReference>>,
    ...
    pub training_runs: Option<Vec<crate::google_rest_apis::bigquery_v2::models::TrainingRun>>,
}
