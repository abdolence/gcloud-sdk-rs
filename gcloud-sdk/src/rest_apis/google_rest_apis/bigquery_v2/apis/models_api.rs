...
pub struct BigqueryPeriodModelsPeriodPatchParams {
    ...
    /// Deprecated. Please use quotaUser instead.
    pub user_ip: Option<String>,
    pub model: Option<crate::google_rest_apis::bigquery_v2::models::Model>,
}
...
pub async fn bigquery_models_get(
    ...
    crate::google_rest_apis::bigquery_v2::models::Model,
    Error<BigqueryPeriodModelsPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_models_list(
    ...
    crate::google_rest_apis::bigquery_v2::models::ListModelsResponse,
    Error<BigqueryPeriodModelsPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_models_patch(
    ...
    crate::google_rest_apis::bigquery_v2::models::Model,
    Error<BigqueryPeriodModelsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
