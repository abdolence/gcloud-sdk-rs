...
pub struct BigqueryPeriodTabledataPeriodInsertAllParams {
    ...
    pub table_data_insert_all_request:
        Option<crate::google_rest_apis::bigquery_v2::models::TableDataInsertAllRequest>,
}
...
pub async fn bigquery_tabledata_insert_all(
    ...
    crate::google_rest_apis::bigquery_v2::models::TableDataInsertAllResponse,
    Error<BigqueryPeriodTabledataPeriodInsertAllError>,
> {
...
pub async fn bigquery_tabledata_list(
    ...
    crate::google_rest_apis::bigquery_v2::models::TableDataList,
    Error<BigqueryPeriodTabledataPeriodListError>,
> {
    let local_var_configuration = configuration;
