...
pub async fn bigquery_projects_get_service_account(
    ...
    crate::google_rest_apis::bigquery_v2::models::GetServiceAccountResponse,
...
pub async fn bigquery_projects_list(
    ...
    crate::google_rest_apis::bigquery_v2::models::ProjectList,
    Error<BigqueryPeriodProjectsPeriodListError>,
> {
    let local_var_configuration = configuration;
