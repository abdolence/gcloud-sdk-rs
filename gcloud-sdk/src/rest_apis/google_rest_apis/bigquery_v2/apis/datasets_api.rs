...
pub struct BigqueryPeriodDatasetsPeriodInsertParams {
    ...
    /// Deprecated. Please use quotaUser instead.
    pub user_ip: Option<String>,
    pub dataset: Option<crate::google_rest_apis::bigquery_v2::models::Dataset>,
}
...
pub async fn bigquery_datasets_get(
    ...
    crate::google_rest_apis::bigquery_v2::models::Dataset,
    Error<BigqueryPeriodDatasetsPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_datasets_insert(
    ...
    crate::google_rest_apis::bigquery_v2::models::Dataset,
    Error<BigqueryPeriodDatasetsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_datasets_list(
    ...
    crate::google_rest_apis::bigquery_v2::models::DatasetList,
    Error<BigqueryPeriodDatasetsPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_datasets_patch(
    ...
    crate::google_rest_apis::bigquery_v2::models::Dataset,
    Error<BigqueryPeriodDatasetsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_datasets_update(
    ...
    crate::google_rest_apis::bigquery_v2::models::Dataset,
    Error<BigqueryPeriodDatasetsPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
