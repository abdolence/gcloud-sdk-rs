...
pub struct BigqueryPeriodTablesPeriodGetIamPolicyParams {
    ...
    /// Deprecated. Please use quotaUser instead.
    pub user_ip: Option<String>,
    pub get_iam_policy_request:
        Option<crate::google_rest_apis::bigquery_v2::models::GetIamPolicyRequest>,
}
...
pub struct BigqueryPeriodTablesPeriodInsertParams {
    ...
    /// Deprecated. Please use quotaUser instead.
    pub user_ip: Option<String>,
    pub table: Option<crate::google_rest_apis::bigquery_v2::models::Table>,
}
...
pub struct BigqueryPeriodTablesPeriodSetIamPolicyParams {
    ...
    /// Deprecated. Please use quotaUser instead.
    pub user_ip: Option<String>,
    pub set_iam_policy_request:
        Option<crate::google_rest_apis::bigquery_v2::models::SetIamPolicyRequest>,
}
...
pub struct BigqueryPeriodTablesPeriodTestIamPermissionsParams {
    ...
    /// Deprecated. Please use quotaUser instead.
    pub user_ip: Option<String>,
    pub test_iam_permissions_request:
        Option<crate::google_rest_apis::bigquery_v2::models::TestIamPermissionsRequest>,
}
...
pub async fn bigquery_tables_get(
    ...
    crate::google_rest_apis::bigquery_v2::models::Table,
    Error<BigqueryPeriodTablesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_tables_get_iam_policy(
    ...
    crate::google_rest_apis::bigquery_v2::models::Policy,
    Error<BigqueryPeriodTablesPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_tables_insert(
    ...
    crate::google_rest_apis::bigquery_v2::models::Table,
    Error<BigqueryPeriodTablesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_tables_list(
    ...
    crate::google_rest_apis::bigquery_v2::models::TableList,
    Error<BigqueryPeriodTablesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_tables_patch(
    ...
    crate::google_rest_apis::bigquery_v2::models::Table,
    Error<BigqueryPeriodTablesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_tables_set_iam_policy(
    ...
    crate::google_rest_apis::bigquery_v2::models::Policy,
    Error<BigqueryPeriodTablesPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_tables_test_iam_permissions(
    ...
    crate::google_rest_apis::bigquery_v2::models::TestIamPermissionsResponse,
...
pub async fn bigquery_tables_update(
    ...
    crate::google_rest_apis::bigquery_v2::models::Table,
    Error<BigqueryPeriodTablesPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
