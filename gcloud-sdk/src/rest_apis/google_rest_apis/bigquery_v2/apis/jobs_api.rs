...
pub struct BigqueryPeriodJobsPeriodInsertParams {
    ...
    /// Deprecated. Please use quotaUser instead.
    pub user_ip: Option<String>,
    pub job: Option<crate::google_rest_apis::bigquery_v2::models::Job>,
}
...
pub struct BigqueryPeriodJobsPeriodQueryParams {
    ...
    /// Deprecated. Please use quotaUser instead.
    pub user_ip: Option<String>,
    pub query_request: Option<crate::google_rest_apis::bigquery_v2::models::QueryRequest>,
}
...
pub async fn bigquery_jobs_cancel(
    ...
    crate::google_rest_apis::bigquery_v2::models::JobCancelResponse,
    Error<BigqueryPeriodJobsPeriodCancelError>,
> {
...
pub async fn bigquery_jobs_get(
    ...
    crate::google_rest_apis::bigquery_v2::models::Job,
    Error<BigqueryPeriodJobsPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_jobs_get_query_results(
    ...
    crate::google_rest_apis::bigquery_v2::models::GetQueryResultsResponse,
    Error<BigqueryPeriodJobsPeriodGetQueryResultsError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_jobs_insert(
    ...
    crate::google_rest_apis::bigquery_v2::models::Job,
    Error<BigqueryPeriodJobsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_jobs_list(
    ...
    crate::google_rest_apis::bigquery_v2::models::JobList,
    Error<BigqueryPeriodJobsPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn bigquery_jobs_query(
    ...
    crate::google_rest_apis::bigquery_v2::models::QueryResponse,
    Error<BigqueryPeriodJobsPeriodQueryError>,
> {
    let local_var_configuration = configuration;
