...
pub struct InstanceGroupManagerUpdatePolicy {
    ...
    pub max_surge: Option<Box<crate::google_rest_apis::compute_v1::models::FixedOrPercent>>,
    #[serde(rename = "maxUnavailable", skip_serializing_if = "Option::is_none")]
    pub max_unavailable: Option<Box<crate::google_rest_apis::compute_v1::models::FixedOrPercent>>,
