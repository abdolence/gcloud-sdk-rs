...
pub struct InstantSnapshotAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::InstantSnapshotsScopedList>>,
...
impl InstantSnapshotAggregatedList {
    pub fn new() -> InstantSnapshotAggregatedList {
