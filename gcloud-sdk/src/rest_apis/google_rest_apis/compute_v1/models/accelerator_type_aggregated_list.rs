...
pub struct AcceleratorTypeAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::AcceleratorTypesScopedList>>,
...
impl AcceleratorTypeAggregatedList {
    pub fn new() -> AcceleratorTypeAggregatedList {
