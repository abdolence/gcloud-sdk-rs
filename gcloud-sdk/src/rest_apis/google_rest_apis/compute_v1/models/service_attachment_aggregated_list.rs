...
pub struct ServiceAttachmentAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::ServiceAttachmentsScopedList>>,
    /// Type of resource.
...
impl ServiceAttachmentAggregatedList {
    /// Contains a list of ServiceAttachmentsScopedList.
    pub fn new() -> ServiceAttachmentAggregatedList {
