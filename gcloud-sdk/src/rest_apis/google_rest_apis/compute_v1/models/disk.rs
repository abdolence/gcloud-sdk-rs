...
pub struct Disk {
    ...
    pub async_primary_disk:
        Option<Box<crate::google_rest_apis::compute_v1::models::DiskAsyncReplication>>,
    /// [Output Only] A list of disks this disk is asynchronously replicated to.
    #[serde(
        rename = "asyncSecondaryDisks",
        skip_serializing_if = "Option::is_none"
    )]
    pub async_secondary_disks: Option<
        ::std::collections::HashMap<
            String,
            crate::google_rest_apis::compute_v1::models::DiskAsyncReplicationList,
        >,
    >,
    ...
    pub params: Option<Box<crate::google_rest_apis::compute_v1::models::DiskParams>>,
