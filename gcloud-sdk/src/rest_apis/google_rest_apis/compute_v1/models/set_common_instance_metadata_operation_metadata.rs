...
pub struct SetCommonInstanceMetadataOperationMetadata {
    ...
    #[serde(rename = "perLocationOperations", skip_serializing_if = "Option::is_none")]
    pub per_location_operations: Option<::std::collections::HashMap<String, crate::google_rest_apis::compute_v1::models::SetCommonInstanceMetadataOperationMetadataPerLocationOperationInfo>>,
}
