...
pub struct AllocationAggregateReservation {
    ...
    pub in_use_resources: Option<Vec<crate::google_rest_apis::compute_v1::models::AllocationAggregateReservationReservedResourceInfo>>,
    /// List of reserved resources (CPUs, memory, accelerators).
    #[serde(rename = "reservedResources", skip_serializing_if = "Option::is_none")]
    pub reserved_resources: Option<Vec<crate::google_rest_apis::compute_v1::models::AllocationAggregateReservationReservedResourceInfo>>,
