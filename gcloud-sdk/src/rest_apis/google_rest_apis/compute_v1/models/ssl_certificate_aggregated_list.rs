...
pub struct SslCertificateAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::SslCertificatesScopedList>>,
...
impl SslCertificateAggregatedList {
    pub fn new() -> SslCertificateAggregatedList {
