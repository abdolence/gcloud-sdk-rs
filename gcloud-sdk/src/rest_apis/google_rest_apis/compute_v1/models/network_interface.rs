...
pub struct NetworkInterface {
    ...
    pub access_configs: Option<Vec<crate::google_rest_apis::compute_v1::models::AccessConfig>>,
    /// An array of alias IP ranges for this network interface. You can only specify this field for network interfaces in VPC networks.
    #[serde(rename = "aliasIpRanges", skip_serializing_if = "Option::is_none")]
    pub alias_ip_ranges: Option<Vec<crate::google_rest_apis::compute_v1::models::AliasIpRange>>,
    ...
    pub ipv6_access_configs: Option<Vec<crate::google_rest_apis::compute_v1::models::AccessConfig>>,
