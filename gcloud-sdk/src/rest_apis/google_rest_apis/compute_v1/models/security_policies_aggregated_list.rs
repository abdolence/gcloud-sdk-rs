...
pub struct SecurityPoliciesAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::SecurityPoliciesScopedList>>,
...
impl SecurityPoliciesAggregatedList {
    pub fn new() -> SecurityPoliciesAggregatedList {
