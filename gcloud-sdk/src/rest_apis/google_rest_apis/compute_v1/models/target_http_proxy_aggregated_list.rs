...
pub struct TargetHttpProxyAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::TargetHttpProxiesScopedList>>,
...
impl TargetHttpProxyAggregatedList {
    pub fn new() -> TargetHttpProxyAggregatedList {
