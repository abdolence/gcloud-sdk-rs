...
pub struct TargetInstanceAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::TargetInstancesScopedList>>,
    /// Type of resource.
...
impl TargetInstanceAggregatedList {
    pub fn new() -> TargetInstanceAggregatedList {
