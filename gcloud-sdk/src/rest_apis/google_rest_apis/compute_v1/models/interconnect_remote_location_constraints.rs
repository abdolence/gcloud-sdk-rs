...
pub struct InterconnectRemoteLocationConstraints {
    ...
    #[serde(rename = "portPairRemoteLocation", skip_serializing_if = "Option::is_none")]
    ...
    pub subnet_length_range: Option<Box<crate::google_rest_apis::compute_v1::models::InterconnectRemoteLocationConstraintsSubnetLengthRange>>,
}
