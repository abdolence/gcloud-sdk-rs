...
pub struct BackendServiceAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::BackendServicesScopedList>>,
    /// Type of resource.
...
impl BackendServiceAggregatedList {
    /// Contains a list of BackendServicesScopedList.
    pub fn new() -> BackendServiceAggregatedList {
