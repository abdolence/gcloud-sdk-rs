...
pub struct RouterStatusBgpPeerStatus {
    ...
    pub advertised_routes: Option<Vec<crate::google_rest_apis::compute_v1::models::Route>>,
    #[serde(rename = "bfdStatus", skip_serializing_if = "Option::is_none")]
    pub bfd_status: Option<Box<crate::google_rest_apis::compute_v1::models::BfdStatus>>,
