...
pub struct ResourcePolicyInstanceSchedulePolicy {
    ...
    pub vm_start_schedule: Option<Box<crate::google_rest_apis::compute_v1::models::ResourcePolicyInstanceSchedulePolicySchedule>>,
    #[serde(rename = "vmStopSchedule", skip_serializing_if = "Option::is_none")]
    pub vm_stop_schedule: Option<Box<crate::google_rest_apis::compute_v1::models::ResourcePolicyInstanceSchedulePolicySchedule>>,
}
