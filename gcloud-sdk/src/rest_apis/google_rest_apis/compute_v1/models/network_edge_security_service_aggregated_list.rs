...
pub struct NetworkEdgeSecurityServiceAggregatedList {
    ...
    pub items:
        Option<std::collections::HashMap<String, models::NetworkEdgeSecurityServicesScopedList>>,
...
impl NetworkEdgeSecurityServiceAggregatedList {
    pub fn new() -> NetworkEdgeSecurityServiceAggregatedList {
