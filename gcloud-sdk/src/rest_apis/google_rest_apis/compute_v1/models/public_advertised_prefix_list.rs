...
pub struct PublicAdvertisedPrefixList {
    ...
    pub items: Option<Vec<crate::google_rest_apis::compute_v1::models::PublicAdvertisedPrefix>>,
...
impl PublicAdvertisedPrefixList {
    pub fn new() -> PublicAdvertisedPrefixList {
