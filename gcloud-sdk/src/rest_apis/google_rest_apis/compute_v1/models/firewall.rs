...
pub struct Firewall {
    ...
    pub allowed: Option<Vec<crate::google_rest_apis::compute_v1::models::FirewallAllowedInner>>,
    /// [Output Only] Creation timestamp in RFC3339 text format.
    #[serde(rename = "creationTimestamp", skip_serializing_if = "Option::is_none")]
    pub creation_timestamp: Option<String>,
    /// The list of DENY rules specified by this firewall. Each rule specifies a protocol and port-range tuple that describes a denied connection.
    #[serde(rename = "denied", skip_serializing_if = "Option::is_none")]
    pub denied: Option<Vec<crate::google_rest_apis::compute_v1::models::FirewallAllowedInner>>,
    ...
    pub log_config: Option<Box<crate::google_rest_apis::compute_v1::models::FirewallLogConfig>>,
