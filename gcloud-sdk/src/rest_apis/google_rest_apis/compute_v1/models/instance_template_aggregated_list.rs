...
pub struct InstanceTemplateAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::InstanceTemplatesScopedList>>,
    /// Type of resource.
...
impl InstanceTemplateAggregatedList {
    /// Contains a list of InstanceTemplatesScopedList.
    pub fn new() -> InstanceTemplateAggregatedList {
