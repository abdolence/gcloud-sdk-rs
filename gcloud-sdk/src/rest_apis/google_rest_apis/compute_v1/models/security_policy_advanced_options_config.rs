...
pub struct SecurityPolicyAdvancedOptionsConfig {
    ...
    pub json_custom_config: Option<Box<crate::google_rest_apis::compute_v1::models::SecurityPolicyAdvancedOptionsConfigJsonCustomConfig>>,
    ...
    #[serde(rename = "userIpRequestHeaders", skip_serializing_if = "Option::is_none")]
