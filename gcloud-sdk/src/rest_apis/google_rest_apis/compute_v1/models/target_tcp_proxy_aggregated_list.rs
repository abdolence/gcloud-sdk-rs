...
pub struct TargetTcpProxyAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::TargetTcpProxiesScopedList>>,
...
impl TargetTcpProxyAggregatedList {
    pub fn new() -> TargetTcpProxyAggregatedList {
