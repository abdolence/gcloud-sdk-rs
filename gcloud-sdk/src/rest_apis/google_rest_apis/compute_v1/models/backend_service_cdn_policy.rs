...
pub struct BackendServiceCdnPolicy {
    ...
    pub bypass_cache_on_request_headers:
        Option<Vec<models::BackendServiceCdnPolicyBypassCacheOnRequestHeader>>,
    #[serde(rename = "cacheKeyPolicy", skip_serializing_if = "Option::is_none")]
    pub cache_key_policy: Option<Box<models::CacheKeyPolicy>>,
    ...
    pub negative_caching_policy: Option<Vec<models::BackendServiceCdnPolicyNegativeCachingPolicy>>,
