...
pub struct OutlierDetection {
    ...
    pub base_ejection_time: Option<Box<crate::google_rest_apis::compute_v1::models::Duration>>,
    ...
    pub interval: Option<Box<crate::google_rest_apis::compute_v1::models::Duration>>,
