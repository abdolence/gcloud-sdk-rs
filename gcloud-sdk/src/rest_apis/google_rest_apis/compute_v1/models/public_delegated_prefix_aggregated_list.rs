...
pub struct PublicDelegatedPrefixAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::PublicDelegatedPrefixesScopedList>>,
...
impl PublicDelegatedPrefixAggregatedList {
    pub fn new() -> PublicDelegatedPrefixAggregatedList {
