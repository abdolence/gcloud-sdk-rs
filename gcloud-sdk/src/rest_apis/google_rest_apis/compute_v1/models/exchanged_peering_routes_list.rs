...
pub struct ExchangedPeeringRoutesList {
    ...
    pub items: Option<Vec<crate::google_rest_apis::compute_v1::models::ExchangedPeeringRoute>>,
...
impl ExchangedPeeringRoutesList {
    pub fn new() -> ExchangedPeeringRoutesList {
