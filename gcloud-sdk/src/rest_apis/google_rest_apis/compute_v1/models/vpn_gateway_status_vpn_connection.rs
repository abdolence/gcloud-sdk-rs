...
pub struct VpnGatewayStatusVpnConnection {
    ...
    pub state: Option<Box<crate::google_rest_apis::compute_v1::models::VpnGatewayStatusHighAvailabilityRequirementState>>,
    /// List of VPN tunnels that are in this VPN connection.
    #[serde(rename = "tunnels", skip_serializing_if = "Option::is_none")]
    pub tunnels: Option<Vec<crate::google_rest_apis::compute_v1::models::VpnGatewayStatusTunnel>>,
}
