...
pub struct PublicDelegatedPrefix {
    ...
    #[serde(rename = "publicDelegatedSubPrefixs", skip_serializing_if = "Option::is_none")]
    pub public_delegated_sub_prefixs: Option<Vec<crate::google_rest_apis::compute_v1::models::PublicDelegatedPrefixPublicDelegatedSubPrefix>>,
