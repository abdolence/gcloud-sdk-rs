...
pub struct ForwardingRuleAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::ForwardingRulesScopedList>>,
...
impl ForwardingRuleAggregatedList {
    pub fn new() -> ForwardingRuleAggregatedList {
