...
pub struct TargetHttpsProxyAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::TargetHttpsProxiesScopedList>>,
...
impl TargetHttpsProxyAggregatedList {
    pub fn new() -> TargetHttpsProxyAggregatedList {
