...
pub struct VmEndpointNatMappingsInterfaceNatMappings {
    ...
    #[serde(rename = "drainNatIpPortRanges", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "numTotalDrainNatPorts", skip_serializing_if = "Option::is_none")]
    ...
    pub rule_mappings: Option<Vec<crate::google_rest_apis::compute_v1::models::VmEndpointNatMappingsInterfaceNatMappingsNatRuleMappings>>,
