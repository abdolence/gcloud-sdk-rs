...
pub struct NetworkEndpointGroup {
    ...
    pub app_engine:
        Option<Box<crate::google_rest_apis::compute_v1::models::NetworkEndpointGroupAppEngine>>,
    #[serde(rename = "cloudFunction", skip_serializing_if = "Option::is_none")]
    pub cloud_function:
        Option<Box<crate::google_rest_apis::compute_v1::models::NetworkEndpointGroupCloudFunction>>,
    #[serde(rename = "cloudRun", skip_serializing_if = "Option::is_none")]
    pub cloud_run:
        Option<Box<crate::google_rest_apis::compute_v1::models::NetworkEndpointGroupCloudRun>>,
