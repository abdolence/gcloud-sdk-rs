...
pub struct TargetVpnGatewayAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::TargetVpnGatewaysScopedList>>,
...
impl TargetVpnGatewayAggregatedList {
    pub fn new() -> TargetVpnGatewayAggregatedList {
