...
pub struct SecurityPolicyRuleRateLimitOptions {
    ...
    pub ban_threshold: Option<Box<crate::google_rest_apis::compute_v1::models::SecurityPolicyRuleRateLimitOptionsThreshold>>,
    ...
    #[serde(rename = "enforceOnKeyConfigs", skip_serializing_if = "Option::is_none")]
    pub enforce_on_key_configs: Option<Vec<crate::google_rest_apis::compute_v1::models::SecurityPolicyRuleRateLimitOptionsEnforceOnKeyConfig>>,
    ...
    #[serde(rename = "exceedRedirectOptions", skip_serializing_if = "Option::is_none")]
    pub exceed_redirect_options: Option<Box<crate::google_rest_apis::compute_v1::models::SecurityPolicyRuleRedirectOptions>>,
    #[serde(rename = "rateLimitThreshold", skip_serializing_if = "Option::is_none")]
    pub rate_limit_threshold: Option<Box<crate::google_rest_apis::compute_v1::models::SecurityPolicyRuleRateLimitOptionsThreshold>>,
}
