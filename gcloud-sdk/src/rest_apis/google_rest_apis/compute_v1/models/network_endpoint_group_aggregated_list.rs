...
pub struct NetworkEndpointGroupAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::NetworkEndpointGroupsScopedList>>,
...
impl NetworkEndpointGroupAggregatedList {
    pub fn new() -> NetworkEndpointGroupAggregatedList {
