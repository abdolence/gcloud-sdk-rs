...
pub struct InterconnectAttachmentAggregatedList {
    ...
    pub items: Option<std::collections::HashMap<String, models::InterconnectAttachmentsScopedList>>,
...
impl InterconnectAttachmentAggregatedList {
    pub fn new() -> InterconnectAttachmentAggregatedList {
