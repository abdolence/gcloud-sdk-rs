...
) -> Result<models::Operation, Error<ComputePeriodRegionTargetHttpProxiesPeriodDeleteError>> {
...
) -> Result<models::TargetHttpProxy, Error<ComputePeriodRegionTargetHttpProxiesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionTargetHttpProxiesPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::TargetHttpProxyList, Error<ComputePeriodRegionTargetHttpProxiesPeriodListError>>
{
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionTargetHttpProxiesPeriodSetUrlMapError>> {
    let local_var_configuration = configuration;
