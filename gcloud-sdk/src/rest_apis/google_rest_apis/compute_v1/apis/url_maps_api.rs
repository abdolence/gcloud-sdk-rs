...
pub struct ComputePeriodUrlMapsPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub url_map: Option<crate::google_rest_apis::compute_v1::models::UrlMap>,
}
...
pub struct ComputePeriodUrlMapsPeriodInvalidateCacheParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub cache_invalidation_rule:
        Option<crate::google_rest_apis::compute_v1::models::CacheInvalidationRule>,
}
...
pub struct ComputePeriodUrlMapsPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub url_map2: Option<crate::google_rest_apis::compute_v1::models::UrlMap>,
}
...
pub struct ComputePeriodUrlMapsPeriodValidateParams {
    ...
    /// Legacy name for parameter that has been superseded by `quotaUser`.
    pub user_ip: Option<String>,
    pub url_maps_validate_request:
        Option<crate::google_rest_apis::compute_v1::models::UrlMapsValidateRequest>,
}
...
pub async fn compute_url_maps_aggregated_list(
    ...
    crate::google_rest_apis::compute_v1::models::UrlMapsAggregatedList,
    Error<ComputePeriodUrlMapsPeriodAggregatedListError>,
> {
...
pub async fn compute_url_maps_delete(
    ...
    Error<ComputePeriodUrlMapsPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_url_maps_get(
    ...
    crate::google_rest_apis::compute_v1::models::UrlMap,
    Error<ComputePeriodUrlMapsPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_url_maps_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodUrlMapsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_url_maps_invalidate_cache(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodUrlMapsPeriodInvalidateCacheError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_url_maps_list(
    ...
    crate::google_rest_apis::compute_v1::models::UrlMapList,
    Error<ComputePeriodUrlMapsPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_url_maps_patch(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodUrlMapsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_url_maps_update(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodUrlMapsPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_url_maps_validate(
    ...
    crate::google_rest_apis::compute_v1::models::UrlMapsValidateResponse,
    Error<ComputePeriodUrlMapsPeriodValidateError>,
> {
    let local_var_configuration = configuration;
