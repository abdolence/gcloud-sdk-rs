...
pub struct ComputePeriodBackendServicesPeriodAddSignedUrlKeyParams {
    ...
    pub signed_url_key: Option<crate::google_rest_apis::compute_v1::models::SignedUrlKey>,
}
...
pub async fn compute_backend_services_add_signed_url_key(
    ...
    Error<ComputePeriodBackendServicesPeriodAddSignedUrlKeyError>,
> {
...
pub async fn compute_backend_services_aggregated_list(
    ...
    crate::google_rest_apis::compute_v1::models::BackendServiceAggregatedList,
...
pub async fn compute_backend_services_delete(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodBackendServicesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_backend_services_delete_signed_url_key(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodBackendServicesPeriodDeleteSignedUrlKeyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_backend_services_get(
    ...
    Error<ComputePeriodBackendServicesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_backend_services_get_iam_policy(
    ...
    Error<ComputePeriodBackendServicesPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_backend_services_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodBackendServicesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_backend_services_list(
    ...
    Error<ComputePeriodBackendServicesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_backend_services_patch(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodBackendServicesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_backend_services_set_edge_security_policy(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodBackendServicesPeriodSetEdgeSecurityPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_backend_services_set_iam_policy(
    ...
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodBackendServicesPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_backend_services_set_security_policy(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodBackendServicesPeriodSetSecurityPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_backend_services_update(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodBackendServicesPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
