...
) -> Result<models::Operation, Error<ComputePeriodRegionSslPoliciesPeriodDeleteError>> {
...
) -> Result<models::SslPolicy, Error<ComputePeriodRegionSslPoliciesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionSslPoliciesPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::SslPoliciesList, Error<ComputePeriodRegionSslPoliciesPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionSslPoliciesPeriodPatchError>> {
    let local_var_configuration = configuration;
