...
pub struct ComputePeriodDisksPeriodAddResourcePoliciesParams {
    ...
    pub disks_add_resource_policies_request:
        Option<crate::google_rest_apis::compute_v1::models::DisksAddResourcePoliciesRequest>,
}
...
pub struct ComputePeriodDisksPeriodBulkInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub bulk_insert_disk_resource:
        Option<crate::google_rest_apis::compute_v1::models::BulkInsertDiskResource>,
}
...
pub struct ComputePeriodDisksPeriodInsertParams {
    ...
    pub disk: Option<crate::google_rest_apis::compute_v1::models::Disk>,
}
...
pub struct ComputePeriodDisksPeriodRemoveResourcePoliciesParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub disks_remove_resource_policies_request:
        Option<crate::google_rest_apis::compute_v1::models::DisksRemoveResourcePoliciesRequest>,
}
...
pub struct ComputePeriodDisksPeriodResizeParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub disks_resize_request:
        Option<crate::google_rest_apis::compute_v1::models::DisksResizeRequest>,
}
...
pub struct ComputePeriodDisksPeriodSetLabelsParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub zone_set_labels_request:
        Option<crate::google_rest_apis::compute_v1::models::ZoneSetLabelsRequest>,
}
...
pub struct ComputePeriodDisksPeriodStartAsyncReplicationParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub disks_start_async_replication_request:
        Option<crate::google_rest_apis::compute_v1::models::DisksStartAsyncReplicationRequest>,
}
...
pub struct ComputePeriodDisksPeriodStopGroupAsyncReplicationParams {
    ...
    pub disks_stop_group_async_replication_resource:
        Option<crate::google_rest_apis::compute_v1::models::DisksStopGroupAsyncReplicationResource>,
}
...
pub struct ComputePeriodDisksPeriodUpdateParams {
    ...
    pub disk2: Option<crate::google_rest_apis::compute_v1::models::Disk>,
}
...
pub async fn compute_disks_add_resource_policies(
    ...
    Error<ComputePeriodDisksPeriodAddResourcePoliciesError>,
> {
...
pub async fn compute_disks_aggregated_list(
    ...
    crate::google_rest_apis::compute_v1::models::DiskAggregatedList,
    Error<ComputePeriodDisksPeriodAggregatedListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_bulk_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodBulkInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_create_snapshot(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodCreateSnapshotError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_delete(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_get(
    ...
    crate::google_rest_apis::compute_v1::models::Disk,
    Error<ComputePeriodDisksPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_get_iam_policy(
    ...
    Error<ComputePeriodDisksPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_list(
    ...
    crate::google_rest_apis::compute_v1::models::DiskList,
    Error<ComputePeriodDisksPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_remove_resource_policies(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodRemoveResourcePoliciesError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_resize(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodResizeError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_set_iam_policy(
    ...
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodDisksPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_set_labels(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodSetLabelsError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_start_async_replication(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodStartAsyncReplicationError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_stop_async_replication(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodStopAsyncReplicationError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_stop_group_async_replication(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodStopGroupAsyncReplicationError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_test_iam_permissions(
    ...
    Error<ComputePeriodDisksPeriodTestIamPermissionsError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_disks_update(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodDisksPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
