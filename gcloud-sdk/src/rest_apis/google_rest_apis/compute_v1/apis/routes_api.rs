...
/// struct for passing parameters to the method [`compute_routes_delete`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodRoutesPeriodDeleteParams {
...
/// struct for passing parameters to the method [`compute_routes_get`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodRoutesPeriodGetParams {
    /// Project ID for this request.
    pub project: String,
...
/// struct for passing parameters to the method [`compute_routes_insert`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodRoutesPeriodInsertParams {
    /// Project ID for this request.
    pub project: String,
    /// V1 error format.
    pub dollar_xgafv: Option<String>,
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub route: Option<crate::google_rest_apis::compute_v1::models::Route>,
}

/// struct for passing parameters to the method [`compute_routes_list`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodRoutesPeriodListParams {
    /// Project ID for this request.
    pub project: String,
    /// V1 error format.
    pub dollar_xgafv: Option<String>,
...
/// struct for typed errors of method [`compute_routes_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRoutesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_routes_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRoutesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_routes_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRoutesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_routes_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRoutesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified Route resource.
pub async fn compute_routes_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodRoutesPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRoutesPeriodDeleteError>,
> {
    ...
    let local_var_uri_str = format!(
        ...
        route = crate::google_rest_apis::compute_v1::apis::urlencode(route)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRoutesPeriodDeleteError> =
...
pub async fn compute_routes_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodRoutesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Route,
    Error<ComputePeriodRoutesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRoutesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_routes_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodRoutesPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRoutesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRoutesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_routes_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodRoutesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::RouteList,
    Error<ComputePeriodRoutesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRoutesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
