...
) -> Result<models::Operation, Error<ComputePeriodRoutesPeriodDeleteError>> {
...
) -> Result<models::Route, Error<ComputePeriodRoutesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRoutesPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::RouteList, Error<ComputePeriodRoutesPeriodListError>> {
    let local_var_configuration = configuration;
