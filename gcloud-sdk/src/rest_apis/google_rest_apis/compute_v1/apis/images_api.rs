...
pub struct ComputePeriodImagesPeriodDeprecateParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub deprecation_status: Option<crate::google_rest_apis::compute_v1::models::DeprecationStatus>,
}
...
pub struct ComputePeriodImagesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub image: Option<crate::google_rest_apis::compute_v1::models::Image>,
}
...
pub struct ComputePeriodImagesPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub image2: Option<crate::google_rest_apis::compute_v1::models::Image>,
}
...
pub async fn compute_images_delete(
    ...
    Error<ComputePeriodImagesPeriodDeleteError>,
> {
...
pub async fn compute_images_deprecate(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodImagesPeriodDeprecateError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_images_get(
    ...
    crate::google_rest_apis::compute_v1::models::Image,
    Error<ComputePeriodImagesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_images_get_from_family(
    ...
    crate::google_rest_apis::compute_v1::models::Image,
    Error<ComputePeriodImagesPeriodGetFromFamilyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_images_get_iam_policy(
    ...
    Error<ComputePeriodImagesPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_images_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodImagesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_images_list(
    ...
    crate::google_rest_apis::compute_v1::models::ImageList,
    Error<ComputePeriodImagesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_images_patch(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodImagesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_images_set_iam_policy(
    ...
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodImagesPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_images_set_labels(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodImagesPeriodSetLabelsError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_images_test_iam_permissions(
    ...
    Error<ComputePeriodImagesPeriodTestIamPermissionsError>,
> {
    let local_var_configuration = configuration;
