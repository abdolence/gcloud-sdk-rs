...
pub struct ComputePeriodNodeTemplatesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub node_template: Option<crate::google_rest_apis::compute_v1::models::NodeTemplate>,
}
...
pub async fn compute_node_templates_aggregated_list(
    ...
    crate::google_rest_apis::compute_v1::models::NodeTemplateAggregatedList,
...
pub async fn compute_node_templates_delete(
    ...
    Error<ComputePeriodNodeTemplatesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_node_templates_get(
    ...
    crate::google_rest_apis::compute_v1::models::NodeTemplate,
    Error<ComputePeriodNodeTemplatesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_node_templates_get_iam_policy(
    ...
    Error<ComputePeriodNodeTemplatesPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_node_templates_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodNodeTemplatesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_node_templates_list(
    ...
    crate::google_rest_apis::compute_v1::models::NodeTemplateList,
    Error<ComputePeriodNodeTemplatesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_node_templates_set_iam_policy(
    ...
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodNodeTemplatesPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
