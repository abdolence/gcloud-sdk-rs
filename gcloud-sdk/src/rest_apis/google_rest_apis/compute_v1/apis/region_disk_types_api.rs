...
pub struct ComputePeriodRegionDiskTypesPeriodGetParams {
...
/// struct for passing parameters to the method [`compute_region_disk_types_list`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodRegionDiskTypesPeriodListParams {
    /// Project ID for this request.
    pub project: String,
    /// The name of the region for this request.
    pub region: String,
...
/// struct for typed errors of method [`compute_region_disk_types_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionDiskTypesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_disk_types_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionDiskTypesPeriodListError {
    UnknownValue(serde_json::Value),
}
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionDiskTypesPeriodGetError> =
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionDiskTypesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
