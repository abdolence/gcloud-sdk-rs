...
pub struct ComputePeriodRoutersPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub router: Option<models::Router>,
}
...
pub struct ComputePeriodRoutersPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub router2: Option<models::Router>,
}
...
) -> Result<models::RouterAggregatedList, Error<ComputePeriodRoutersPeriodAggregatedListError>> {
...
) -> Result<models::Operation, Error<ComputePeriodRoutersPeriodDeleteError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Router, Error<ComputePeriodRoutersPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::NatIpInfoResponse, Error<ComputePeriodRoutersPeriodGetNatIpInfoError>> {
    let local_var_configuration = configuration;
...
pub async fn compute_routers_get_nat_mapping_info(
    ...
    models::VmEndpointNatMappingsList,
...
) -> Result<models::RouterStatusResponse, Error<ComputePeriodRoutersPeriodGetRouterStatusError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRoutersPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::RouterList, Error<ComputePeriodRoutersPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRoutersPeriodPatchError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::RoutersPreviewResponse, Error<ComputePeriodRoutersPeriodPreviewError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRoutersPeriodUpdateError>> {
    let local_var_configuration = configuration;
