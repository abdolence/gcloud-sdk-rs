...
) -> Result<models::Operation, Error<ComputePeriodRegionTargetTcpProxiesPeriodDeleteError>> {
...
) -> Result<models::TargetTcpProxy, Error<ComputePeriodRegionTargetTcpProxiesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionTargetTcpProxiesPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::TargetTcpProxyList, Error<ComputePeriodRegionTargetTcpProxiesPeriodListError>> {
    let local_var_configuration = configuration;
