...
pub struct ComputePeriodRegionTargetTcpProxiesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub target_tcp_proxy: Option<crate::google_rest_apis::compute_v1::models::TargetTcpProxy>,
}
...
/// struct for typed errors of method [`compute_region_target_tcp_proxies_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionTargetTcpProxiesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_target_tcp_proxies_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionTargetTcpProxiesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_target_tcp_proxies_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionTargetTcpProxiesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_target_tcp_proxies_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionTargetTcpProxiesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified TargetTcpProxy resource.
pub async fn compute_region_target_tcp_proxies_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionTargetTcpProxiesPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionTargetTcpProxiesPeriodDeleteError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionTargetTcpProxiesPeriodDeleteError> =
...
pub async fn compute_region_target_tcp_proxies_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionTargetTcpProxiesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TargetTcpProxy,
    Error<ComputePeriodRegionTargetTcpProxiesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionTargetTcpProxiesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_target_tcp_proxies_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionTargetTcpProxiesPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionTargetTcpProxiesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionTargetTcpProxiesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_target_tcp_proxies_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionTargetTcpProxiesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TargetTcpProxyList,
    Error<ComputePeriodRegionTargetTcpProxiesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionTargetTcpProxiesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
