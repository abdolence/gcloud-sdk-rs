...
pub struct ComputePeriodMachineTypesPeriodAggregatedListParams {
...
/// struct for passing parameters to the method [`compute_machine_types_get`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodMachineTypesPeriodGetParams {
    /// Project ID for this request.
    pub project: String,
...
/// struct for passing parameters to the method [`compute_machine_types_list`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodMachineTypesPeriodListParams {
    /// Project ID for this request.
    pub project: String,
    /// The name of the zone for this request.
    pub zone: String,
...
/// struct for typed errors of method [`compute_machine_types_aggregated_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodMachineTypesPeriodAggregatedListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_machine_types_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodMachineTypesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_machine_types_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodMachineTypesPeriodListError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_machine_types_aggregated_list(
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodMachineTypesPeriodAggregatedListError> =
...
> {
    ...
    let local_var_uri_str = format!(
        ...
        machineType = crate::google_rest_apis::compute_v1::apis::urlencode(machine_type)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodMachineTypesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodMachineTypesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
