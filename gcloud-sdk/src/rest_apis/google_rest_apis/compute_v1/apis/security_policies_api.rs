...
pub async fn compute_security_policies_add_rule(
    ...
    Error<ComputePeriodSecurityPoliciesPeriodAddRuleError>,
> {
...
pub async fn compute_security_policies_aggregated_list(
    ...
    crate::google_rest_apis::compute_v1::models::SecurityPoliciesAggregatedList,
...
pub async fn compute_security_policies_delete(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSecurityPoliciesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_security_policies_get(
    ...
    Error<ComputePeriodSecurityPoliciesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_security_policies_get_rule(
    ...
    Error<ComputePeriodSecurityPoliciesPeriodGetRuleError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_security_policies_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSecurityPoliciesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_security_policies_list(
    ...
    Error<ComputePeriodSecurityPoliciesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_security_policies_list_preconfigured_expression_sets(configuration: &configuration::Configuration, params: ComputePeriodSecurityPoliciesPeriodListPreconfiguredExpressionSetsParams) -> Result<crate::google_rest_apis::compute_v1::models::SecurityPoliciesListPreconfiguredExpressionSetsResponse, Error<ComputePeriodSecurityPoliciesPeriodListPreconfiguredExpressionSetsError>>{
    let local_var_configuration = configuration;
...
pub async fn compute_security_policies_patch(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSecurityPoliciesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_security_policies_patch_rule(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSecurityPoliciesPeriodPatchRuleError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_security_policies_remove_rule(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSecurityPoliciesPeriodRemoveRuleError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_security_policies_set_labels(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSecurityPoliciesPeriodSetLabelsError>,
> {
    let local_var_configuration = configuration;
