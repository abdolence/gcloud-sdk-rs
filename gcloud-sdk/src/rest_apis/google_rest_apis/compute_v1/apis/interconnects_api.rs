...
pub struct ComputePeriodInterconnectsPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub interconnect: Option<crate::google_rest_apis::compute_v1::models::Interconnect>,
}
...
pub struct ComputePeriodInterconnectsPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub interconnect2: Option<crate::google_rest_apis::compute_v1::models::Interconnect>,
}
...
pub struct ComputePeriodInterconnectsPeriodSetLabelsParams {
    ...
    /// Legacy name for parameter that has been superseded by `quotaUser`.
    pub user_ip: Option<String>,
    pub global_set_labels_request:
        Option<crate::google_rest_apis::compute_v1::models::GlobalSetLabelsRequest>,
}

/// struct for typed errors of method [`compute_interconnects_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectsPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_interconnects_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_interconnects_get_diagnostics`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectsPeriodGetDiagnosticsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_interconnects_get_macsec_config`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectsPeriodGetMacsecConfigError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_interconnects_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectsPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_interconnects_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectsPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_interconnects_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectsPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_interconnects_set_labels`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectsPeriodSetLabelsError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified Interconnect.
pub async fn compute_interconnects_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodInterconnectsPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodInterconnectsPeriodDeleteError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project = params.project;
    let interconnect = params.interconnect;
    ...
    let local_var_uri_str = format!(
        ...
        interconnect = crate::google_rest_apis::compute_v1::apis::urlencode(interconnect)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectsPeriodDeleteError> =
...
pub async fn compute_interconnects_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodInterconnectsPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Interconnect,
    Error<ComputePeriodInterconnectsPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectsPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_interconnects_get_diagnostics(
    configuration: &configuration::Configuration,
    params: ComputePeriodInterconnectsPeriodGetDiagnosticsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::InterconnectsGetDiagnosticsResponse,
    Error<ComputePeriodInterconnectsPeriodGetDiagnosticsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectsPeriodGetDiagnosticsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_interconnects_get_macsec_config(
    configuration: &configuration::Configuration,
    params: ComputePeriodInterconnectsPeriodGetMacsecConfigParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::InterconnectsGetMacsecConfigResponse,
    Error<ComputePeriodInterconnectsPeriodGetMacsecConfigError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectsPeriodGetMacsecConfigError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_interconnects_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodInterconnectsPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodInterconnectsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&interconnect);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectsPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_interconnects_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodInterconnectsPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::InterconnectList,
    Error<ComputePeriodInterconnectsPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectsPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_interconnects_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodInterconnectsPeriodPatchParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodInterconnectsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
    ...
    let user_ip = params.user_ip;
    let request_id = params.request_id;
    let interconnect2 = params.interconnect2;
    ...
    local_var_req_builder = local_var_req_builder.json(&interconnect2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectsPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_interconnects_set_labels(
    configuration: &configuration::Configuration,
    params: ComputePeriodInterconnectsPeriodSetLabelsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodInterconnectsPeriodSetLabelsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectsPeriodSetLabelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
