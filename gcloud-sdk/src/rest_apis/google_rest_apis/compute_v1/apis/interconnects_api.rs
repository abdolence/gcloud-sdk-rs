...
pub struct ComputePeriodInterconnectsPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub interconnect: Option<models::Interconnect>,
}
...
pub struct ComputePeriodInterconnectsPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub interconnect2: Option<models::Interconnect>,
}
...
) -> Result<models::Operation, Error<ComputePeriodInterconnectsPeriodDeleteError>> {
...
) -> Result<models::Interconnect, Error<ComputePeriodInterconnectsPeriodGetError>> {
    let local_var_configuration = configuration;
...
pub async fn compute_interconnects_get_diagnostics(
    ...
    models::InterconnectsGetDiagnosticsResponse,
...
pub async fn compute_interconnects_get_macsec_config(
    ...
    models::InterconnectsGetMacsecConfigResponse,
...
) -> Result<models::Operation, Error<ComputePeriodInterconnectsPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::InterconnectList, Error<ComputePeriodInterconnectsPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodInterconnectsPeriodPatchError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodInterconnectsPeriodSetLabelsError>> {
    let local_var_configuration = configuration;
