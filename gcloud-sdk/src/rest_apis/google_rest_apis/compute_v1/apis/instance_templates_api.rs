...
pub async fn compute_instance_templates_aggregated_list(
    ...
    crate::google_rest_apis::compute_v1::models::InstanceTemplateAggregatedList,
...
pub async fn compute_instance_templates_delete(
    ...
    Error<ComputePeriodInstanceTemplatesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_instance_templates_get(
    ...
    Error<ComputePeriodInstanceTemplatesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_instance_templates_get_iam_policy(
    ...
    Error<ComputePeriodInstanceTemplatesPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_instance_templates_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodInstanceTemplatesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_instance_templates_list(
    ...
    Error<ComputePeriodInstanceTemplatesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_instance_templates_set_iam_policy(
    ...
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodInstanceTemplatesPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
