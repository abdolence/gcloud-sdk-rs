...
pub struct ComputePeriodInterconnectAttachmentsPeriodInsertParams {
    ...
    pub interconnect_attachment: Option<models::InterconnectAttachment>,
}
...
pub struct ComputePeriodInterconnectAttachmentsPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub interconnect_attachment2: Option<models::InterconnectAttachment>,
}
...
pub async fn compute_interconnect_attachments_aggregated_list(
    ...
    models::InterconnectAttachmentAggregatedList,
...
) -> Result<models::Operation, Error<ComputePeriodInterconnectAttachmentsPeriodDeleteError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::InterconnectAttachment, Error<ComputePeriodInterconnectAttachmentsPeriodGetError>>
{
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodInterconnectAttachmentsPeriodInsertError>> {
    let local_var_configuration = configuration;
...
pub async fn compute_interconnect_attachments_list(
    ...
    models::InterconnectAttachmentList,
...
) -> Result<models::Operation, Error<ComputePeriodInterconnectAttachmentsPeriodPatchError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodInterconnectAttachmentsPeriodSetLabelsError>> {
    let local_var_configuration = configuration;
