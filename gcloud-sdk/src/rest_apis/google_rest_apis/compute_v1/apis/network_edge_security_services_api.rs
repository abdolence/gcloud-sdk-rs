...
pub struct ComputePeriodNetworkEdgeSecurityServicesPeriodInsertParams {
    ...
    pub network_edge_security_service: Option<models::NetworkEdgeSecurityService>,
}
...
pub struct ComputePeriodNetworkEdgeSecurityServicesPeriodPatchParams {
    ...
    pub network_edge_security_service2: Option<models::NetworkEdgeSecurityService>,
}

/// struct for typed errors of method [`compute_network_edge_security_services_aggregated_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkEdgeSecurityServicesPeriodAggregatedListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_edge_security_services_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkEdgeSecurityServicesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_edge_security_services_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkEdgeSecurityServicesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_edge_security_services_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkEdgeSecurityServicesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_edge_security_services_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkEdgeSecurityServicesPeriodPatchError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_network_edge_security_services_aggregated_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkEdgeSecurityServicesPeriodAggregatedListParams,
) -> Result<
    models::NetworkEdgeSecurityServiceAggregatedList,
    Error<ComputePeriodNetworkEdgeSecurityServicesPeriodAggregatedListError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ComputePeriodNetworkEdgeSecurityServicesPeriodAggregatedListError,
...
pub async fn compute_network_edge_security_services_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkEdgeSecurityServicesPeriodDeleteParams,
) -> Result<models::Operation, Error<ComputePeriodNetworkEdgeSecurityServicesPeriodDeleteError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project = params.project;
    let region = params.region;
    let network_edge_security_service = params.network_edge_security_service;
    let dollar_xgafv = params.dollar_xgafv;
    let access_token = params.access_token;
    let alt = params.alt;
    let callback = params.callback;
    ...
    let local_var_uri_str = format!("{}/projects/{project}/regions/{region}/networkEdgeSecurityServices/{networkEdgeSecurityService}", local_var_configuration.base_path, project=crate::google_rest_apis::compute_v1::apis::urlencode(project), region=crate::google_rest_apis::compute_v1::apis::urlencode(region), networkEdgeSecurityService=crate::google_rest_apis::compute_v1::apis::urlencode(network_edge_security_service));
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkEdgeSecurityServicesPeriodDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_network_edge_security_services_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkEdgeSecurityServicesPeriodGetParams,
) -> Result<
    models::NetworkEdgeSecurityService,
    Error<ComputePeriodNetworkEdgeSecurityServicesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkEdgeSecurityServicesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_network_edge_security_services_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkEdgeSecurityServicesPeriodInsertParams,
) -> Result<models::Operation, Error<ComputePeriodNetworkEdgeSecurityServicesPeriodInsertError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&network_edge_security_service);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkEdgeSecurityServicesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_network_edge_security_services_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkEdgeSecurityServicesPeriodPatchParams,
) -> Result<models::Operation, Error<ComputePeriodNetworkEdgeSecurityServicesPeriodPatchError>> {
    let local_var_configuration = configuration;
    ...
    let network_edge_security_service2 = params.network_edge_security_service2;
    ...
    local_var_req_builder = local_var_req_builder.json(&network_edge_security_service2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkEdgeSecurityServicesPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
