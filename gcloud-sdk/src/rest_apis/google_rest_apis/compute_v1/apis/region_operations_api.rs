...
pub struct ComputePeriodRegionOperationsPeriodDeleteParams {
...
/// struct for passing parameters to the method [`compute_region_operations_get`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodRegionOperationsPeriodGetParams {
    /// Project ID for this request.
    pub project: String,
    /// Name of the region for this request.
    pub region: String,
...
/// struct for passing parameters to the method [`compute_region_operations_list`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodRegionOperationsPeriodListParams {
    /// Project ID for this request.
    pub project: String,
    /// Name of the region for this request.
    pub region: String,
...
/// struct for passing parameters to the method [`compute_region_operations_wait`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodRegionOperationsPeriodWaitParams {
    /// Project ID for this request.
    pub project: String,
    /// Name of the region for this request.
    pub region: String,
...
/// struct for typed errors of method [`compute_region_operations_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionOperationsPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_operations_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionOperationsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_operations_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionOperationsPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_operations_wait`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionOperationsPeriodWaitError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified region-specific Operations resource.
pub async fn compute_region_operations_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionOperationsPeriodDeleteParams,
) -> Result<(), Error<ComputePeriodRegionOperationsPeriodDeleteError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionOperationsPeriodDeleteError> =
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionOperationsPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionOperationsPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionOperationsPeriodWaitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
