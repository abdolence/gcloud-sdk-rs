...
pub struct ComputePeriodNetworkAttachmentsPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000). end_interface: MixerMutationRequestBuilder
    pub request_id: Option<String>,
    pub network_attachment: Option<crate::google_rest_apis::compute_v1::models::NetworkAttachment>,
}
...
pub struct ComputePeriodNetworkAttachmentsPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000). end_interface: MixerMutationRequestBuilder
    pub request_id: Option<String>,
    pub network_attachment2: Option<crate::google_rest_apis::compute_v1::models::NetworkAttachment>,
}
...
/// struct for typed errors of method [`compute_network_attachments_aggregated_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkAttachmentsPeriodAggregatedListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_attachments_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkAttachmentsPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_attachments_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkAttachmentsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_attachments_get_iam_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkAttachmentsPeriodGetIamPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_attachments_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkAttachmentsPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_attachments_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkAttachmentsPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_attachments_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkAttachmentsPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_attachments_set_iam_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkAttachmentsPeriodSetIamPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_network_attachments_test_iam_permissions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNetworkAttachmentsPeriodTestIamPermissionsError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_network_attachments_aggregated_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkAttachmentsPeriodAggregatedListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::NetworkAttachmentAggregatedList,
    Error<ComputePeriodNetworkAttachmentsPeriodAggregatedListError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkAttachmentsPeriodAggregatedListError> =
...
pub async fn compute_network_attachments_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkAttachmentsPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodNetworkAttachmentsPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
    ...
    let network_attachment = params.network_attachment;
    let dollar_xgafv = params.dollar_xgafv;
    let access_token = params.access_token;
    let alt = params.alt;
    let callback = params.callback;
    ...
    let local_var_uri_str = format!(
        ...
        networkAttachment =
            crate::google_rest_apis::compute_v1::apis::urlencode(network_attachment)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkAttachmentsPeriodDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_network_attachments_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkAttachmentsPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::NetworkAttachment,
    Error<ComputePeriodNetworkAttachmentsPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkAttachmentsPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_network_attachments_get_iam_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkAttachmentsPeriodGetIamPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodNetworkAttachmentsPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkAttachmentsPeriodGetIamPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_network_attachments_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkAttachmentsPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodNetworkAttachmentsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&network_attachment);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkAttachmentsPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_network_attachments_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkAttachmentsPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::NetworkAttachmentList,
    Error<ComputePeriodNetworkAttachmentsPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkAttachmentsPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_network_attachments_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkAttachmentsPeriodPatchParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodNetworkAttachmentsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
    ...
    let user_ip = params.user_ip;
    let request_id = params.request_id;
    let network_attachment2 = params.network_attachment2;
    ...
    local_var_req_builder = local_var_req_builder.json(&network_attachment2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkAttachmentsPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_network_attachments_set_iam_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkAttachmentsPeriodSetIamPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodNetworkAttachmentsPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkAttachmentsPeriodSetIamPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_network_attachments_test_iam_permissions(
    configuration: &configuration::Configuration,
    params: ComputePeriodNetworkAttachmentsPeriodTestIamPermissionsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TestPermissionsResponse,
    Error<ComputePeriodNetworkAttachmentsPeriodTestIamPermissionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNetworkAttachmentsPeriodTestIamPermissionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
