...
pub struct ComputePeriodNetworkAttachmentsPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000). end_interface: MixerMutationRequestBuilder
    pub request_id: Option<String>,
    pub network_attachment: Option<models::NetworkAttachment>,
}
...
pub struct ComputePeriodNetworkAttachmentsPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000). end_interface: MixerMutationRequestBuilder
    pub request_id: Option<String>,
    pub network_attachment2: Option<models::NetworkAttachment>,
}
...
pub async fn compute_network_attachments_aggregated_list(
    ...
    models::NetworkAttachmentAggregatedList,
...
) -> Result<models::Operation, Error<ComputePeriodNetworkAttachmentsPeriodDeleteError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::NetworkAttachment, Error<ComputePeriodNetworkAttachmentsPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Policy, Error<ComputePeriodNetworkAttachmentsPeriodGetIamPolicyError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodNetworkAttachmentsPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::NetworkAttachmentList, Error<ComputePeriodNetworkAttachmentsPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodNetworkAttachmentsPeriodPatchError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Policy, Error<ComputePeriodNetworkAttachmentsPeriodSetIamPolicyError>> {
    let local_var_configuration = configuration;
