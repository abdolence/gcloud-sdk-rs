...
) -> Result<models::Operation, Error<ComputePeriodRegionSslCertificatesPeriodDeleteError>> {
...
) -> Result<models::SslCertificate, Error<ComputePeriodRegionSslCertificatesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionSslCertificatesPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::SslCertificateList, Error<ComputePeriodRegionSslCertificatesPeriodListError>> {
    let local_var_configuration = configuration;
