...
/// struct for typed errors of method [`compute_region_ssl_certificates_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionSslCertificatesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_ssl_certificates_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionSslCertificatesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_ssl_certificates_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionSslCertificatesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_ssl_certificates_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionSslCertificatesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified SslCertificate resource in the region.
pub async fn compute_region_ssl_certificates_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionSslCertificatesPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionSslCertificatesPeriodDeleteError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionSslCertificatesPeriodDeleteError> =
...
pub async fn compute_region_ssl_certificates_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionSslCertificatesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::SslCertificate,
    Error<ComputePeriodRegionSslCertificatesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionSslCertificatesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_ssl_certificates_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionSslCertificatesPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionSslCertificatesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionSslCertificatesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_ssl_certificates_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionSslCertificatesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::SslCertificateList,
    Error<ComputePeriodRegionSslCertificatesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionSslCertificatesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
