...
pub struct ComputePeriodSslCertificatesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub ssl_certificate: Option<crate::google_rest_apis::compute_v1::models::SslCertificate>,
}
...
/// struct for typed errors of method [`compute_ssl_certificates_aggregated_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSslCertificatesPeriodAggregatedListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_ssl_certificates_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSslCertificatesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_ssl_certificates_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSslCertificatesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_ssl_certificates_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSslCertificatesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_ssl_certificates_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSslCertificatesPeriodListError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_ssl_certificates_aggregated_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodSslCertificatesPeriodAggregatedListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::SslCertificateAggregatedList,
    Error<ComputePeriodSslCertificatesPeriodAggregatedListError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSslCertificatesPeriodAggregatedListError> =
...
pub async fn compute_ssl_certificates_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodSslCertificatesPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSslCertificatesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project = params.project;
    let ssl_certificate = params.ssl_certificate;
    let dollar_xgafv = params.dollar_xgafv;
    let access_token = params.access_token;
    let alt = params.alt;
    let callback = params.callback;
    ...
    let local_var_uri_str = format!(
        ...
        local_var_configuration.base_path,
        project = crate::google_rest_apis::compute_v1::apis::urlencode(project),
        sslCertificate = crate::google_rest_apis::compute_v1::apis::urlencode(ssl_certificate)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSslCertificatesPeriodDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_ssl_certificates_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodSslCertificatesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::SslCertificate,
    Error<ComputePeriodSslCertificatesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSslCertificatesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_ssl_certificates_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodSslCertificatesPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSslCertificatesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&ssl_certificate);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSslCertificatesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_ssl_certificates_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodSslCertificatesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::SslCertificateList,
    Error<ComputePeriodSslCertificatesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSslCertificatesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
