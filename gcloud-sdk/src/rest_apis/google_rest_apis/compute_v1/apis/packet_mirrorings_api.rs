...
pub struct ComputePeriodPacketMirroringsPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub packet_mirroring: Option<crate::google_rest_apis::compute_v1::models::PacketMirroring>,
}
...
pub struct ComputePeriodPacketMirroringsPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub packet_mirroring2: Option<crate::google_rest_apis::compute_v1::models::PacketMirroring>,
}
...
/// struct for typed errors of method [`compute_packet_mirrorings_aggregated_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPacketMirroringsPeriodAggregatedListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_packet_mirrorings_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPacketMirroringsPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_packet_mirrorings_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPacketMirroringsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_packet_mirrorings_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPacketMirroringsPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_packet_mirrorings_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPacketMirroringsPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_packet_mirrorings_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPacketMirroringsPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_packet_mirrorings_test_iam_permissions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPacketMirroringsPeriodTestIamPermissionsError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_packet_mirrorings_aggregated_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodPacketMirroringsPeriodAggregatedListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::PacketMirroringAggregatedList,
    Error<ComputePeriodPacketMirroringsPeriodAggregatedListError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPacketMirroringsPeriodAggregatedListError> =
...
pub async fn compute_packet_mirrorings_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodPacketMirroringsPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodPacketMirroringsPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
    ...
    let packet_mirroring = params.packet_mirroring;
    let dollar_xgafv = params.dollar_xgafv;
    let access_token = params.access_token;
    let alt = params.alt;
    let callback = params.callback;
    ...
    let local_var_uri_str = format!(
        ...
        packetMirroring = crate::google_rest_apis::compute_v1::apis::urlencode(packet_mirroring)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPacketMirroringsPeriodDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_packet_mirrorings_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodPacketMirroringsPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::PacketMirroring,
    Error<ComputePeriodPacketMirroringsPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPacketMirroringsPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_packet_mirrorings_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodPacketMirroringsPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodPacketMirroringsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&packet_mirroring);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPacketMirroringsPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_packet_mirrorings_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodPacketMirroringsPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::PacketMirroringList,
    Error<ComputePeriodPacketMirroringsPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPacketMirroringsPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_packet_mirrorings_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodPacketMirroringsPeriodPatchParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodPacketMirroringsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
    ...
    let user_ip = params.user_ip;
    let request_id = params.request_id;
    let packet_mirroring2 = params.packet_mirroring2;
    ...
    local_var_req_builder = local_var_req_builder.json(&packet_mirroring2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPacketMirroringsPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_packet_mirrorings_test_iam_permissions(
    configuration: &configuration::Configuration,
    params: ComputePeriodPacketMirroringsPeriodTestIamPermissionsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TestPermissionsResponse,
    Error<ComputePeriodPacketMirroringsPeriodTestIamPermissionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPacketMirroringsPeriodTestIamPermissionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
