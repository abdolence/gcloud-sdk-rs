...
pub struct ComputePeriodExternalVpnGatewaysPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub external_vpn_gateway:
        Option<crate::google_rest_apis::compute_v1::models::ExternalVpnGateway>,
}
...
/// struct for typed errors of method [`compute_external_vpn_gateways_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodExternalVpnGatewaysPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_external_vpn_gateways_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodExternalVpnGatewaysPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_external_vpn_gateways_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodExternalVpnGatewaysPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_external_vpn_gateways_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodExternalVpnGatewaysPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_external_vpn_gateways_set_labels`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodExternalVpnGatewaysPeriodSetLabelsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_external_vpn_gateways_test_iam_permissions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodExternalVpnGatewaysPeriodTestIamPermissionsError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified externalVpnGateway.
pub async fn compute_external_vpn_gateways_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodExternalVpnGatewaysPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodExternalVpnGatewaysPeriodDeleteError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project = params.project;
    let external_vpn_gateway = params.external_vpn_gateway;
    ...
    let local_var_uri_str = format!(
        ...
        externalVpnGateway =
            crate::google_rest_apis::compute_v1::apis::urlencode(external_vpn_gateway)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodExternalVpnGatewaysPeriodDeleteError> =
...
pub async fn compute_external_vpn_gateways_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodExternalVpnGatewaysPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::ExternalVpnGateway,
    Error<ComputePeriodExternalVpnGatewaysPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodExternalVpnGatewaysPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_external_vpn_gateways_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodExternalVpnGatewaysPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodExternalVpnGatewaysPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&external_vpn_gateway);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodExternalVpnGatewaysPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_external_vpn_gateways_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodExternalVpnGatewaysPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::ExternalVpnGatewayList,
    Error<ComputePeriodExternalVpnGatewaysPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodExternalVpnGatewaysPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_external_vpn_gateways_set_labels(
    configuration: &configuration::Configuration,
    params: ComputePeriodExternalVpnGatewaysPeriodSetLabelsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodExternalVpnGatewaysPeriodSetLabelsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodExternalVpnGatewaysPeriodSetLabelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_external_vpn_gateways_test_iam_permissions(
    configuration: &configuration::Configuration,
    params: ComputePeriodExternalVpnGatewaysPeriodTestIamPermissionsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TestPermissionsResponse,
    Error<ComputePeriodExternalVpnGatewaysPeriodTestIamPermissionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ComputePeriodExternalVpnGatewaysPeriodTestIamPermissionsError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
