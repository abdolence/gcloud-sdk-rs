...
/// struct for passing parameters to the method [`compute_zones_get`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodZonesPeriodGetParams {
...
/// struct for passing parameters to the method [`compute_zones_list`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodZonesPeriodListParams {
    /// Project ID for this request.
    pub project: String,
    /// V1 error format.
    pub dollar_xgafv: Option<String>,
...
/// struct for typed errors of method [`compute_zones_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodZonesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_zones_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodZonesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// Returns the specified Zone resource.
pub async fn compute_zones_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodZonesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Zone,
    Error<ComputePeriodZonesPeriodGetError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodZonesPeriodGetError> =
...
pub async fn compute_zones_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodZonesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::ZoneList,
    Error<ComputePeriodZonesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodZonesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
