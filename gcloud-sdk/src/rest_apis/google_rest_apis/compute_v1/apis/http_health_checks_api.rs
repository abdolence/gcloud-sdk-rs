...
pub struct ComputePeriodHttpHealthChecksPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub http_health_check: Option<crate::google_rest_apis::compute_v1::models::HttpHealthCheck>,
}
...
pub struct ComputePeriodHttpHealthChecksPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub http_health_check2: Option<crate::google_rest_apis::compute_v1::models::HttpHealthCheck>,
}
...
/// struct for typed errors of method [`compute_http_health_checks_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodHttpHealthChecksPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_http_health_checks_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodHttpHealthChecksPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_http_health_checks_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodHttpHealthChecksPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_http_health_checks_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodHttpHealthChecksPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_http_health_checks_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodHttpHealthChecksPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_http_health_checks_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodHttpHealthChecksPeriodUpdateError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified HttpHealthCheck resource.
pub async fn compute_http_health_checks_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodHttpHealthChecksPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodHttpHealthChecksPeriodDeleteError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project = params.project;
    let http_health_check = params.http_health_check;
    ...
    let local_var_uri_str = format!(
        ...
        httpHealthCheck = crate::google_rest_apis::compute_v1::apis::urlencode(http_health_check)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodHttpHealthChecksPeriodDeleteError> =
...
pub async fn compute_http_health_checks_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodHttpHealthChecksPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::HttpHealthCheck,
    Error<ComputePeriodHttpHealthChecksPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodHttpHealthChecksPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_http_health_checks_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodHttpHealthChecksPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodHttpHealthChecksPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&http_health_check);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodHttpHealthChecksPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_http_health_checks_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodHttpHealthChecksPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::HttpHealthCheckList,
    Error<ComputePeriodHttpHealthChecksPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodHttpHealthChecksPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_http_health_checks_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodHttpHealthChecksPeriodPatchParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodHttpHealthChecksPeriodPatchError>,
> {
    let local_var_configuration = configuration;
    ...
    let user_ip = params.user_ip;
    let request_id = params.request_id;
    let http_health_check2 = params.http_health_check2;
    ...
    local_var_req_builder = local_var_req_builder.json(&http_health_check2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodHttpHealthChecksPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_http_health_checks_update(
    configuration: &configuration::Configuration,
    params: ComputePeriodHttpHealthChecksPeriodUpdateParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodHttpHealthChecksPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodHttpHealthChecksPeriodUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
