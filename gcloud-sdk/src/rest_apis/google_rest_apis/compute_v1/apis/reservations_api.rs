...
pub struct ComputePeriodReservationsPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub reservation: Option<crate::google_rest_apis::compute_v1::models::Reservation>,
}
...
pub struct ComputePeriodReservationsPeriodResizeParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub reservations_resize_request:
        Option<crate::google_rest_apis::compute_v1::models::ReservationsResizeRequest>,
}
...
pub struct ComputePeriodReservationsPeriodUpdateParams {
    ...
    pub reservation2: Option<crate::google_rest_apis::compute_v1::models::Reservation>,
}

/// struct for typed errors of method [`compute_reservations_aggregated_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodReservationsPeriodAggregatedListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_reservations_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodReservationsPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_reservations_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodReservationsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_reservations_get_iam_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodReservationsPeriodGetIamPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_reservations_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodReservationsPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_reservations_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodReservationsPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_reservations_resize`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodReservationsPeriodResizeError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_reservations_set_iam_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodReservationsPeriodSetIamPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_reservations_test_iam_permissions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodReservationsPeriodTestIamPermissionsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_reservations_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodReservationsPeriodUpdateError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_reservations_aggregated_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodReservationsPeriodAggregatedListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::ReservationAggregatedList,
    Error<ComputePeriodReservationsPeriodAggregatedListError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodReservationsPeriodAggregatedListError> =
...
pub async fn compute_reservations_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodReservationsPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodReservationsPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        reservation = crate::google_rest_apis::compute_v1::apis::urlencode(reservation)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodReservationsPeriodDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_reservations_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodReservationsPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Reservation,
    Error<ComputePeriodReservationsPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodReservationsPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_reservations_get_iam_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodReservationsPeriodGetIamPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodReservationsPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodReservationsPeriodGetIamPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_reservations_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodReservationsPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodReservationsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodReservationsPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_reservations_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodReservationsPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::ReservationList,
    Error<ComputePeriodReservationsPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodReservationsPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_reservations_resize(
    configuration: &configuration::Configuration,
    params: ComputePeriodReservationsPeriodResizeParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodReservationsPeriodResizeError>,
> {
    let local_var_configuration = configuration;
    ...
    let user_ip = params.user_ip;
    let request_id = params.request_id;
    let reservations_resize_request = params.reservations_resize_request;
    ...
    local_var_req_builder = local_var_req_builder.json(&reservations_resize_request);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodReservationsPeriodResizeError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_reservations_set_iam_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodReservationsPeriodSetIamPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodReservationsPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodReservationsPeriodSetIamPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_reservations_test_iam_permissions(
    configuration: &configuration::Configuration,
    params: ComputePeriodReservationsPeriodTestIamPermissionsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TestPermissionsResponse,
    Error<ComputePeriodReservationsPeriodTestIamPermissionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodReservationsPeriodTestIamPermissionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_reservations_update(
    configuration: &configuration::Configuration,
    params: ComputePeriodReservationsPeriodUpdateParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodReservationsPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
    ...
    let reservation2 = params.reservation2;
    ...
    local_var_req_builder = local_var_req_builder.json(&reservation2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodReservationsPeriodUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
