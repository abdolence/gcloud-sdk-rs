...
#[serde(untagged)]
pub enum ComputePeriodZoneOperationsPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_zone_operations_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodZoneOperationsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_zone_operations_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodZoneOperationsPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_zone_operations_wait`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodZoneOperationsPeriodWaitError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified zone-specific Operations resource.
pub async fn compute_zone_operations_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodZoneOperationsPeriodDeleteParams,
) -> Result<(), Error<ComputePeriodZoneOperationsPeriodDeleteError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodZoneOperationsPeriodDeleteError> =
...
pub async fn compute_zone_operations_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodZoneOperationsPeriodGetParams,
) -> Result<models::Operation, Error<ComputePeriodZoneOperationsPeriodGetError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodZoneOperationsPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_zone_operations_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodZoneOperationsPeriodListParams,
) -> Result<models::OperationList, Error<ComputePeriodZoneOperationsPeriodListError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodZoneOperationsPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_zone_operations_wait(
    configuration: &configuration::Configuration,
    params: ComputePeriodZoneOperationsPeriodWaitParams,
) -> Result<models::Operation, Error<ComputePeriodZoneOperationsPeriodWaitError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodZoneOperationsPeriodWaitError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
