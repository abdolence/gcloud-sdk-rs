...
) -> Result<models::Operation, Error<ComputePeriodGlobalForwardingRulesPeriodDeleteError>> {
...
) -> Result<models::ForwardingRule, Error<ComputePeriodGlobalForwardingRulesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodGlobalForwardingRulesPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::ForwardingRuleList, Error<ComputePeriodGlobalForwardingRulesPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodGlobalForwardingRulesPeriodPatchError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodGlobalForwardingRulesPeriodSetLabelsError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodGlobalForwardingRulesPeriodSetTargetError>> {
    let local_var_configuration = configuration;
