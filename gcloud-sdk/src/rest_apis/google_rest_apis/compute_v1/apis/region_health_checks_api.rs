...
) -> Result<models::Operation, Error<ComputePeriodRegionHealthChecksPeriodDeleteError>> {
...
) -> Result<models::HealthCheck, Error<ComputePeriodRegionHealthChecksPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionHealthChecksPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::HealthCheckList, Error<ComputePeriodRegionHealthChecksPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionHealthChecksPeriodPatchError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionHealthChecksPeriodUpdateError>> {
    let local_var_configuration = configuration;
