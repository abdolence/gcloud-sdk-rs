...
) -> Result<models::Operation, Error<ComputePeriodRegionInstanceTemplatesPeriodDeleteError>> {
...
) -> Result<models::InstanceTemplate, Error<ComputePeriodRegionInstanceTemplatesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionInstanceTemplatesPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::InstanceTemplateList, Error<ComputePeriodRegionInstanceTemplatesPeriodListError>>
{
    let local_var_configuration = configuration;
