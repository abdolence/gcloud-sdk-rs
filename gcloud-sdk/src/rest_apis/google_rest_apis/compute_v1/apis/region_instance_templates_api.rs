...
pub struct ComputePeriodRegionInstanceTemplatesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub instance_template: Option<crate::google_rest_apis::compute_v1::models::InstanceTemplate>,
}
...
/// struct for typed errors of method [`compute_region_instance_templates_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionInstanceTemplatesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_instance_templates_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionInstanceTemplatesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_instance_templates_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionInstanceTemplatesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_instance_templates_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionInstanceTemplatesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified instance template. Deleting an instance template is permanent and cannot be undone.
pub async fn compute_region_instance_templates_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionInstanceTemplatesPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionInstanceTemplatesPeriodDeleteError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionInstanceTemplatesPeriodDeleteError> =
...
pub async fn compute_region_instance_templates_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionInstanceTemplatesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::InstanceTemplate,
    Error<ComputePeriodRegionInstanceTemplatesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionInstanceTemplatesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_instance_templates_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionInstanceTemplatesPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionInstanceTemplatesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionInstanceTemplatesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_instance_templates_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionInstanceTemplatesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::InstanceTemplateList,
    Error<ComputePeriodRegionInstanceTemplatesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionInstanceTemplatesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
