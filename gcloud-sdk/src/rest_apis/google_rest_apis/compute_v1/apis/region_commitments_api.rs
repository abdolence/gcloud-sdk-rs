...
pub struct ComputePeriodRegionCommitmentsPeriodInsertParams {
    ...
    pub commitment: Option<crate::google_rest_apis::compute_v1::models::Commitment>,
}
...
pub struct ComputePeriodRegionCommitmentsPeriodUpdateParams {
    ...
    pub commitment2: Option<crate::google_rest_apis::compute_v1::models::Commitment>,
}

/// struct for typed errors of method [`compute_region_commitments_aggregated_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionCommitmentsPeriodAggregatedListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_commitments_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionCommitmentsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_commitments_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionCommitmentsPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_commitments_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionCommitmentsPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_commitments_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionCommitmentsPeriodUpdateError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_region_commitments_aggregated_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionCommitmentsPeriodAggregatedListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::CommitmentAggregatedList,
    Error<ComputePeriodRegionCommitmentsPeriodAggregatedListError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionCommitmentsPeriodAggregatedListError> =
...
pub async fn compute_region_commitments_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionCommitmentsPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Commitment,
    Error<ComputePeriodRegionCommitmentsPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        commitment = crate::google_rest_apis::compute_v1::apis::urlencode(commitment)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionCommitmentsPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_commitments_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionCommitmentsPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionCommitmentsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&commitment);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionCommitmentsPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_commitments_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionCommitmentsPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::CommitmentList,
    Error<ComputePeriodRegionCommitmentsPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionCommitmentsPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_commitments_update(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionCommitmentsPeriodUpdateParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionCommitmentsPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
    ...
    let commitment2 = params.commitment2;
    ...
    local_var_req_builder = local_var_req_builder.json(&commitment2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionCommitmentsPeriodUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
