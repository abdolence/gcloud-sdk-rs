...
pub struct ComputePeriodRegionCommitmentsPeriodInsertParams {
    ...
    pub commitment: Option<models::Commitment>,
}
...
pub struct ComputePeriodRegionCommitmentsPeriodUpdateParams {
    ...
    pub commitment2: Option<models::Commitment>,
}
...
pub async fn compute_region_commitments_aggregated_list(
    ...
    models::CommitmentAggregatedList,
...
) -> Result<models::Commitment, Error<ComputePeriodRegionCommitmentsPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionCommitmentsPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::CommitmentList, Error<ComputePeriodRegionCommitmentsPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionCommitmentsPeriodUpdateError>> {
    let local_var_configuration = configuration;
