...
pub async fn compute_ssl_policies_aggregated_list(
    ...
    crate::google_rest_apis::compute_v1::models::SslPoliciesAggregatedList,
...
pub async fn compute_ssl_policies_delete(
    ...
    Error<ComputePeriodSslPoliciesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_ssl_policies_get(
    ...
    Error<ComputePeriodSslPoliciesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_ssl_policies_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSslPoliciesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_ssl_policies_list(
    ...
    Error<ComputePeriodSslPoliciesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_ssl_policies_patch(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSslPoliciesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
