...
pub struct ComputePeriodTargetTcpProxiesPeriodSetBackendServiceParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub target_tcp_proxies_set_backend_service_request: Option<
        crate::google_rest_apis::compute_v1::models::TargetTcpProxiesSetBackendServiceRequest,
    >,
}
...
pub struct ComputePeriodTargetTcpProxiesPeriodSetProxyHeaderParams {
    ...
    pub target_tcp_proxies_set_proxy_header_request:
        Option<crate::google_rest_apis::compute_v1::models::TargetTcpProxiesSetProxyHeaderRequest>,
}
...
pub async fn compute_target_tcp_proxies_aggregated_list(
    ...
    crate::google_rest_apis::compute_v1::models::TargetTcpProxyAggregatedList,
...
pub async fn compute_target_tcp_proxies_delete(
    ...
    Error<ComputePeriodTargetTcpProxiesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_tcp_proxies_get(
    ...
    Error<ComputePeriodTargetTcpProxiesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_tcp_proxies_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetTcpProxiesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_tcp_proxies_list(
    ...
    Error<ComputePeriodTargetTcpProxiesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_tcp_proxies_set_backend_service(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetTcpProxiesPeriodSetBackendServiceError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_tcp_proxies_set_proxy_header(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetTcpProxiesPeriodSetProxyHeaderError>,
> {
    let local_var_configuration = configuration;
