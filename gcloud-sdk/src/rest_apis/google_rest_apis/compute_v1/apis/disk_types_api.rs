...
) -> Result<models::DiskTypeAggregatedList, Error<ComputePeriodDiskTypesPeriodAggregatedListError>>
{
...
) -> Result<models::DiskType, Error<ComputePeriodDiskTypesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::DiskTypeList, Error<ComputePeriodDiskTypesPeriodListError>> {
    let local_var_configuration = configuration;
