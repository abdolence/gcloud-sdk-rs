...
/// struct for passing parameters to the method [`compute_disk_types_aggregated_list`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodDiskTypesPeriodAggregatedListParams {
...
/// struct for passing parameters to the method [`compute_disk_types_get`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodDiskTypesPeriodGetParams {
    /// Project ID for this request.
    pub project: String,
...
/// struct for passing parameters to the method [`compute_disk_types_list`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodDiskTypesPeriodListParams {
    /// Project ID for this request.
    pub project: String,
    /// The name of the zone for this request.
    pub zone: String,
...
/// struct for typed errors of method [`compute_disk_types_aggregated_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodDiskTypesPeriodAggregatedListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_disk_types_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodDiskTypesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_disk_types_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodDiskTypesPeriodListError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_disk_types_aggregated_list(
    ...
    crate::google_rest_apis::compute_v1::models::DiskTypeAggregatedList,
    Error<ComputePeriodDiskTypesPeriodAggregatedListError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodDiskTypesPeriodAggregatedListError> =
...
pub async fn compute_disk_types_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodDiskTypesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::DiskType,
    Error<ComputePeriodDiskTypesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    let disk_type = params.disk_type;
    let dollar_xgafv = params.dollar_xgafv;
    let access_token = params.access_token;
    let alt = params.alt;
    let callback = params.callback;
    ...
    let local_var_uri_str = format!(
        ...
        diskType = crate::google_rest_apis::compute_v1::apis::urlencode(disk_type)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodDiskTypesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_disk_types_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodDiskTypesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::DiskTypeList,
    Error<ComputePeriodDiskTypesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodDiskTypesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
