...
/// struct for typed errors of method [`compute_node_types_aggregated_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNodeTypesPeriodAggregatedListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_node_types_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNodeTypesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_node_types_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodNodeTypesPeriodListError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_node_types_aggregated_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodNodeTypesPeriodAggregatedListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::NodeTypeAggregatedList,
    Error<ComputePeriodNodeTypesPeriodAggregatedListError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNodeTypesPeriodAggregatedListError> =
...
pub async fn compute_node_types_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodNodeTypesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::NodeType,
    Error<ComputePeriodNodeTypesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    let local_var_uri_str = format!(
        ...
        nodeType = crate::google_rest_apis::compute_v1::apis::urlencode(node_type)
    );
    let mut local_var_req_builder =
        local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNodeTypesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_node_types_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodNodeTypesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::NodeTypeList,
    Error<ComputePeriodNodeTypesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodNodeTypesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
