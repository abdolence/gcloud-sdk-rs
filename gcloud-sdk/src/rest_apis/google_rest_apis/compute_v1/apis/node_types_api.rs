...
) -> Result<models::NodeTypeAggregatedList, Error<ComputePeriodNodeTypesPeriodAggregatedListError>>
{
...
) -> Result<models::NodeType, Error<ComputePeriodNodeTypesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::NodeTypeList, Error<ComputePeriodNodeTypesPeriodListError>> {
    let local_var_configuration = configuration;
