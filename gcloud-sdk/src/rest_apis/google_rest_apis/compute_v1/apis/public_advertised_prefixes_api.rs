...
pub struct ComputePeriodPublicAdvertisedPrefixesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub public_advertised_prefix:
        Option<crate::google_rest_apis::compute_v1::models::PublicAdvertisedPrefix>,
}
...
pub async fn compute_public_advertised_prefixes_announce(
    ...
    Error<ComputePeriodPublicAdvertisedPrefixesPeriodAnnounceError>,
> {
...
pub async fn compute_public_advertised_prefixes_delete(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodPublicAdvertisedPrefixesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_public_advertised_prefixes_get(
    ...
    crate::google_rest_apis::compute_v1::models::PublicAdvertisedPrefix,
...
pub async fn compute_public_advertised_prefixes_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodPublicAdvertisedPrefixesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_public_advertised_prefixes_list(
    ...
    crate::google_rest_apis::compute_v1::models::PublicAdvertisedPrefixList,
...
pub async fn compute_public_advertised_prefixes_patch(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodPublicAdvertisedPrefixesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_public_advertised_prefixes_withdraw(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodPublicAdvertisedPrefixesPeriodWithdrawError>,
> {
    let local_var_configuration = configuration;
