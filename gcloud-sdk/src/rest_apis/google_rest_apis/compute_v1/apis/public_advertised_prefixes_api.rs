...
pub struct ComputePeriodPublicAdvertisedPrefixesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub public_advertised_prefix: Option<models::PublicAdvertisedPrefix>,
}
...
pub struct ComputePeriodPublicAdvertisedPrefixesPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub public_advertised_prefix2: Option<models::PublicAdvertisedPrefix>,
}
...
/// struct for typed errors of method [`compute_public_advertised_prefixes_announce`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPublicAdvertisedPrefixesPeriodAnnounceError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_public_advertised_prefixes_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPublicAdvertisedPrefixesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_public_advertised_prefixes_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPublicAdvertisedPrefixesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_public_advertised_prefixes_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPublicAdvertisedPrefixesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_public_advertised_prefixes_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPublicAdvertisedPrefixesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_public_advertised_prefixes_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPublicAdvertisedPrefixesPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_public_advertised_prefixes_withdraw`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodPublicAdvertisedPrefixesPeriodWithdrawError {
    UnknownValue(serde_json::Value),
}

/// Announces the specified PublicAdvertisedPrefix
pub async fn compute_public_advertised_prefixes_announce(
    configuration: &configuration::Configuration,
    params: ComputePeriodPublicAdvertisedPrefixesPeriodAnnounceParams,
) -> Result<models::Operation, Error<ComputePeriodPublicAdvertisedPrefixesPeriodAnnounceError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project = params.project;
    let public_advertised_prefix = params.public_advertised_prefix;
    ...
    let local_var_uri_str = format!(
        ...
        publicAdvertisedPrefix =
            crate::google_rest_apis::compute_v1::apis::urlencode(public_advertised_prefix)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPublicAdvertisedPrefixesPeriodAnnounceError> =
...
pub async fn compute_public_advertised_prefixes_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodPublicAdvertisedPrefixesPeriodDeleteParams,
) -> Result<models::Operation, Error<ComputePeriodPublicAdvertisedPrefixesPeriodDeleteError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPublicAdvertisedPrefixesPeriodDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_public_advertised_prefixes_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodPublicAdvertisedPrefixesPeriodGetParams,
) -> Result<
    models::PublicAdvertisedPrefix,
    Error<ComputePeriodPublicAdvertisedPrefixesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPublicAdvertisedPrefixesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_public_advertised_prefixes_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodPublicAdvertisedPrefixesPeriodInsertParams,
) -> Result<models::Operation, Error<ComputePeriodPublicAdvertisedPrefixesPeriodInsertError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&public_advertised_prefix);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPublicAdvertisedPrefixesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_public_advertised_prefixes_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodPublicAdvertisedPrefixesPeriodListParams,
) -> Result<
    models::PublicAdvertisedPrefixList,
    Error<ComputePeriodPublicAdvertisedPrefixesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPublicAdvertisedPrefixesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_public_advertised_prefixes_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodPublicAdvertisedPrefixesPeriodPatchParams,
) -> Result<models::Operation, Error<ComputePeriodPublicAdvertisedPrefixesPeriodPatchError>> {
    let local_var_configuration = configuration;
    ...
    let user_ip = params.user_ip;
    let request_id = params.request_id;
    let public_advertised_prefix2 = params.public_advertised_prefix2;
    ...
    local_var_req_builder = local_var_req_builder.json(&public_advertised_prefix2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPublicAdvertisedPrefixesPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_public_advertised_prefixes_withdraw(
    configuration: &configuration::Configuration,
    params: ComputePeriodPublicAdvertisedPrefixesPeriodWithdrawParams,
) -> Result<models::Operation, Error<ComputePeriodPublicAdvertisedPrefixesPeriodWithdrawError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodPublicAdvertisedPrefixesPeriodWithdrawError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
