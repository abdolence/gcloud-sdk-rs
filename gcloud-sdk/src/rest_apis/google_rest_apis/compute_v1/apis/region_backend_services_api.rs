...
pub struct ComputePeriodRegionBackendServicesPeriodGetHealthParams {
    ...
    /// Legacy name for parameter that has been superseded by `quotaUser`.
    pub user_ip: Option<String>,
    pub resource_group_reference:
        Option<crate::google_rest_apis::compute_v1::models::ResourceGroupReference>,
}
...
pub struct ComputePeriodRegionBackendServicesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub backend_service: Option<crate::google_rest_apis::compute_v1::models::BackendService>,
}
...
pub struct ComputePeriodRegionBackendServicesPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub backend_service2: Option<crate::google_rest_apis::compute_v1::models::BackendService>,
}
...
pub struct ComputePeriodRegionBackendServicesPeriodSetSecurityPolicyParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub security_policy_reference:
        Option<crate::google_rest_apis::compute_v1::models::SecurityPolicyReference>,
}
...
/// struct for typed errors of method [`compute_region_backend_services_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_get_health`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodGetHealthError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_get_iam_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodGetIamPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_list_usable`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodListUsableError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_set_iam_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodSetIamPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_set_security_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodSetSecurityPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_test_iam_permissions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodTestIamPermissionsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_backend_services_update`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionBackendServicesPeriodUpdateError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified regional BackendService resource.
pub async fn compute_region_backend_services_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionBackendServicesPeriodDeleteError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionBackendServicesPeriodDeleteError> =
...
pub async fn compute_region_backend_services_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::BackendService,
    Error<ComputePeriodRegionBackendServicesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionBackendServicesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_backend_services_get_health(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodGetHealthParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::BackendServiceGroupHealth,
    Error<ComputePeriodRegionBackendServicesPeriodGetHealthError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionBackendServicesPeriodGetHealthError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_backend_services_get_iam_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodGetIamPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodRegionBackendServicesPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionBackendServicesPeriodGetIamPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_backend_services_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionBackendServicesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionBackendServicesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_backend_services_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::BackendServiceList,
    Error<ComputePeriodRegionBackendServicesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionBackendServicesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_backend_services_list_usable(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodListUsableParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::BackendServiceListUsable,
    Error<ComputePeriodRegionBackendServicesPeriodListUsableError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionBackendServicesPeriodListUsableError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_backend_services_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodPatchParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionBackendServicesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionBackendServicesPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_backend_services_set_iam_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodSetIamPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodRegionBackendServicesPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionBackendServicesPeriodSetIamPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_backend_services_set_security_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodSetSecurityPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionBackendServicesPeriodSetSecurityPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ComputePeriodRegionBackendServicesPeriodSetSecurityPolicyError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_backend_services_test_iam_permissions(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodTestIamPermissionsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TestPermissionsResponse,
    Error<ComputePeriodRegionBackendServicesPeriodTestIamPermissionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<
            ComputePeriodRegionBackendServicesPeriodTestIamPermissionsError,
        > = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_backend_services_update(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionBackendServicesPeriodUpdateParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionBackendServicesPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionBackendServicesPeriodUpdateError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
