...
) -> Result<models::Operation, Error<ComputePeriodRegionBackendServicesPeriodDeleteError>> {
...
) -> Result<models::BackendService, Error<ComputePeriodRegionBackendServicesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Policy, Error<ComputePeriodRegionBackendServicesPeriodGetIamPolicyError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionBackendServicesPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::BackendServiceList, Error<ComputePeriodRegionBackendServicesPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionBackendServicesPeriodPatchError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Policy, Error<ComputePeriodRegionBackendServicesPeriodSetIamPolicyError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionBackendServicesPeriodSetSecurityPolicyError>>
{
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionBackendServicesPeriodUpdateError>> {
    let local_var_configuration = configuration;
