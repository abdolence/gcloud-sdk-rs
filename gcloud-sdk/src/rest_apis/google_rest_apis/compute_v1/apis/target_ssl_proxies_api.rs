...
pub struct ComputePeriodTargetSslProxiesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub target_ssl_proxy: Option<crate::google_rest_apis::compute_v1::models::TargetSslProxy>,
}
...
pub struct ComputePeriodTargetSslProxiesPeriodSetBackendServiceParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub target_ssl_proxies_set_backend_service_request: Option<
        crate::google_rest_apis::compute_v1::models::TargetSslProxiesSetBackendServiceRequest,
    >,
}
...
pub struct ComputePeriodTargetSslProxiesPeriodSetCertificateMapParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub target_ssl_proxies_set_certificate_map_request: Option<
        crate::google_rest_apis::compute_v1::models::TargetSslProxiesSetCertificateMapRequest,
    >,
}
...
pub struct ComputePeriodTargetSslProxiesPeriodSetProxyHeaderParams {
    ...
    pub target_ssl_proxies_set_proxy_header_request:
        Option<crate::google_rest_apis::compute_v1::models::TargetSslProxiesSetProxyHeaderRequest>,
}
...
pub struct ComputePeriodTargetSslProxiesPeriodSetSslCertificatesParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub target_ssl_proxies_set_ssl_certificates_request: Option<
        crate::google_rest_apis::compute_v1::models::TargetSslProxiesSetSslCertificatesRequest,
    >,
}
...
pub async fn compute_target_ssl_proxies_delete(
    ...
    Error<ComputePeriodTargetSslProxiesPeriodDeleteError>,
> {
...
pub async fn compute_target_ssl_proxies_get(
    ...
    crate::google_rest_apis::compute_v1::models::TargetSslProxy,
    Error<ComputePeriodTargetSslProxiesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_ssl_proxies_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetSslProxiesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_ssl_proxies_list(
    ...
    crate::google_rest_apis::compute_v1::models::TargetSslProxyList,
    Error<ComputePeriodTargetSslProxiesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_ssl_proxies_set_backend_service(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetSslProxiesPeriodSetBackendServiceError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_ssl_proxies_set_certificate_map(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetSslProxiesPeriodSetCertificateMapError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_ssl_proxies_set_proxy_header(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetSslProxiesPeriodSetProxyHeaderError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_ssl_proxies_set_ssl_certificates(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetSslProxiesPeriodSetSslCertificatesError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_target_ssl_proxies_set_ssl_policy(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetSslProxiesPeriodSetSslPolicyError>,
> {
    let local_var_configuration = configuration;
