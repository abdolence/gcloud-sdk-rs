...
pub struct ComputePeriodRegionHealthCheckServicesPeriodInsertParams {
    ...
    pub health_check_service:
        Option<crate::google_rest_apis::compute_v1::models::HealthCheckService>,
}
...
pub async fn compute_region_health_check_services_delete(
    ...
    Error<ComputePeriodRegionHealthCheckServicesPeriodDeleteError>,
> {
...
pub async fn compute_region_health_check_services_get(
    ...
    crate::google_rest_apis::compute_v1::models::HealthCheckService,
    Error<ComputePeriodRegionHealthCheckServicesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_region_health_check_services_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionHealthCheckServicesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_region_health_check_services_list(
    ...
    crate::google_rest_apis::compute_v1::models::HealthCheckServicesList,
...
pub async fn compute_region_health_check_services_patch(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionHealthCheckServicesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
