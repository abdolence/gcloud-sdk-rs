...
pub struct ComputePeriodRegionHealthCheckServicesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub health_check_service: Option<models::HealthCheckService>,
}
...
pub struct ComputePeriodRegionHealthCheckServicesPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub health_check_service2: Option<models::HealthCheckService>,
}

/// struct for typed errors of method [`compute_region_health_check_services_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionHealthCheckServicesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_health_check_services_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionHealthCheckServicesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_health_check_services_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionHealthCheckServicesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_health_check_services_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionHealthCheckServicesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_region_health_check_services_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionHealthCheckServicesPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified regional HealthCheckService.
pub async fn compute_region_health_check_services_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionHealthCheckServicesPeriodDeleteParams,
) -> Result<models::Operation, Error<ComputePeriodRegionHealthCheckServicesPeriodDeleteError>> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project = params.project;
    let region = params.region;
    let health_check_service = params.health_check_service;
    ...
    let local_var_uri_str = format!(
        ...
        healthCheckService =
            crate::google_rest_apis::compute_v1::apis::urlencode(health_check_service)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionHealthCheckServicesPeriodDeleteError> =
...
pub async fn compute_region_health_check_services_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionHealthCheckServicesPeriodGetParams,
) -> Result<models::HealthCheckService, Error<ComputePeriodRegionHealthCheckServicesPeriodGetError>>
{
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionHealthCheckServicesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_health_check_services_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionHealthCheckServicesPeriodInsertParams,
) -> Result<models::Operation, Error<ComputePeriodRegionHealthCheckServicesPeriodInsertError>> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&health_check_service);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionHealthCheckServicesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_health_check_services_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionHealthCheckServicesPeriodListParams,
) -> Result<
    models::HealthCheckServicesList,
    Error<ComputePeriodRegionHealthCheckServicesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionHealthCheckServicesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_region_health_check_services_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodRegionHealthCheckServicesPeriodPatchParams,
) -> Result<models::Operation, Error<ComputePeriodRegionHealthCheckServicesPeriodPatchError>> {
    let local_var_configuration = configuration;
    ...
    let user_ip = params.user_ip;
    let request_id = params.request_id;
    let health_check_service2 = params.health_check_service2;
    ...
    local_var_req_builder = local_var_req_builder.json(&health_check_service2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionHealthCheckServicesPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
