...
pub struct ComputePeriodForwardingRulesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub forwarding_rule: Option<crate::google_rest_apis::compute_v1::models::ForwardingRule>,
}
...
pub struct ComputePeriodForwardingRulesPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub forwarding_rule2: Option<crate::google_rest_apis::compute_v1::models::ForwardingRule>,
}
...
pub struct ComputePeriodForwardingRulesPeriodSetTargetParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub target_reference: Option<crate::google_rest_apis::compute_v1::models::TargetReference>,
}

/// struct for typed errors of method [`compute_forwarding_rules_aggregated_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodForwardingRulesPeriodAggregatedListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_forwarding_rules_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodForwardingRulesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_forwarding_rules_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodForwardingRulesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_forwarding_rules_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodForwardingRulesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_forwarding_rules_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodForwardingRulesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_forwarding_rules_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodForwardingRulesPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_forwarding_rules_set_labels`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodForwardingRulesPeriodSetLabelsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_forwarding_rules_set_target`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodForwardingRulesPeriodSetTargetError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_forwarding_rules_aggregated_list(
    ...
    crate::google_rest_apis::compute_v1::models::ForwardingRuleAggregatedList,
    Error<ComputePeriodForwardingRulesPeriodAggregatedListError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodForwardingRulesPeriodAggregatedListError> =
...
pub async fn compute_forwarding_rules_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodForwardingRulesPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodForwardingRulesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
    ...
    let forwarding_rule = params.forwarding_rule;
    let dollar_xgafv = params.dollar_xgafv;
    let access_token = params.access_token;
    let alt = params.alt;
    let callback = params.callback;
    ...
    let local_var_uri_str = format!(
        ...
        forwardingRule = crate::google_rest_apis::compute_v1::apis::urlencode(forwarding_rule)
    );
    let mut local_var_req_builder =
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodForwardingRulesPeriodDeleteError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_forwarding_rules_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodForwardingRulesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::ForwardingRule,
    Error<ComputePeriodForwardingRulesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodForwardingRulesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_forwarding_rules_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodForwardingRulesPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodForwardingRulesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&forwarding_rule);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodForwardingRulesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_forwarding_rules_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodForwardingRulesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::ForwardingRuleList,
    Error<ComputePeriodForwardingRulesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodForwardingRulesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_forwarding_rules_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodForwardingRulesPeriodPatchParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodForwardingRulesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
    ...
    let user_ip = params.user_ip;
    let request_id = params.request_id;
    let forwarding_rule2 = params.forwarding_rule2;
    ...
    local_var_req_builder = local_var_req_builder.json(&forwarding_rule2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodForwardingRulesPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_forwarding_rules_set_labels(
    configuration: &configuration::Configuration,
    params: ComputePeriodForwardingRulesPeriodSetLabelsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodForwardingRulesPeriodSetLabelsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodForwardingRulesPeriodSetLabelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_forwarding_rules_set_target(
    configuration: &configuration::Configuration,
    params: ComputePeriodForwardingRulesPeriodSetTargetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodForwardingRulesPeriodSetTargetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodForwardingRulesPeriodSetTargetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
