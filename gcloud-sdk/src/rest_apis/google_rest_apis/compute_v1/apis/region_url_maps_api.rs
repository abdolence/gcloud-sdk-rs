...
pub struct ComputePeriodRegionUrlMapsPeriodValidateParams {
    ...
    /// Legacy name for parameter that has been superseded by `quotaUser`.
    pub user_ip: Option<String>,
    pub region_url_maps_validate_request:
        Option<crate::google_rest_apis::compute_v1::models::RegionUrlMapsValidateRequest>,
}
...
pub async fn compute_region_url_maps_delete(
    ...
    Error<ComputePeriodRegionUrlMapsPeriodDeleteError>,
> {
...
pub async fn compute_region_url_maps_get(
    ...
    Error<ComputePeriodRegionUrlMapsPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_region_url_maps_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionUrlMapsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_region_url_maps_list(
    ...
    Error<ComputePeriodRegionUrlMapsPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_region_url_maps_patch(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionUrlMapsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_region_url_maps_update(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodRegionUrlMapsPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_region_url_maps_validate(
    ...
    Error<ComputePeriodRegionUrlMapsPeriodValidateError>,
> {
    let local_var_configuration = configuration;
