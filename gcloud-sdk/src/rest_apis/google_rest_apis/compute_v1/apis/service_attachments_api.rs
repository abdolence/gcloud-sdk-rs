...
pub struct ComputePeriodServiceAttachmentsPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub service_attachment: Option<models::ServiceAttachment>,
}
...
pub struct ComputePeriodServiceAttachmentsPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub service_attachment2: Option<models::ServiceAttachment>,
}
...
pub async fn compute_service_attachments_aggregated_list(
    ...
    models::ServiceAttachmentAggregatedList,
...
) -> Result<models::Operation, Error<ComputePeriodServiceAttachmentsPeriodDeleteError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::ServiceAttachment, Error<ComputePeriodServiceAttachmentsPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Policy, Error<ComputePeriodServiceAttachmentsPeriodGetIamPolicyError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodServiceAttachmentsPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::ServiceAttachmentList, Error<ComputePeriodServiceAttachmentsPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodServiceAttachmentsPeriodPatchError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Policy, Error<ComputePeriodServiceAttachmentsPeriodSetIamPolicyError>> {
    let local_var_configuration = configuration;
