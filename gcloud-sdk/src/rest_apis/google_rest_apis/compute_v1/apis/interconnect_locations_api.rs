...
/// struct for typed errors of method [`compute_interconnect_locations_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectLocationsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_interconnect_locations_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectLocationsPeriodListError {
    UnknownValue(serde_json::Value),
}
...
> {
    ...
    let interconnect_location = params.interconnect_location;
    ...
    let local_var_uri_str = format!(
        ...
        interconnectLocation =
            crate::google_rest_apis::compute_v1::apis::urlencode(interconnect_location)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectLocationsPeriodGetError> =
...
pub async fn compute_interconnect_locations_list(
    configuration: &configuration::Configuration,
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectLocationsPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
