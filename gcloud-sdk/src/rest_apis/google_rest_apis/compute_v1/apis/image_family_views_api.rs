...
pub struct ComputePeriodImageFamilyViewsPeriodGetParams {
...
/// struct for typed errors of method [`compute_image_family_views_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodImageFamilyViewsPeriodGetError {
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodImageFamilyViewsPeriodGetError> =
