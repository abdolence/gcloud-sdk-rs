...
/// struct for passing parameters to the method [`compute_interconnect_remote_locations_get`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodInterconnectRemoteLocationsPeriodGetParams {
...
/// struct for passing parameters to the method [`compute_interconnect_remote_locations_list`]
#[derive(Clone, Debug, Default)]
pub struct ComputePeriodInterconnectRemoteLocationsPeriodListParams {
    /// Project ID for this request.
    pub project: String,
    /// V1 error format.
    pub dollar_xgafv: Option<String>,
...
/// struct for typed errors of method [`compute_interconnect_remote_locations_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectRemoteLocationsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_interconnect_remote_locations_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodInterconnectRemoteLocationsPeriodListError {
    UnknownValue(serde_json::Value),
}
...
pub async fn compute_interconnect_remote_locations_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodInterconnectRemoteLocationsPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::InterconnectRemoteLocation,
    Error<ComputePeriodInterconnectRemoteLocationsPeriodGetError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project = params.project;
    let interconnect_remote_location = params.interconnect_remote_location;
    ...
    let local_var_uri_str = format!(
        ...
        interconnectRemoteLocation =
            crate::google_rest_apis::compute_v1::apis::urlencode(interconnect_remote_location)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectRemoteLocationsPeriodGetError> =
...
pub async fn compute_interconnect_remote_locations_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodInterconnectRemoteLocationsPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::InterconnectRemoteLocationList,
    Error<ComputePeriodInterconnectRemoteLocationsPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodInterconnectRemoteLocationsPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
