...
pub struct ComputePeriodSnapshotSettingsPeriodPatchParams {
    ...
    pub snapshot_settings: Option<crate::google_rest_apis::compute_v1::models::SnapshotSettings>,
}

/// struct for typed errors of method [`compute_snapshot_settings_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSnapshotSettingsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_snapshot_settings_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSnapshotSettingsPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// Get snapshot settings.
pub async fn compute_snapshot_settings_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodSnapshotSettingsPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::SnapshotSettings,
    Error<ComputePeriodSnapshotSettingsPeriodGetError>,
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSnapshotSettingsPeriodGetError> =
...
pub async fn compute_snapshot_settings_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodSnapshotSettingsPeriodPatchParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSnapshotSettingsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
    ...
    let snapshot_settings = params.snapshot_settings;
    ...
    local_var_req_builder = local_var_req_builder.json(&snapshot_settings);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSnapshotSettingsPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
