...
pub struct ComputePeriodSnapshotSettingsPeriodPatchParams {
    ...
    pub snapshot_settings: Option<models::SnapshotSettings>,
}
...
) -> Result<models::SnapshotSettings, Error<ComputePeriodSnapshotSettingsPeriodGetError>> {
...
) -> Result<models::Operation, Error<ComputePeriodSnapshotSettingsPeriodPatchError>> {
    let local_var_configuration = configuration;
