...
pub struct ComputePeriodRegionZonesPeriodListParams {
...
/// struct for typed errors of method [`compute_region_zones_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodRegionZonesPeriodListError {
...
> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodRegionZonesPeriodListError> =
