...
pub struct ComputePeriodTargetGrpcProxiesPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub target_grpc_proxy: Option<crate::google_rest_apis::compute_v1::models::TargetGrpcProxy>,
}
...
pub struct ComputePeriodTargetGrpcProxiesPeriodPatchParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub target_grpc_proxy2: Option<crate::google_rest_apis::compute_v1::models::TargetGrpcProxy>,
}

/// struct for typed errors of method [`compute_target_grpc_proxies_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodTargetGrpcProxiesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_target_grpc_proxies_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodTargetGrpcProxiesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_target_grpc_proxies_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodTargetGrpcProxiesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_target_grpc_proxies_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodTargetGrpcProxiesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_target_grpc_proxies_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodTargetGrpcProxiesPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified TargetGrpcProxy in the given scope
pub async fn compute_target_grpc_proxies_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodTargetGrpcProxiesPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetGrpcProxiesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project = params.project;
    let target_grpc_proxy = params.target_grpc_proxy;
    ...
    let local_var_uri_str = format!(
        ...
        targetGrpcProxy = crate::google_rest_apis::compute_v1::apis::urlencode(target_grpc_proxy)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodTargetGrpcProxiesPeriodDeleteError> =
...
pub async fn compute_target_grpc_proxies_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodTargetGrpcProxiesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TargetGrpcProxy,
    Error<ComputePeriodTargetGrpcProxiesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodTargetGrpcProxiesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_target_grpc_proxies_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodTargetGrpcProxiesPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetGrpcProxiesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    local_var_req_builder = local_var_req_builder.json(&target_grpc_proxy);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodTargetGrpcProxiesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_target_grpc_proxies_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodTargetGrpcProxiesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TargetGrpcProxyList,
    Error<ComputePeriodTargetGrpcProxiesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodTargetGrpcProxiesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_target_grpc_proxies_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodTargetGrpcProxiesPeriodPatchParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodTargetGrpcProxiesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
    ...
    let user_ip = params.user_ip;
    let request_id = params.request_id;
    let target_grpc_proxy2 = params.target_grpc_proxy2;
    ...
    local_var_req_builder = local_var_req_builder.json(&target_grpc_proxy2);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodTargetGrpcProxiesPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
