...
pub struct ComputePeriodMachineImagesPeriodInsertParams {
    ...
    pub machine_image: Option<crate::google_rest_apis::compute_v1::models::MachineImage>,
}
...
pub struct ComputePeriodMachineImagesPeriodSetIamPolicyParams {
    ...
    /// Legacy name for parameter that has been superseded by `quotaUser`.
    pub user_ip: Option<String>,
    pub global_set_policy_request:
        Option<crate::google_rest_apis::compute_v1::models::GlobalSetPolicyRequest>,
}
...
/// struct for typed errors of method [`compute_machine_images_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodMachineImagesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_machine_images_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodMachineImagesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_machine_images_get_iam_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodMachineImagesPeriodGetIamPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_machine_images_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodMachineImagesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_machine_images_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodMachineImagesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_machine_images_set_iam_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodMachineImagesPeriodSetIamPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_machine_images_test_iam_permissions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodMachineImagesPeriodTestIamPermissionsError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified machine image. Deleting a machine image is permanent and cannot be undone.
pub async fn compute_machine_images_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodMachineImagesPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodMachineImagesPeriodDeleteError>,
> {
    let local_var_configuration = configuration;

    // unbox the parameters
    let project = params.project;
    let machine_image = params.machine_image;
    ...
    let local_var_uri_str = format!(
        ...
        machineImage = crate::google_rest_apis::compute_v1::apis::urlencode(machine_image)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodMachineImagesPeriodDeleteError> =
...
pub async fn compute_machine_images_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodMachineImagesPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::MachineImage,
    Error<ComputePeriodMachineImagesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodMachineImagesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_machine_images_get_iam_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodMachineImagesPeriodGetIamPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodMachineImagesPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodMachineImagesPeriodGetIamPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_machine_images_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodMachineImagesPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodMachineImagesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    let user_ip = params.user_ip;
    let request_id = params.request_id;
    let source_instance = params.source_instance;
    let machine_image = params.machine_image;
    ...
    if let Some(ref local_var_str) = source_instance {
        local_var_req_builder =
            local_var_req_builder.query(&[("sourceInstance", &local_var_str.to_string())]);
    }
    if let Some(ref local_var_user_agent) = local_var_configuration.user_agent {
        local_var_req_builder =
            local_var_req_builder.header(reqwest::header::USER_AGENT, local_var_user_agent.clone());
    ...
    local_var_req_builder = local_var_req_builder.json(&machine_image);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodMachineImagesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_machine_images_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodMachineImagesPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::MachineImageList,
    Error<ComputePeriodMachineImagesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodMachineImagesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_machine_images_set_iam_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodMachineImagesPeriodSetIamPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodMachineImagesPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodMachineImagesPeriodSetIamPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_machine_images_test_iam_permissions(
    configuration: &configuration::Configuration,
    params: ComputePeriodMachineImagesPeriodTestIamPermissionsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TestPermissionsResponse,
    Error<ComputePeriodMachineImagesPeriodTestIamPermissionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodMachineImagesPeriodTestIamPermissionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
