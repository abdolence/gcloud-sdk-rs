...
pub struct ComputePeriodMachineImagesPeriodInsertParams {
    ...
    pub machine_image: Option<models::MachineImage>,
}
...
) -> Result<models::Operation, Error<ComputePeriodMachineImagesPeriodDeleteError>> {
...
) -> Result<models::MachineImage, Error<ComputePeriodMachineImagesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Policy, Error<ComputePeriodMachineImagesPeriodGetIamPolicyError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodMachineImagesPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::MachineImageList, Error<ComputePeriodMachineImagesPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Policy, Error<ComputePeriodMachineImagesPeriodSetIamPolicyError>> {
    let local_var_configuration = configuration;
