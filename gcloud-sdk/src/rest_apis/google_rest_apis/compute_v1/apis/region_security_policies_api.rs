...
) -> Result<models::Operation, Error<ComputePeriodRegionSecurityPoliciesPeriodAddRuleError>> {
...
) -> Result<models::Operation, Error<ComputePeriodRegionSecurityPoliciesPeriodDeleteError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::SecurityPolicy, Error<ComputePeriodRegionSecurityPoliciesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::SecurityPolicyRule, Error<ComputePeriodRegionSecurityPoliciesPeriodGetRuleError>>
{
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionSecurityPoliciesPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::SecurityPolicyList, Error<ComputePeriodRegionSecurityPoliciesPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionSecurityPoliciesPeriodPatchError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionSecurityPoliciesPeriodPatchRuleError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionSecurityPoliciesPeriodRemoveRuleError>> {
    let local_var_configuration = configuration;
