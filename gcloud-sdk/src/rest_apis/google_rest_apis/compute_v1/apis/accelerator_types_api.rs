...
pub async fn compute_accelerator_types_aggregated_list(
    ...
    models::AcceleratorTypeAggregatedList,
...
) -> Result<models::AcceleratorType, Error<ComputePeriodAcceleratorTypesPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::AcceleratorTypeList, Error<ComputePeriodAcceleratorTypesPeriodListError>> {
    let local_var_configuration = configuration;
