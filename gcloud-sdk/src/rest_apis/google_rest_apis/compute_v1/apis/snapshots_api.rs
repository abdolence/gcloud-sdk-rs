...
) -> Result<models::Operation, Error<ComputePeriodSnapshotsPeriodDeleteError>> {
...
) -> Result<models::Snapshot, Error<ComputePeriodSnapshotsPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Policy, Error<ComputePeriodSnapshotsPeriodGetIamPolicyError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodSnapshotsPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::SnapshotList, Error<ComputePeriodSnapshotsPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Policy, Error<ComputePeriodSnapshotsPeriodSetIamPolicyError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodSnapshotsPeriodSetLabelsError>> {
    let local_var_configuration = configuration;
