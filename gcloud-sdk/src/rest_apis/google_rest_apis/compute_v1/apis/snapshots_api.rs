...
pub struct ComputePeriodSnapshotsPeriodInsertParams {
    ...
    /// An optional request ID to identify requests. Specify a unique request ID so that if you must retry your request, the server will know to ignore the request if it has already been completed. For example, consider a situation where you make an initial request and the request times out. If you make the request again with the same request ID, the server can check if original operation with the same request ID was received, and if so, will ignore the second request. This prevents clients from accidentally creating duplicate commitments. The request ID must be a valid UUID with the exception that zero UUID is not supported ( 00000000-0000-0000-0000-000000000000).
    pub request_id: Option<String>,
    pub snapshot: Option<crate::google_rest_apis::compute_v1::models::Snapshot>,
}
...
/// struct for typed errors of method [`compute_snapshots_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSnapshotsPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_snapshots_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSnapshotsPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_snapshots_get_iam_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSnapshotsPeriodGetIamPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_snapshots_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSnapshotsPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_snapshots_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSnapshotsPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_snapshots_set_iam_policy`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSnapshotsPeriodSetIamPolicyError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_snapshots_set_labels`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSnapshotsPeriodSetLabelsError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_snapshots_test_iam_permissions`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodSnapshotsPeriodTestIamPermissionsError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified Snapshot resource. Keep in mind that deleting a single snapshot might not necessarily delete all the data on that snapshot. If any data on the snapshot that is marked for deletion is needed for subsequent snapshots, the data will be moved to the next corresponding snapshot. For more information, see Deleting snapshots.
pub async fn compute_snapshots_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodSnapshotsPeriodDeleteParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSnapshotsPeriodDeleteError>,
> {
    ...
    let local_var_uri_str = format!(
        ...
        snapshot = crate::google_rest_apis::compute_v1::apis::urlencode(snapshot)
    );
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSnapshotsPeriodDeleteError> =
...
pub async fn compute_snapshots_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodSnapshotsPeriodGetParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Snapshot,
    Error<ComputePeriodSnapshotsPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSnapshotsPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_snapshots_get_iam_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodSnapshotsPeriodGetIamPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodSnapshotsPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSnapshotsPeriodGetIamPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_snapshots_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodSnapshotsPeriodInsertParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSnapshotsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSnapshotsPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_snapshots_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodSnapshotsPeriodListParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::SnapshotList,
    Error<ComputePeriodSnapshotsPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSnapshotsPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_snapshots_set_iam_policy(
    configuration: &configuration::Configuration,
    params: ComputePeriodSnapshotsPeriodSetIamPolicyParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Policy,
    Error<ComputePeriodSnapshotsPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSnapshotsPeriodSetIamPolicyError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_snapshots_set_labels(
    configuration: &configuration::Configuration,
    params: ComputePeriodSnapshotsPeriodSetLabelsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodSnapshotsPeriodSetLabelsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSnapshotsPeriodSetLabelsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_snapshots_test_iam_permissions(
    configuration: &configuration::Configuration,
    params: ComputePeriodSnapshotsPeriodTestIamPermissionsParams,
) -> Result<
    crate::google_rest_apis::compute_v1::models::TestPermissionsResponse,
    Error<ComputePeriodSnapshotsPeriodTestIamPermissionsError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodSnapshotsPeriodTestIamPermissionsError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
