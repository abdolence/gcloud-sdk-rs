...
/// struct for typed errors of method [`compute_global_public_delegated_prefixes_delete`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodGlobalPublicDelegatedPrefixesPeriodDeleteError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_global_public_delegated_prefixes_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodGlobalPublicDelegatedPrefixesPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_global_public_delegated_prefixes_insert`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodGlobalPublicDelegatedPrefixesPeriodInsertError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_global_public_delegated_prefixes_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodGlobalPublicDelegatedPrefixesPeriodListError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`compute_global_public_delegated_prefixes_patch`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ComputePeriodGlobalPublicDelegatedPrefixesPeriodPatchError {
    UnknownValue(serde_json::Value),
}

/// Deletes the specified global PublicDelegatedPrefix.
pub async fn compute_global_public_delegated_prefixes_delete(
    configuration: &configuration::Configuration,
    params: ComputePeriodGlobalPublicDelegatedPrefixesPeriodDeleteParams,
) -> Result<models::Operation, Error<ComputePeriodGlobalPublicDelegatedPrefixesPeriodDeleteError>> {
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodGlobalPublicDelegatedPrefixesPeriodDeleteError> =
...
pub async fn compute_global_public_delegated_prefixes_get(
    configuration: &configuration::Configuration,
    params: ComputePeriodGlobalPublicDelegatedPrefixesPeriodGetParams,
) -> Result<
    models::PublicDelegatedPrefix,
    Error<ComputePeriodGlobalPublicDelegatedPrefixesPeriodGetError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodGlobalPublicDelegatedPrefixesPeriodGetError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_global_public_delegated_prefixes_insert(
    configuration: &configuration::Configuration,
    params: ComputePeriodGlobalPublicDelegatedPrefixesPeriodInsertParams,
) -> Result<models::Operation, Error<ComputePeriodGlobalPublicDelegatedPrefixesPeriodInsertError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodGlobalPublicDelegatedPrefixesPeriodInsertError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_global_public_delegated_prefixes_list(
    configuration: &configuration::Configuration,
    params: ComputePeriodGlobalPublicDelegatedPrefixesPeriodListParams,
) -> Result<
    models::PublicDelegatedPrefixList,
    Error<ComputePeriodGlobalPublicDelegatedPrefixesPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodGlobalPublicDelegatedPrefixesPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
...
pub async fn compute_global_public_delegated_prefixes_patch(
    configuration: &configuration::Configuration,
    params: ComputePeriodGlobalPublicDelegatedPrefixesPeriodPatchParams,
) -> Result<models::Operation, Error<ComputePeriodGlobalPublicDelegatedPrefixesPeriodPatchError>> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<ComputePeriodGlobalPublicDelegatedPrefixesPeriodPatchError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
