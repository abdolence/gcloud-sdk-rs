...
pub async fn compute_global_public_delegated_prefixes_delete(
    ...
    Error<ComputePeriodGlobalPublicDelegatedPrefixesPeriodDeleteError>,
> {
...
pub async fn compute_global_public_delegated_prefixes_insert(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodGlobalPublicDelegatedPrefixesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn compute_global_public_delegated_prefixes_patch(
    ...
    crate::google_rest_apis::compute_v1::models::Operation,
    Error<ComputePeriodGlobalPublicDelegatedPrefixesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
