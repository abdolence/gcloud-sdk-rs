...
) -> Result<models::Operation, Error<ComputePeriodRegionAutoscalersPeriodDeleteError>> {
...
) -> Result<models::Autoscaler, Error<ComputePeriodRegionAutoscalersPeriodGetError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionAutoscalersPeriodInsertError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::RegionAutoscalerList, Error<ComputePeriodRegionAutoscalersPeriodListError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionAutoscalersPeriodPatchError>> {
    let local_var_configuration = configuration;
...
) -> Result<models::Operation, Error<ComputePeriodRegionAutoscalersPeriodUpdateError>> {
    let local_var_configuration = configuration;
