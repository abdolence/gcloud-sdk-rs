...
pub struct DnsPeriodPoliciesPeriodCreateParams {
    ...
    pub policy: Option<crate::google_rest_apis::dns_v1::models::Policy>,
}
...
pub struct DnsPeriodPoliciesPeriodPatchParams {
    ...
    /// For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
    pub client_operation_id: Option<String>,
    pub policy2: Option<crate::google_rest_apis::dns_v1::models::Policy>,
}
...
pub async fn dns_policies_create(
    ...
    crate::google_rest_apis::dns_v1::models::Policy,
    Error<DnsPeriodPoliciesPeriodCreateError>,
> {
...
) -> Result<crate::google_rest_apis::dns_v1::models::Policy, Error<DnsPeriodPoliciesPeriodGetError>>
{
    let local_var_configuration = configuration;
...
pub async fn dns_policies_list(
    ...
    crate::google_rest_apis::dns_v1::models::PoliciesListResponse,
    Error<DnsPeriodPoliciesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn dns_policies_patch(
    ...
    crate::google_rest_apis::dns_v1::models::PoliciesPatchResponse,
    Error<DnsPeriodPoliciesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn dns_policies_update(
    ...
    crate::google_rest_apis::dns_v1::models::PoliciesUpdateResponse,
    Error<DnsPeriodPoliciesPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
