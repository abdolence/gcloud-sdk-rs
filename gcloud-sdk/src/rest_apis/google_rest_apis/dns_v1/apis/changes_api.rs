...
pub struct DnsPeriodChangesPeriodCreateParams {
    ...
    pub change: Option<crate::google_rest_apis::dns_v1::models::Change>,
}
...
) -> Result<crate::google_rest_apis::dns_v1::models::Change, Error<DnsPeriodChangesPeriodCreateError>>
{
...
) -> Result<crate::google_rest_apis::dns_v1::models::Change, Error<DnsPeriodChangesPeriodGetError>>
{
    let local_var_configuration = configuration;
...
pub async fn dns_changes_list(
    ...
    crate::google_rest_apis::dns_v1::models::ChangesListResponse,
    Error<DnsPeriodChangesPeriodListError>,
> {
    let local_var_configuration = configuration;
