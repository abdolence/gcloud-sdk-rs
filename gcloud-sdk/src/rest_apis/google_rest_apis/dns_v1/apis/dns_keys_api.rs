...
/// struct for typed errors of method [`dns_dns_keys_get`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DnsPeriodDnsKeysPeriodGetError {
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method [`dns_dns_keys_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DnsPeriodDnsKeysPeriodListError {
    UnknownValue(serde_json::Value),
}

/// Fetches the representation of an existing DnsKey.
pub async fn dns_dns_keys_get(
    configuration: &configuration::Configuration,
    params: DnsPeriodDnsKeysPeriodGetParams,
) -> Result<crate::google_rest_apis::dns_v1::models::DnsKey, Error<DnsPeriodDnsKeysPeriodGetError>>
{
    ...
    let dns_key_id = params.dns_key_id;
    ...
    let digest_type = params.digest_type;
    ...
    let local_var_uri_str = format!(
        ...
        dnsKeyId = crate::google_rest_apis::dns_v1::apis::urlencode(dns_key_id)
    );
    ...
    if let Some(ref local_var_str) = digest_type {
        local_var_req_builder =
            local_var_req_builder.query(&[("digestType", &local_var_str.to_string())]);
    }
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DnsPeriodDnsKeysPeriodGetError> =
...
pub async fn dns_dns_keys_list(
    configuration: &configuration::Configuration,
    params: DnsPeriodDnsKeysPeriodListParams,
) -> Result<
    crate::google_rest_apis::dns_v1::models::DnsKeysListResponse,
    Error<DnsPeriodDnsKeysPeriodListError>,
> {
    let local_var_configuration = configuration;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<DnsPeriodDnsKeysPeriodListError> =
            serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent {
            status: local_var_status,
            content: local_var_content,
