...
pub struct DnsPeriodResourceRecordSetsPeriodCreateParams {
    ...
    pub resource_record_set: Option<crate::google_rest_apis::dns_v1::models::ResourceRecordSet>,
}
...
pub async fn dns_resource_record_sets_create(
    ...
    crate::google_rest_apis::dns_v1::models::ResourceRecordSet,
    Error<DnsPeriodResourceRecordSetsPeriodCreateError>,
> {
...
pub async fn dns_resource_record_sets_get(
    ...
    crate::google_rest_apis::dns_v1::models::ResourceRecordSet,
    Error<DnsPeriodResourceRecordSetsPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn dns_resource_record_sets_list(
    ...
    crate::google_rest_apis::dns_v1::models::ResourceRecordSetsListResponse,
    Error<DnsPeriodResourceRecordSetsPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn dns_resource_record_sets_patch(
    ...
    crate::google_rest_apis::dns_v1::models::ResourceRecordSet,
    Error<DnsPeriodResourceRecordSetsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
