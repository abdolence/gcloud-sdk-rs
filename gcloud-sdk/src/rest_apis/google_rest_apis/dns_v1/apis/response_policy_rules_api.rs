...
pub struct DnsPeriodResponsePolicyRulesPeriodCreateParams {
    ...
    pub response_policy_rule: Option<crate::google_rest_apis::dns_v1::models::ResponsePolicyRule>,
}
...
pub struct DnsPeriodResponsePolicyRulesPeriodPatchParams {
    ...
    /// For mutating operation requests only. An optional identifier specified by the client. Must be unique for operation resources in the Operations collection.
    pub client_operation_id: Option<String>,
    pub response_policy_rule2: Option<crate::google_rest_apis::dns_v1::models::ResponsePolicyRule>,
}
...
pub async fn dns_response_policy_rules_create(
    ...
    crate::google_rest_apis::dns_v1::models::ResponsePolicyRule,
    Error<DnsPeriodResponsePolicyRulesPeriodCreateError>,
> {
...
pub async fn dns_response_policy_rules_get(
    ...
    crate::google_rest_apis::dns_v1::models::ResponsePolicyRule,
    Error<DnsPeriodResponsePolicyRulesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn dns_response_policy_rules_list(
    ...
    crate::google_rest_apis::dns_v1::models::ResponsePolicyRulesListResponse,
...
pub async fn dns_response_policy_rules_patch(
    ...
    crate::google_rest_apis::dns_v1::models::ResponsePolicyRulesPatchResponse,
...
pub async fn dns_response_policy_rules_update(
    ...
    crate::google_rest_apis::dns_v1::models::ResponsePolicyRulesUpdateResponse,
