...
pub struct V2LogEntry {
    ...
    pub http_request: Option<Box<models::V2HttpRequest>>,
    ...
    pub operation: Option<Box<models::V2LogEntryOperation>>,
    ...
    pub source_location: Option<Box<models::V2LogEntrySourceLocation>>,
