...
pub struct StoragePeriodObjectsPeriodComposeParams {
    ...
    pub compose_request: Option<crate::google_rest_apis::storage_v1::models::ComposeRequest>,
}
...
pub struct StoragePeriodObjectsPeriodCopyParams {
    ...
    /// The project to be billed for this request. Required for Requester Pays buckets.
    pub user_project: Option<String>,
    pub object: Option<crate::google_rest_apis::storage_v1::models::Object>,
}
...
pub async fn storage_objects_compose(
    ...
    Error<StoragePeriodObjectsPeriodComposeError>,
> {
...
pub async fn storage_objects_copy(
    ...
    crate::google_rest_apis::storage_v1::models::Object,
    Error<StoragePeriodObjectsPeriodCopyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_objects_get_iam_policy(
    ...
    Error<StoragePeriodObjectsPeriodGetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_objects_list(
    ...
    crate::google_rest_apis::storage_v1::models::Objects,
    Error<StoragePeriodObjectsPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_objects_patch(
    ...
    crate::google_rest_apis::storage_v1::models::Object,
    Error<StoragePeriodObjectsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_objects_rewrite(
    ...
    crate::google_rest_apis::storage_v1::models::RewriteResponse,
    Error<StoragePeriodObjectsPeriodRewriteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_objects_set_iam_policy(
    ...
    crate::google_rest_apis::storage_v1::models::Policy,
    Error<StoragePeriodObjectsPeriodSetIamPolicyError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_objects_update(
    ...
    crate::google_rest_apis::storage_v1::models::Object,
    Error<StoragePeriodObjectsPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_objects_watch_all(
    ...
    crate::google_rest_apis::storage_v1::models::Channel,
    Error<StoragePeriodObjectsPeriodWatchAllError>,
> {
    let local_var_configuration = configuration;
