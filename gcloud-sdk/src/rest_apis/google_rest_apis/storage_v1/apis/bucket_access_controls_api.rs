...
pub struct StoragePeriodBucketAccessControlsPeriodInsertParams {
    ...
    /// The project to be billed for this request. Required for Requester Pays buckets.
    pub user_project: Option<String>,
    pub bucket_access_control:
        Option<crate::google_rest_apis::storage_v1::models::BucketAccessControl>,
}
...
pub async fn storage_bucket_access_controls_get(
    ...
    crate::google_rest_apis::storage_v1::models::BucketAccessControl,
    Error<StoragePeriodBucketAccessControlsPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_bucket_access_controls_insert(
    ...
    crate::google_rest_apis::storage_v1::models::BucketAccessControl,
    Error<StoragePeriodBucketAccessControlsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_bucket_access_controls_list(
    ...
    crate::google_rest_apis::storage_v1::models::BucketAccessControls,
    Error<StoragePeriodBucketAccessControlsPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_bucket_access_controls_patch(
    ...
    crate::google_rest_apis::storage_v1::models::BucketAccessControl,
    Error<StoragePeriodBucketAccessControlsPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_bucket_access_controls_update(
    ...
    crate::google_rest_apis::storage_v1::models::BucketAccessControl,
    Error<StoragePeriodBucketAccessControlsPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
