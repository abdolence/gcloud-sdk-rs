...
pub struct StoragePeriodNotificationsPeriodInsertParams {
    ...
    /// The project to be billed for this request. Required for Requester Pays buckets.
    pub user_project: Option<String>,
    pub notification: Option<crate::google_rest_apis::storage_v1::models::Notification>,
}
...
pub async fn storage_notifications_get(
    ...
    crate::google_rest_apis::storage_v1::models::Notification,
    Error<StoragePeriodNotificationsPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_notifications_insert(
    ...
    crate::google_rest_apis::storage_v1::models::Notification,
    Error<StoragePeriodNotificationsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn storage_notifications_list(
    ...
    crate::google_rest_apis::storage_v1::models::Notifications,
    Error<StoragePeriodNotificationsPeriodListError>,
> {
    let local_var_configuration = configuration;
