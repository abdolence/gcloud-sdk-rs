...
pub struct SqlPeriodDatabasesPeriodInsertParams {
    ...
    /// Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    pub upload_type: Option<String>,
    pub database: Option<crate::google_rest_apis::sqladmin_v1::models::Database>,
}
...
pub struct SqlPeriodDatabasesPeriodPatchParams {
    ...
    /// Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    pub upload_type: Option<String>,
    pub database2: Option<crate::google_rest_apis::sqladmin_v1::models::Database>,
}
...
pub async fn sql_databases_delete(
    ...
    Error<SqlPeriodDatabasesPeriodDeleteError>,
> {
...
pub async fn sql_databases_get(
    ...
    crate::google_rest_apis::sqladmin_v1::models::Database,
    Error<SqlPeriodDatabasesPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn sql_databases_insert(
    ...
    crate::google_rest_apis::sqladmin_v1::models::Operation,
    Error<SqlPeriodDatabasesPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn sql_databases_list(
    ...
    crate::google_rest_apis::sqladmin_v1::models::DatabasesListResponse,
    Error<SqlPeriodDatabasesPeriodListError>,
> {
    let local_var_configuration = configuration;
...
pub async fn sql_databases_patch(
    ...
    crate::google_rest_apis::sqladmin_v1::models::Operation,
    Error<SqlPeriodDatabasesPeriodPatchError>,
> {
    let local_var_configuration = configuration;
...
pub async fn sql_databases_update(
    ...
    crate::google_rest_apis::sqladmin_v1::models::Operation,
    Error<SqlPeriodDatabasesPeriodUpdateError>,
> {
    let local_var_configuration = configuration;
