...
pub struct SqlPeriodSslCertsPeriodCreateEphemeralParams {
    ...
    pub ssl_certs_create_ephemeral_request:
        Option<crate::google_rest_apis::sqladmin_v1::models::SslCertsCreateEphemeralRequest>,
}
...
pub struct SqlPeriodSslCertsPeriodInsertParams {
    ...
    /// Legacy upload protocol for media (e.g. \"media\", \"multipart\").
    pub upload_type: Option<String>,
    pub ssl_certs_insert_request:
        Option<crate::google_rest_apis::sqladmin_v1::models::SslCertsInsertRequest>,
}
...
pub async fn sql_ssl_certs_create_ephemeral(
    ...
    crate::google_rest_apis::sqladmin_v1::models::SslCert,
    Error<SqlPeriodSslCertsPeriodCreateEphemeralError>,
> {
...
pub async fn sql_ssl_certs_delete(
    ...
    Error<SqlPeriodSslCertsPeriodDeleteError>,
> {
    let local_var_configuration = configuration;
...
pub async fn sql_ssl_certs_get(
    ...
    crate::google_rest_apis::sqladmin_v1::models::SslCert,
    Error<SqlPeriodSslCertsPeriodGetError>,
> {
    let local_var_configuration = configuration;
...
pub async fn sql_ssl_certs_insert(
    ...
    crate::google_rest_apis::sqladmin_v1::models::SslCertsInsertResponse,
    Error<SqlPeriodSslCertsPeriodInsertError>,
> {
    let local_var_configuration = configuration;
...
pub async fn sql_ssl_certs_list(
    ...
    crate::google_rest_apis::sqladmin_v1::models::SslCertsListResponse,
    Error<SqlPeriodSslCertsPeriodListError>,
> {
    let local_var_configuration = configuration;
