...
/// struct for passing parameters to the method [`cloudresourcemanager_effective_tags_list`]
#[derive(Clone, Debug, Default)]
pub struct CloudresourcemanagerPeriodEffectiveTagsPeriodListParams {
    /// V1 error format.
...
/// struct for typed errors of method [`cloudresourcemanager_effective_tags_list`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CloudresourcemanagerPeriodEffectiveTagsPeriodListError {
    UnknownValue(serde_json::Value),
}

/// Return a list of effective tags for the given Google Cloud resource, as specified in `parent`.
pub async fn cloudresourcemanager_effective_tags_list(
    configuration: &configuration::Configuration,
    params: CloudresourcemanagerPeriodEffectiveTagsPeriodListParams,
) -> Result<
    models::ListEffectiveTagsResponse,
    Error<CloudresourcemanagerPeriodEffectiveTagsPeriodListError>,
> {
    ...
    let local_var_uri_str = format!("{}/v3/effectiveTags", local_var_configuration.base_path);
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        ...
        let local_var_entity: Option<CloudresourcemanagerPeriodEffectiveTagsPeriodListError> =
