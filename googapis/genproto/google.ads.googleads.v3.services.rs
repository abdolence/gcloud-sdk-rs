...
pub struct GoogleAdsRow {
    ...
    pub keyword_plan_negative_keyword:
        ::core::option::Option<super::resources::KeywordPlanNegativeKeyword>,
    ...
    pub keyword_plan_keyword: ::core::option::Option<super::resources::KeywordPlanKeyword>,
    ...
    pub mutate_job: ::core::option::Option<super::resources::MutateJob>,
...
pub struct MutateKeywordPlanKeywordsRequest {
    ...
    #[prost(message, repeated, tag = "2")]
    pub operations: ::prost::alloc::vec::Vec<KeywordPlanKeywordOperation>,
    /// If true, successful operations will be carried out and invalid
    /// operations will return errors. If false, all operations will be carried
    /// out in one transaction if and only if they are all valid.
    /// Default is false.
...
pub struct KeywordPlanKeywordOperation {
    ...
    pub operation: ::core::option::Option<keyword_plan_keyword_operation::Operation>,
}
/// Nested message and enum types in `KeywordPlanKeywordOperation`.
...
pub struct MutateKeywordPlanKeywordsResponse {
    ...
    /// All results for the mutate.
    #[prost(message, repeated, tag = "2")]
    pub results: ::prost::alloc::vec::Vec<MutateKeywordPlanKeywordResult>,
}
...
pub struct MutateKeywordPlanNegativeKeywordsRequest {
    ...
    /// keywords.
    #[prost(message, repeated, tag = "2")]
    pub operations: ::prost::alloc::vec::Vec<KeywordPlanNegativeKeywordOperation>,
    /// If true, successful operations will be carried out and invalid
    /// operations will return errors. If false, all operations will be carried
    /// out in one transaction if and only if they are all valid.
    /// Default is false.
...
pub struct KeywordPlanNegativeKeywordOperation {
    ...
    pub operation: ::core::option::Option<keyword_plan_negative_keyword_operation::Operation>,
}
/// Nested message and enum types in `KeywordPlanNegativeKeywordOperation`.
...
pub struct MutateKeywordPlanNegativeKeywordsResponse {
    ...
    /// All results for the mutate.
    #[prost(message, repeated, tag = "2")]
    pub results: ::prost::alloc::vec::Vec<MutateKeywordPlanNegativeKeywordResult>,
}
...
pub struct ListMutateJobResultsResponse {
    /// The list of rows that matched the query.
    #[prost(message, repeated, tag = "1")]
    pub results: ::prost::alloc::vec::Vec<MutateJobResult>,
    /// Pagination token used to retrieve the next page of results.
    /// Pass the content of this string as the `page_token` attribute of
    /// the next request. `next_page_token` is not returned for the last
    /// page.
