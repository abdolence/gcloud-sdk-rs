...
pub struct Document {
    ...
    pub translations: ::std::vec::Vec<document::Translation>,
    /// A list of text corrections made to [Document.text].  This is usually
    /// used for annotating corrections to OCR mistakes.  Text changes for a given
    /// revision may not overlap with each other.
    #[prost(message, repeated, tag = "14")]
    pub text_changes: ::std::vec::Vec<document::TextChange>,
    ...
    pub revisions: ::std::vec::Vec<document::Revision>,
...
pub mod document {
    ...
    pub mod page {
        ...
        pub struct Block {
            ...
            #[prost(message, optional, tag = "3")]
            pub provenance: ::std::option::Option<super::Provenance>,
        }
        /// A collection of lines that a human would perceive as a paragraph.
        #[derive(Clone, PartialEq, ::prost::Message)]
    ...
    pub struct Entity {
        ...
        /// types.
        #[prost(message, optional, tag = "9")]
        pub normalized_value: ::std::option::Option<entity::NormalizedValue>,
        /// Optional. Entities can be nested to form a hierarchical data structure representing
        /// the content in the document.
        #[prost(message, repeated, tag = "10")]
        pub properties: ::std::vec::Vec<Entity>,
    ...
    pub mod entity {
        ...
        pub struct NormalizedValue {
            ...
            pub structured_value: ::std::option::Option<normalized_value::StructuredValue>,
        }
    ...
    pub struct Provenance {
        ...
        #[prost(message, repeated, tag = "3")]
        pub parents: ::std::vec::Vec<provenance::Parent>,
    ...
    pub struct Revision {
        ...
        #[prost(message, optional, tag = "6")]
        pub human_review: ::std::option::Option<revision::HumanReview>,
        /// Who/what made the change
        #[prost(oneof = "revision::Source", tags = "4, 5")]
        pub source: ::std::option::Option<revision::Source>,
    }
    pub mod revision {
...
pub struct BatchProcessRequest {
    ...
    #[prost(message, repeated, tag = "2")]
    pub input_configs: ::std::vec::Vec<batch_process_request::BatchInputConfig>,
    /// The overall output config for batch process.
    #[prost(message, optional, tag = "3")]
    pub output_config: ::std::option::Option<batch_process_request::BatchOutputConfig>,
}
pub mod batch_process_request {
    ...
    pub struct BatchInputConfig {
        ...
        #[prost(string, tag = "1")]
        pub gcs_source: std::string::String,
...
pub struct BatchProcessMetadata {
    ...
    pub individual_process_statuses:
        ::std::vec::Vec<batch_process_metadata::IndividualProcessStatus>,
}
