...
pub struct TextAdInfo {
    ...
    pub description1: ::std::option::Option<::std::string::String>,
    /// The second line of the ad's description.
    #[prost(message, optional, tag = "3")]
    pub description2: ::std::option::Option<::std::string::String>,
}
/// An expanded text ad.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ExpandedTextAdInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub headline_part1: ::std::option::Option<::std::string::String>,
    /// The second part of the ad's headline.
    #[prost(message, optional, tag = "2")]
    pub headline_part2: ::std::option::Option<::std::string::String>,
    /// The third part of the ad's headline.
    #[prost(message, optional, tag = "6")]
    pub headline_part3: ::std::option::Option<::std::string::String>,
...
pub struct CallOnlyAdInfo {
    ...
    pub headline1: ::std::option::Option<::std::string::String>,
    /// Second headline in the ad.
    #[prost(message, optional, tag = "12")]
    pub headline2: ::std::option::Option<::std::string::String>,
    /// The first line of the ad's description.
    #[prost(message, optional, tag = "4")]
    pub description1: ::std::option::Option<::std::string::String>,
    /// The second line of the ad's description.
    ...
    #[prost(message, optional, tag = "6")]
    pub call_tracked: ::std::option::Option<bool>,
    /// Whether to disable call conversion for the creative.
    /// If set to `true`, disables call conversions even when `call_tracked` is
    /// `true`.
    /// If `call_tracked` is `false`, this field is ignored.
    #[prost(message, optional, tag = "7")]
    pub disable_call_conversion: ::std::option::Option<bool>,
    /// The URL to be used for phone number verification.
    #[prost(message, optional, tag = "8")]
    pub phone_number_verification_url: ::std::option::Option<::std::string::String>,
...
pub struct GmailAdInfo {
    /// The Gmail teaser.
    #[prost(message, optional, tag = "1")]
    pub teaser: ::std::option::Option<GmailTeaser>,
    ...
    #[prost(message, optional, tag = "2")]
    pub header_image: ::std::option::Option<::std::string::String>,
    ...
    #[prost(message, optional, tag = "3")]
    pub marketing_image: ::std::option::Option<::std::string::String>,
    /// Headline of the marketing image.
    #[prost(message, optional, tag = "4")]
    pub marketing_image_headline: ::std::option::Option<::std::string::String>,
    /// Description of the marketing image.
    #[prost(message, optional, tag = "5")]
    pub marketing_image_description: ::std::option::Option<::std::string::String>,
    /// Display-call-to-action of the marketing image.
    #[prost(message, optional, tag = "6")]
    pub marketing_image_display_call_to_action: ::std::option::Option<DisplayCallToAction>,
    /// Product images. Up to 15 images are supported.
    #[prost(message, repeated, tag = "7")]
    pub product_images: ::std::vec::Vec<ProductImage>,
    /// Product videos. Up to 7 videos are supported. At least one product video
    /// or a marketing image must be specified.
    #[prost(message, repeated, tag = "8")]
    pub product_videos: ::std::vec::Vec<ProductVideo>,
}
...
pub struct DisplayCallToAction {
    ...
    #[prost(message, optional, tag = "3")]
    pub url_collection_id: ::std::option::Option<::std::string::String>,
}
...
pub struct ProductImage {
    ...
    /// must be 1:1 (+-1%).
    #[prost(message, optional, tag = "1")]
    pub product_image: ::std::option::Option<::std::string::String>,
    /// Description of the product.
    #[prost(message, optional, tag = "2")]
    pub description: ::std::option::Option<::std::string::String>,
    /// Display-call-to-action of the product image.
    #[prost(message, optional, tag = "3")]
    pub display_call_to_action: ::std::option::Option<DisplayCallToAction>,
}
...
pub struct ProductVideo {
    ...
    #[prost(message, optional, tag = "1")]
    pub product_video: ::std::option::Option<::std::string::String>,
}
/// An image ad.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ImageAdInfo {
    ...
    #[prost(message, optional, tag = "4")]
    pub pixel_width: ::std::option::Option<i64>,
    /// Height in pixels of the full size image.
    #[prost(message, optional, tag = "5")]
    pub pixel_height: ::std::option::Option<i64>,
    /// URL of the full size image.
    #[prost(message, optional, tag = "6")]
    pub image_url: ::std::option::Option<::std::string::String>,
    /// Width in pixels of the preview size image.
    #[prost(message, optional, tag = "7")]
    pub preview_pixel_width: ::std::option::Option<i64>,
    /// Height in pixels of the preview size image.
    #[prost(message, optional, tag = "8")]
    pub preview_pixel_height: ::std::option::Option<i64>,
    ...
    pub image: ::std::option::Option<image_ad_info::Image>,
}
...
pub struct VideoBumperInStreamAdInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub companion_banner: ::std::option::Option<::std::string::String>,
}
...
pub struct VideoTrueViewInStreamAdInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub action_button_label: ::std::option::Option<::std::string::String>,
    /// Additional text displayed with the CTA (call-to-action) button to give
    /// context and encourage clicking on the button.
    #[prost(message, optional, tag = "2")]
    pub action_headline: ::std::option::Option<::std::string::String>,
    /// The MediaFile resource name of the companion banner used with the ad.
    #[prost(message, optional, tag = "3")]
    pub companion_banner: ::std::option::Option<::std::string::String>,
}
...
pub struct ResponsiveSearchAdInfo {
    ...
    pub headlines: ::std::vec::Vec<AdTextAsset>,
    /// List of text assets for descriptions. When the ad serves the descriptions
    /// will be selected from this list.
    #[prost(message, repeated, tag = "2")]
    pub descriptions: ::std::vec::Vec<AdTextAsset>,
...
pub struct LegacyResponsiveDisplayAdInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub short_headline: ::std::option::Option<::std::string::String>,
    /// The long version of the ad's headline.
    #[prost(message, optional, tag = "2")]
    pub long_headline: ::std::option::Option<::std::string::String>,
    /// The description of the ad.
    #[prost(message, optional, tag = "3")]
    pub description: ::std::option::Option<::std::string::String>,
    /// The business name in the ad.
    ...
    #[prost(message, optional, tag = "5")]
    pub allow_flexible_color: ::std::option::Option<bool>,
    ...
    /// well.
    #[prost(message, optional, tag = "7")]
    pub main_color: ::std::option::Option<::std::string::String>,
    ...
    pub square_logo_image: ::std::option::Option<::std::string::String>,
    /// The MediaFile resource name of the marketing image used in the ad.
    #[prost(message, optional, tag = "11")]
    pub marketing_image: ::std::option::Option<::std::string::String>,
    /// The MediaFile resource name of the square marketing image used in the ad.
    #[prost(message, optional, tag = "12")]
    pub square_marketing_image: ::std::option::Option<::std::string::String>,
    ...
    pub price_prefix: ::std::option::Option<::std::string::String>,
    /// Promotion text used for dyanmic formats of responsive ads. For example
    /// 'Free two-day shipping'.
    #[prost(message, optional, tag = "15")]
    pub promo_text: ::std::option::Option<::std::string::String>,
}
/// An app ad.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct AppAdInfo {
    ...
    pub images: ::std::vec::Vec<AdImageAsset>,
    /// List of YouTube video assets that may be displayed with the ad.
    #[prost(message, repeated, tag = "5")]
    pub youtube_videos: ::std::vec::Vec<AdVideoAsset>,
    /// List of media bundle assets that may be used with the ad.
    #[prost(message, repeated, tag = "6")]
    pub html5_media_bundles: ::std::vec::Vec<AdMediaBundleAsset>,
}
...
pub struct AppEngagementAdInfo {
    ...
    #[prost(message, repeated, tag = "4")]
    pub videos: ::std::vec::Vec<AdVideoAsset>,
}
...
pub struct ResponsiveDisplayAdInfo {
    ...
    #[prost(message, repeated, tag = "1")]
    pub marketing_images: ::std::vec::Vec<AdImageAsset>,
    ...
    #[prost(message, optional, tag = "6")]
    pub long_headline: ::std::option::Option<AdTextAsset>,
...
pub struct LocalAdInfo {
    ...
    #[prost(message, repeated, tag = "3")]
    pub call_to_actions: ::std::vec::Vec<AdTextAsset>,
...
pub struct DisplayUploadAdInfo {
    ...
    pub media_asset: ::std::option::Option<display_upload_ad_info::MediaAsset>,
}
...
pub struct TargetingSetting {
    ...
    /// or ad group.
    #[prost(message, repeated, tag = "1")]
    pub target_restrictions: ::std::vec::Vec<TargetRestriction>,
    ...
    #[prost(message, repeated, tag = "2")]
    pub target_restriction_operations: ::std::vec::Vec<TargetRestrictionOperation>,
}
...
pub struct TargetRestriction {
    ...
    /// modifiers.
    #[prost(message, optional, tag = "2")]
    pub bid_only: ::std::option::Option<bool>,
}
...
pub struct TargetRestrictionOperation {
    ...
    #[prost(message, optional, tag = "2")]
    pub value: ::std::option::Option<TargetRestriction>,
}
...
pub struct PolicyViolationKey {
    ...
    #[prost(message, optional, tag = "2")]
    pub violating_text: ::std::option::Option<::std::string::String>,
}
...
pub struct PolicyValidationParameter {
    ...
    /// certificates.
    #[prost(message, repeated, tag = "1")]
    pub ignorable_policy_topics: ::std::vec::Vec<::std::string::String>,
    ...
    /// certificates.
    #[prost(message, repeated, tag = "2")]
    pub exempt_policy_violation_keys: ::std::vec::Vec<PolicyViolationKey>,
}
...
pub struct PolicyTopicEntry {
    ...
    #[prost(message, repeated, tag = "3")]
    pub evidences: ::std::vec::Vec<PolicyTopicEvidence>,
    /// Indicates how serving of this resource may be affected (e.g. not serving
    /// in a country).
    #[prost(message, repeated, tag = "4")]
    pub constraints: ::std::vec::Vec<PolicyTopicConstraint>,
}
...
pub struct PolicyTopicEvidence {
    ...
    pub value: ::std::option::Option<policy_topic_evidence::Value>,
}
pub mod policy_topic_evidence {
    ...
    pub struct DestinationTextList {
        ...
        #[prost(message, repeated, tag = "1")]
        pub destination_texts: ::std::vec::Vec<::std::string::String>,
    }
    ...
    pub struct DestinationNotWorking {
        ...
        #[prost(message, optional, tag = "5")]
        pub last_checked_date_time: ::std::option::Option<::std::string::String>,
        /// Indicates the reason of the DESTINATION_NOT_WORKING policy finding.
        #[prost(oneof = "destination_not_working::Reason", tags = "1, 2")]
        pub reason: ::std::option::Option<destination_not_working::Reason>,
    }
    ...
    pub enum Value {
        ...
        #[prost(message, tag = "5")]
        LanguageCode(::std::string::String),
...
pub struct PolicyTopicConstraint {
    ...
    pub value: ::std::option::Option<policy_topic_constraint::Value>,
}
pub mod policy_topic_constraint {
    ...
    pub struct CountryConstraintList {
        ...
        #[prost(message, optional, tag = "1")]
        pub total_targeted_countries: ::std::option::Option<i32>,
        /// Countries in which serving is restricted.
        #[prost(message, repeated, tag = "2")]
        pub countries: ::std::vec::Vec<CountryConstraint>,
    }
    ...
    pub struct CountryConstraint {
        ...
        /// constrained.
        #[prost(message, optional, tag = "1")]
        pub country_criterion: ::std::option::Option<::std::string::String>,
    }
    /// Specific information about the constraint.
    #[derive(Clone, PartialEq, ::prost::Oneof)]
    pub enum Value {
...
pub struct MobileAppCategoryInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub mobile_app_category_constant: ::std::option::Option<::std::string::String>,
}
...
pub struct ListingGroupInfo {
    ...
    #[prost(message, optional, tag = "2")]
    pub case_value: ::std::option::Option<ListingDimensionInfo>,
    /// Resource name of ad group criterion which is the parent listing group
    /// subdivision. Null for the root group.
    #[prost(message, optional, tag = "3")]
    pub parent_ad_group_criterion: ::std::option::Option<::std::string::String>,
}
...
pub struct ListingScopeInfo {
    ...
    #[prost(message, repeated, tag = "2")]
    pub dimensions: ::std::vec::Vec<ListingDimensionInfo>,
}
...
pub struct ListingDimensionInfo {
    ...
    pub dimension: ::std::option::Option<listing_dimension_info::Dimension>,
}
...
pub struct HotelCountryRegionInfo {
    /// The Geo Target Constant resource name.
    #[prost(message, optional, tag = "1")]
    pub country_region_criterion: ::std::option::Option<::std::string::String>,
}
/// State the hotel is located in.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct HotelStateInfo {
    /// The Geo Target Constant resource name.
    #[prost(message, optional, tag = "1")]
    pub state_criterion: ::std::option::Option<::std::string::String>,
}
/// City the hotel is located in.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct HotelCityInfo {
    /// The Geo Target Constant resource name.
    #[prost(message, optional, tag = "1")]
    pub city_criterion: ::std::option::Option<::std::string::String>,
}
/// Bidding category of a product offer.
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub struct HotelAdvanceBookingWindowInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub min_days: ::std::option::Option<i64>,
    /// High end of the number of days prior to the stay.
    #[prost(message, optional, tag = "2")]
    pub max_days: ::std::option::Option<i64>,
}
...
pub struct HotelLengthOfStayInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub min_nights: ::std::option::Option<i64>,
    /// High end of the number of nights in the stay.
    #[prost(message, optional, tag = "2")]
    pub max_nights: ::std::option::Option<i64>,
}
...
pub struct UserListInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub user_list: ::std::option::Option<::std::string::String>,
}
...
pub struct ProximityInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub geo_point: ::std::option::Option<GeoPointInfo>,
    ...
    /// Full address.
    #[prost(message, optional, tag = "4")]
    pub address: ::std::option::Option<AddressInfo>,
}
...
pub struct GeoPointInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub longitude_in_micro_degrees: ::std::option::Option<i32>,
    /// Micro degrees for the latitude.
    #[prost(message, optional, tag = "2")]
    pub latitude_in_micro_degrees: ::std::option::Option<i32>,
}
...
pub struct AddressInfo {
    ...
    #[prost(message, optional, tag = "2")]
    pub province_code: ::std::option::Option<::std::string::String>,
    /// Country code.
    #[prost(message, optional, tag = "3")]
    pub country_code: ::std::option::Option<::std::string::String>,
    /// Province or state name.
    #[prost(message, optional, tag = "4")]
    pub province_name: ::std::option::Option<::std::string::String>,
    ...
    /// empty.
    #[prost(message, optional, tag = "6")]
    pub street_address2: ::std::option::Option<::std::string::String>,
    /// Name of the city.
    #[prost(message, optional, tag = "7")]
...
pub struct TopicInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub topic_constant: ::std::option::Option<::std::string::String>,
...
pub struct LanguageInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub language_constant: ::std::option::Option<::std::string::String>,
}
...
pub struct CarrierInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub carrier_constant: ::std::option::Option<::std::string::String>,
}
...
pub struct UserInterestInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub user_interest_category: ::std::option::Option<::std::string::String>,
}
...
pub struct WebpageInfo {
    ...
    /// operations.
    #[prost(message, optional, tag = "1")]
    pub criterion_name: ::std::option::Option<::std::string::String>,
    ...
    /// operations.
    #[prost(message, repeated, tag = "2")]
    pub conditions: ::std::vec::Vec<WebpageConditionInfo>,
}
...
pub struct OperatingSystemVersionInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub operating_system_version_constant: ::std::option::Option<::std::string::String>,
}
...
pub struct MobileDeviceInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub mobile_device_constant: ::std::option::Option<::std::string::String>,
}
...
pub struct CustomAffinityInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub custom_affinity: ::std::option::Option<::std::string::String>,
}
...
pub struct CustomIntentInfo {
    /// The CustomInterest resource name.
    #[prost(message, optional, tag = "1")]
    pub custom_intent: ::std::option::Option<::std::string::String>,
}
...
pub struct BidModifierSimulationPointList {
    ...
    #[prost(message, repeated, tag = "1")]
    pub points: ::std::vec::Vec<BidModifierSimulationPoint>,
}
...
pub struct CpcBidSimulationPointList {
    ...
    #[prost(message, repeated, tag = "1")]
    pub points: ::std::vec::Vec<CpcBidSimulationPoint>,
}
...
pub struct CpvBidSimulationPointList {
    ...
    #[prost(message, repeated, tag = "1")]
    pub points: ::std::vec::Vec<CpvBidSimulationPoint>,
}
...
pub struct TargetCpaSimulationPointList {
    ...
    #[prost(message, repeated, tag = "1")]
    pub points: ::std::vec::Vec<TargetCpaSimulationPoint>,
}
...
pub struct TargetRoasSimulationPointList {
    ...
    #[prost(message, repeated, tag = "1")]
    pub points: ::std::vec::Vec<TargetRoasSimulationPoint>,
}
...
pub struct BidModifierSimulationPoint {
    ...
    #[prost(message, optional, tag = "2")]
    pub biddable_conversions: ::std::option::Option<f64>,
    /// Projected total value of biddable conversions.
    /// Only search advertising channel type supports this field.
    #[prost(message, optional, tag = "3")]
    pub biddable_conversions_value: ::std::option::Option<f64>,
    ...
    /// Only search advertising channel type supports this field.
    #[prost(message, optional, tag = "7")]
    pub top_slot_impressions: ::std::option::Option<i64>,
    /// Projected number of biddable conversions for the parent resource.
    /// Only search advertising channel type supports this field.
    #[prost(message, optional, tag = "8")]
    pub parent_biddable_conversions: ::std::option::Option<f64>,
    /// Projected total value of biddable conversions for the parent resource.
    /// Only search advertising channel type supports this field.
    #[prost(message, optional, tag = "9")]
    pub parent_biddable_conversions_value: ::std::option::Option<f64>,
    /// Projected number of clicks for the parent resource.
    #[prost(message, optional, tag = "10")]
    pub parent_clicks: ::std::option::Option<i64>,
    /// Projected cost in micros for the parent resource.
    #[prost(message, optional, tag = "11")]
    pub parent_cost_micros: ::std::option::Option<i64>,
    /// Projected number of impressions for the parent resource.
    #[prost(message, optional, tag = "12")]
    pub parent_impressions: ::std::option::Option<i64>,
    /// Projected number of top slot impressions for the parent resource.
    /// Only search advertising channel type supports this field.
    #[prost(message, optional, tag = "13")]
    pub parent_top_slot_impressions: ::std::option::Option<i64>,
    /// Projected minimum daily budget that must be available to the parent
    /// resource to realize this simulation.
    #[prost(message, optional, tag = "14")]
    pub parent_required_budget_micros: ::std::option::Option<i64>,
}
...
pub struct CpvBidSimulationPoint {
    ...
    #[prost(message, optional, tag = "4")]
    pub views: ::std::option::Option<i64>,
}
...
pub struct MatchingFunction {
    ...
    /// mutate request.
    #[prost(message, optional, tag = "1")]
    pub function_string: ::std::option::Option<::std::string::String>,
    ...
    #[prost(message, repeated, tag = "2")]
    pub left_operands: ::std::vec::Vec<Operand>,
    /// The operands on the right hand side of the equation.
    #[prost(message, repeated, tag = "3")]
    pub right_operands: ::std::vec::Vec<Operand>,
}
...
pub struct Operand {
    ...
    pub function_argument_operand: ::std::option::Option<operand::FunctionArgumentOperand>,
}
pub mod operand {
    ...
    pub struct ConstantOperand {
        ...
        pub constant_operand_value: ::std::option::Option<constant_operand::ConstantOperandValue>,
    }
    ...
    pub struct FeedAttributeOperand {
        ...
        #[prost(message, optional, tag = "1")]
        pub feed_id: ::std::option::Option<i64>,
    ...
    pub struct FunctionOperand {
        ...
        #[prost(message, optional, tag = "1")]
        pub matching_function: ::std::option::Option<super::MatchingFunction>,
    }
...
pub struct ImageAsset {
    ...
    #[prost(message, optional, tag = "4")]
    pub full_size: ::std::option::Option<ImageDimension>,
}
...
pub struct ImageDimension {
    /// Height of the image.
    #[prost(message, optional, tag = "1")]
    pub height_pixels: ::std::option::Option<i64>,
    /// Width of the image.
    #[prost(message, optional, tag = "2")]
    pub width_pixels: ::std::option::Option<i64>,
...
pub struct Commission {
    ...
    /// rate of 0.106 (10.6%).
    #[prost(message, optional, tag = "1")]
    pub commission_rate_micros: ::std::option::Option<i64>,
}
...
pub struct FrequencyCapEntry {
    ...
    #[prost(message, optional, tag = "1")]
    pub key: ::std::option::Option<FrequencyCapKey>,
...
pub struct FrequencyCapKey {
    ...
    #[prost(message, optional, tag = "4")]
    pub time_length: ::std::option::Option<i32>,
}
...
pub struct ClickLocation {
    ...
    #[prost(message, optional, tag = "4")]
    pub most_specific: ::std::option::Option<::std::string::String>,
...
pub struct TagSnippet {
    ...
    #[prost(message, optional, tag = "3")]
    pub global_site_tag: ::std::option::Option<::std::string::String>,
    /// The event snippet that works with the site tag to track actions that
    /// should be counted as conversions.
    #[prost(message, optional, tag = "4")]
    pub event_snippet: ::std::option::Option<::std::string::String>,
}
...
pub struct AppFeedItem {
    ...
    #[prost(message, repeated, tag = "7")]
    pub url_custom_parameters: ::std::vec::Vec<CustomParameter>,
...
pub struct CallFeedItem {
    ...
    /// not enabled.
    #[prost(message, optional, tag = "3")]
    pub call_tracking_enabled: ::std::option::Option<bool>,
    /// The conversion action to attribute a call conversion to. If not set a
    /// default conversion action is used. This field only has effect if
    ...
    #[prost(message, optional, tag = "5")]
    pub call_conversion_tracking_disabled: ::std::option::Option<bool>,
...
pub struct CalloutFeedItem {
    ...
    #[prost(message, optional, tag = "1")]
    pub callout_text: ::std::option::Option<::std::string::String>,
}
...
pub struct LocationFeedItem {
    ...
    #[prost(message, optional, tag = "2")]
    pub address_line_1: ::std::option::Option<::std::string::String>,
    /// Line 2 of the business address.
    #[prost(message, optional, tag = "3")]
    pub address_line_2: ::std::option::Option<::std::string::String>,
...
pub struct TextMessageFeedItem {
    ...
    #[prost(message, optional, tag = "5")]
    pub extension_text: ::std::option::Option<::std::string::String>,
}
...
pub struct PriceFeedItem {
    ...
    #[prost(message, repeated, tag = "5")]
    pub price_offerings: ::std::vec::Vec<PriceOffer>,
    /// URL template for appending params to landing page URLs served with parallel
    /// tracking.
    #[prost(message, optional, tag = "6")]
    pub final_url_suffix: ::std::option::Option<::std::string::String>,
...
pub struct PriceOffer {
    ...
    #[prost(message, optional, tag = "3")]
    pub price: ::std::option::Option<Money>,
...
pub struct PromotionFeedItem {
    ...
    /// This field is required.
    #[prost(message, optional, tag = "1")]
    pub promotion_target: ::std::option::Option<::std::string::String>,
    ...
    #[prost(message, optional, tag = "7")]
    pub promotion_start_date: ::std::option::Option<::std::string::String>,
    /// End date of when the promotion is eligible to be redeemed.
    #[prost(message, optional, tag = "8")]
    pub promotion_end_date: ::std::option::Option<::std::string::String>,
    ...
    pub discount_type: ::std::option::Option<promotion_feed_item::DiscountType>,
    ...
    pub promotion_trigger: ::std::option::Option<promotion_feed_item::PromotionTrigger>,
}
pub mod promotion_feed_item {
    ...
    pub enum PromotionTrigger {
        ...
        #[prost(message, tag = "5")]
        PromotionCode(::std::string::String),
...
pub struct OfflineUserAddressInfo {
    ...
    /// between).
    #[prost(message, optional, tag = "1")]
    pub hashed_first_name: ::std::option::Option<::std::string::String>,
    /// Last name of the user, which is hashed as SHA-256 after normalized (lower
    /// case only and no punctuation).
    #[prost(message, optional, tag = "2")]
    pub hashed_last_name: ::std::option::Option<::std::string::String>,
...
pub struct UserIdentifier {
    ...
    pub identifier: ::std::option::Option<user_identifier::Identifier>,
}
...
pub struct TransactionAttribute {
    ...
    /// Examples: "2018-03-05 09:15:00" or "2018-02-01 14:34:30"
    #[prost(message, optional, tag = "1")]
    pub transaction_date_time: ::std::option::Option<::std::string::String>,
    /// Transaction amount in micros. Required.
    #[prost(message, optional, tag = "2")]
    pub transaction_amount_micros: ::std::option::Option<f64>,
...
pub struct UserData {
    ...
    #[prost(message, repeated, tag = "1")]
    pub user_identifiers: ::std::vec::Vec<UserIdentifier>,
    /// Additional transactions/attributes associated with the user.
    /// Required when updating store sales data.
    #[prost(message, optional, tag = "2")]
    pub transaction_attribute: ::std::option::Option<TransactionAttribute>,
}
...
pub struct StoreSalesMetadata {
    ...
    #[prost(message, optional, tag = "1")]
    pub loyalty_fraction: ::std::option::Option<f64>,
...
pub struct CriterionCategoryAvailability {
    ...
    #[prost(message, optional, tag = "1")]
    pub channel: ::std::option::Option<CriterionCategoryChannelAvailability>,
    /// Locales that are available to the category for the channel.
    #[prost(message, repeated, tag = "2")]
    pub locale: ::std::vec::Vec<CriterionCategoryLocaleAvailability>,
}
...
pub struct CriterionCategoryChannelAvailability {
    ...
    pub advertising_channel_sub_type: ::std::vec::Vec<i32>,
    ...
    #[prost(message, optional, tag = "4")]
    pub include_default_channel_sub_type: ::std::option::Option<bool>,
}
...
pub struct SimilarUserListInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub seed_user_list: ::std::option::Option<::std::string::String>,
}
...
pub struct UserListRuleInfo {
    ...
    #[prost(message, repeated, tag = "2")]
    pub rule_item_groups: ::std::vec::Vec<UserListRuleItemGroupInfo>,
}
...
pub struct UserListRuleItemGroupInfo {
    ...
    #[prost(message, repeated, tag = "1")]
    pub rule_items: ::std::vec::Vec<UserListRuleItemInfo>,
}
/// An atomic rule item.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UserListRuleItemInfo {
    ...
    pub rule_item: ::std::option::Option<user_list_rule_item_info::RuleItem>,
}
...
pub struct UserListDateRuleItemInfo {
    ...
    /// present.
    #[prost(message, optional, tag = "3")]
    pub offset_in_days: ::std::option::Option<i64>,
}
...
pub struct CombinedRuleUserListInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub left_operand: ::std::option::Option<UserListRuleInfo>,
    /// Right operand of the combined rule.
    /// This field is required and must be populated when creating new combined
    /// rule based user list.
    #[prost(message, optional, tag = "2")]
    pub right_operand: ::std::option::Option<UserListRuleInfo>,
...
pub struct DateSpecificRuleUserListInfo {
    ...
    #[prost(message, optional, tag = "1")]
    pub rule: ::std::option::Option<UserListRuleInfo>,
...
pub struct RuleBasedUserListInfo {
    ...
    pub rule_based_user_list: ::std::option::Option<rule_based_user_list_info::RuleBasedUserList>,
}
...
pub struct LogicalUserListInfo {
    ...
    #[prost(message, repeated, tag = "1")]
    pub rules: ::std::vec::Vec<UserListLogicalRuleInfo>,
}
...
pub struct UserListLogicalRuleInfo {
    ...
    #[prost(message, repeated, tag = "2")]
    pub rule_operands: ::std::vec::Vec<LogicalUserListOperandInfo>,
}
...
pub struct BasicUserListInfo {
    ...
    #[prost(message, repeated, tag = "1")]
    pub actions: ::std::vec::Vec<UserListActionInfo>,
}
...
pub struct UserListActionInfo {
    ...
    pub user_list_action: ::std::option::Option<user_list_action_info::UserListAction>,
}
pub mod user_list_action_info {
    ...
    pub enum UserListAction {
        ...
        #[prost(message, tag = "1")]
        ConversionAction(::std::string::String),
        /// A remarketing action.
        #[prost(message, tag = "2")]
        RemarketingAction(::std::string::String),
    }
}
...
pub struct Metrics {
    ...
    #[prost(message, optional, tag = "1")]
    pub active_view_cpm: ::std::option::Option<f64>,
    /// Active view measurable clicks divided by active view viewable impressions.
    /// This metric is reported only for display network.
    #[prost(message, optional, tag = "79")]
    pub active_view_ctr: ::std::option::Option<f64>,
    /// A measurement of how often your ad has become viewable on a Display
    /// Network site.
    #[prost(message, optional, tag = "2")]
    pub active_view_impressions: ::std::option::Option<i64>,
    /// The ratio of impressions that could be measured by Active View over the
    /// number of served impressions.
    #[prost(message, optional, tag = "96")]
    pub active_view_measurability: ::std::option::Option<f64>,
    /// The cost of the impressions you received that were measurable by Active
    /// View.
    #[prost(message, optional, tag = "3")]
    pub active_view_measurable_cost_micros: ::std::option::Option<i64>,
    /// The number of times your ads are appearing on placements in positions
    /// where they can be seen.
    #[prost(message, optional, tag = "4")]
    pub active_view_measurable_impressions: ::std::option::Option<i64>,
    /// The percentage of time when your ad appeared on an Active View enabled site
    /// (measurable impressions) and was viewable (viewable impressions).
    #[prost(message, optional, tag = "97")]
    pub active_view_viewability: ::std::option::Option<f64>,
    ...
    pub average_cpe: ::std::option::Option<f64>,
    ...
    /// the number of views.
    #[prost(message, optional, tag = "11")]
    pub average_cpv: ::std::option::Option<f64>,
    /// Average number of pages viewed per session.
    #[prost(message, optional, tag = "99")]
    pub average_page_views: ::std::option::Option<f64>,
    /// Total duration of all sessions (in seconds) / number of sessions. Imported
    /// from Google Analytics.
    #[prost(message, optional, tag = "84")]
    pub average_time_on_site: ::std::option::Option<f64>,
    /// An indication of how other advertisers are bidding on similar products.
    #[prost(message, optional, tag = "14")]
    pub benchmark_average_max_cpc: ::std::option::Option<f64>,
    /// An indication on how other advertisers' Shopping ads for similar products
    /// are performing based on how often people who see their ad click on it.
    #[prost(message, optional, tag = "77")]
    pub benchmark_ctr: ::std::option::Option<f64>,
    /// Percentage of clicks where the user only visited a single page on your
    /// site. Imported from Google Analytics.
    #[prost(message, optional, tag = "15")]
    pub bounce_rate: ::std::option::Option<f64>,
    ...
    pub combined_clicks: ::std::option::Option<i64>,
    /// The number of times your ad or your site's listing in the unpaid
    /// results was clicked (combined_clicks) divided by combined_queries. See the
    /// help page at https://support.google.com/google-ads/answer/3097241 for
    /// details.
    #[prost(message, optional, tag = "116")]
    pub combined_clicks_per_query: ::std::option::Option<f64>,
    /// The number of searches that returned pages from your site in the unpaid
    /// results or showed one of your text ads. See the help page at
    /// https://support.google.com/google-ads/answer/3097241 for details.
    #[prost(message, optional, tag = "117")]
    pub combined_queries: ::std::option::Option<i64>,
    ...
    pub conversion_last_received_request_date_time: ::std::option::Option<::std::string::String>,
    /// The date of the most recent conversion for this conversion action. The date
    /// is in the customer's time zone.
    #[prost(message, optional, tag = "74")]
    pub conversion_last_conversion_date: ::std::option::Option<::std::string::String>,
    ...
    pub engagement_rate: ::std::option::Option<f64>,
    ...
    pub hotel_price_difference_percentage: ::std::option::Option<f64>,
    /// The number of impressions that hotel partners could have had given their
    /// feed performance.
    #[prost(message, optional, tag = "130")]
    pub hotel_eligible_impressions: ::std::option::Option<i64>,
    ...
    pub gmail_forwards: ::std::option::Option<i64>,
    /// The number of times someone has saved your Gmail ad to their inbox as a
    /// message.
    #[prost(message, optional, tag = "86")]
    pub gmail_saves: ::std::option::Option<i64>,
    /// The number of clicks to the landing page on the expanded state of Gmail
    /// ads.
    #[prost(message, optional, tag = "87")]
    pub gmail_secondary_clicks: ::std::option::Option<i64>,
    /// The number of times a store's location-based ad was shown.
    /// This metric applies to feed items only.
    #[prost(message, optional, tag = "125")]
    pub impressions_from_store_reach: ::std::option::Option<i64>,
    ...
    pub interaction_event_types: ::std::vec::Vec<i32>,
    ...
    pub message_chats: ::std::option::Option<i64>,
    /// Number of Click To Message impressions that were message tracking eligible.
    #[prost(message, optional, tag = "127")]
    pub message_impressions: ::std::option::Option<i64>,
    ...
    pub message_chat_rate: ::std::option::Option<f64>,
    ...
    pub organic_clicks: ::std::option::Option<i64>,
    /// The number of times someone clicked your site's listing in the unpaid
    /// results (organic_clicks) divided by the total number of searches that
    /// returned pages from your site (organic_queries). See the help page at
    /// https://support.google.com/google-ads/answer/3097241 for details.
    #[prost(message, optional, tag = "111")]
    pub organic_clicks_per_query: ::std::option::Option<f64>,
    /// The number of listings for your site in the unpaid search results. See the
    /// help page at https://support.google.com/google-ads/answer/3097241 for
    /// details.
    #[prost(message, optional, tag = "112")]
    pub organic_impressions: ::std::option::Option<i64>,
    /// The number of times a page from your site was listed in the unpaid search
    /// results (organic_impressions) divided by the number of searches returning
    /// your site's listing in the unpaid results (organic_queries). See the help
    /// page at https://support.google.com/google-ads/answer/3097241 for details.
    #[prost(message, optional, tag = "113")]
    pub organic_impressions_per_query: ::std::option::Option<f64>,
    /// The total number of searches that returned your site's listing in the
    /// unpaid results. See the help page at
    /// https://support.google.com/google-ads/answer/3097241 for details.
    #[prost(message, optional, tag = "114")]
    pub organic_queries: ::std::option::Option<i64>,
    /// Percentage of first-time sessions (from people who had never visited your
    /// site before). Imported from Google Analytics.
    #[prost(message, optional, tag = "42")]
    pub percent_new_visitors: ::std::option::Option<f64>,
    /// Number of offline phone calls.
    #[prost(message, optional, tag = "43")]
    pub phone_calls: ::std::option::Option<i64>,
    /// Number of offline phone impressions.
    #[prost(message, optional, tag = "44")]
    pub phone_impressions: ::std::option::Option<i64>,
    /// Number of phone calls received (phone_calls) divided by the number of
    /// times your phone number is shown (phone_impressions).
    #[prost(message, optional, tag = "45")]
    pub phone_through_rate: ::std::option::Option<f64>,
    /// Your clickthrough rate (Ctr) divided by the average clickthrough rate of
    /// all advertisers on the websites that show your ads. Measures how your ads
    /// perform on Display Network sites compared to other ads on the same sites.
    #[prost(message, optional, tag = "46")]
    pub relative_ctr: ::std::option::Option<f64>,
    ...
    pub speed_score: ::std::option::Option<i64>,
    ...
    pub valid_accelerated_mobile_pages_clicks_percentage: ::std::option::Option<f64>,
    ...
    pub video_quartile_100_rate: ::std::option::Option<f64>,
    /// Percentage of impressions where the viewer watched 25% of your video.
    #[prost(message, optional, tag = "55")]
    pub video_quartile_25_rate: ::std::option::Option<f64>,
    /// Percentage of impressions where the viewer watched 50% of your video.
    #[prost(message, optional, tag = "56")]
    pub video_quartile_50_rate: ::std::option::Option<f64>,
    /// Percentage of impressions where the viewer watched 75% of your video.
    #[prost(message, optional, tag = "57")]
    pub video_quartile_75_rate: ::std::option::Option<f64>,
    /// The number of views your TrueView video ad receives divided by its number
    /// of impressions, including thumbnail impressions for TrueView in-display
    /// ads.
    #[prost(message, optional, tag = "58")]
    pub video_view_rate: ::std::option::Option<f64>,
    /// The number of times your video ads were viewed.
    #[prost(message, optional, tag = "59")]
    pub video_views: ::std::option::Option<i64>,
    /// The total number of view-through conversions.
    /// These happen when a customer sees an image or rich media ad, then later
    /// completes a conversion on your site without interacting with (e.g.,
    /// clicking on) another ad.
    #[prost(message, optional, tag = "60")]
    pub view_through_conversions: ::std::option::Option<i64>,
}
...
pub struct Segments {
    ...
    #[prost(message, optional, tag = "54")]
    pub conversion_action_name: ::std::option::Option<::std::string::String>,
    ...
    pub conversion_adjustment: ::std::option::Option<bool>,
    ...
    #[prost(message, optional, tag = "65")]
    pub geo_target_airport: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents a canton.
    #[prost(message, optional, tag = "76")]
    pub geo_target_canton: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents a city.
    #[prost(message, optional, tag = "62")]
    pub geo_target_city: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents a country.
    #[prost(message, optional, tag = "77")]
    pub geo_target_country: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents a county.
    #[prost(message, optional, tag = "68")]
    pub geo_target_county: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents a district.
    #[prost(message, optional, tag = "69")]
    pub geo_target_district: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents a metro.
    #[prost(message, optional, tag = "63")]
    pub geo_target_metro: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents the most
    /// specific location.
    #[prost(message, optional, tag = "72")]
    pub geo_target_most_specific_location: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents a postal code.
    #[prost(message, optional, tag = "71")]
    pub geo_target_postal_code: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents a province.
    #[prost(message, optional, tag = "75")]
    pub geo_target_province: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents a region.
    #[prost(message, optional, tag = "64")]
    pub geo_target_region: ::std::option::Option<::std::string::String>,
    /// Resource name of the geo target constant that represents a state.
    #[prost(message, optional, tag = "67")]
    pub geo_target_state: ::std::option::Option<::std::string::String>,
    /// Hotel booking window in days.
    #[prost(message, optional, tag = "6")]
    pub hotel_booking_window_days: ::std::option::Option<i64>,
    /// Hotel center ID.
    #[prost(message, optional, tag = "7")]
    pub hotel_center_id: ::std::option::Option<i64>,
    /// Hotel check-in date. Formatted as yyyy-MM-dd.
    #[prost(message, optional, tag = "8")]
    pub hotel_check_in_date: ::std::option::Option<::std::string::String>,
    /// Hotel check-in day of week.
    #[prost(enumeration = "super::enums::day_of_week_enum::DayOfWeek", tag = "9")]
    pub hotel_check_in_day_of_week: i32,
    /// Hotel city.
    #[prost(message, optional, tag = "10")]
    pub hotel_city: ::std::option::Option<::std::string::String>,
    /// Hotel class.
    #[prost(message, optional, tag = "11")]
    pub hotel_class: ::std::option::Option<i32>,
    /// Hotel country.
    #[prost(message, optional, tag = "12")]
    pub hotel_country: ::std::option::Option<::std::string::String>,
    ...
    #[prost(message, optional, tag = "14")]
    pub hotel_length_of_stay: ::std::option::Option<i32>,
    /// Hotel rate rule ID.
    #[prost(message, optional, tag = "73")]
    pub hotel_rate_rule_id: ::std::option::Option<::std::string::String>,
    /// Hotel rate type.
    #[prost(
    ...
    /// Hotel state.
    #[prost(message, optional, tag = "15")]
    pub hotel_state: ::std::option::Option<::std::string::String>,
    ...
    #[prost(message, optional, tag = "49")]
    pub interaction_on_this_extension: ::std::option::Option<bool>,
    /// Keyword criterion.
    ...
    pub month: ::std::option::Option<::std::string::String>,
    ...
    /// Partner hotel ID.
    #[prost(message, optional, tag = "19")]
    pub partner_hotel_id: ::std::option::Option<::std::string::String>,
    ...
    #[prost(message, optional, tag = "28")]
    pub product_aggregator_id: ::std::option::Option<u64>,
    /// Bidding category (level 1) of the product.
    #[prost(message, optional, tag = "56")]
    pub product_bidding_category_level1: ::std::option::Option<::std::string::String>,
    /// Bidding category (level 2) of the product.
    #[prost(message, optional, tag = "57")]
    pub product_bidding_category_level2: ::std::option::Option<::std::string::String>,
    /// Bidding category (level 3) of the product.
    #[prost(message, optional, tag = "58")]
    pub product_bidding_category_level3: ::std::option::Option<::std::string::String>,
    /// Bidding category (level 4) of the product.
    #[prost(message, optional, tag = "59")]
    pub product_bidding_category_level4: ::std::option::Option<::std::string::String>,
    /// Bidding category (level 5) of the product.
    #[prost(message, optional, tag = "60")]
    pub product_bidding_category_level5: ::std::option::Option<::std::string::String>,
    /// Brand of the product.
    #[prost(message, optional, tag = "29")]
    pub product_brand: ::std::option::Option<::std::string::String>,
    ...
    pub product_custom_attribute0: ::std::option::Option<::std::string::String>,
    /// Custom attribute 1 of the product.
    #[prost(message, optional, tag = "35")]
    pub product_custom_attribute1: ::std::option::Option<::std::string::String>,
    /// Custom attribute 2 of the product.
    #[prost(message, optional, tag = "36")]
    pub product_custom_attribute2: ::std::option::Option<::std::string::String>,
    /// Custom attribute 3 of the product.
    #[prost(message, optional, tag = "37")]
    pub product_custom_attribute3: ::std::option::Option<::std::string::String>,
    /// Custom attribute 4 of the product.
    #[prost(message, optional, tag = "38")]
    pub product_custom_attribute4: ::std::option::Option<::std::string::String>,
    /// Item ID of the product.
    #[prost(message, optional, tag = "39")]
    pub product_item_id: ::std::option::Option<::std::string::String>,
    /// Resource name of the language constant for the language of the product.
    #[prost(message, optional, tag = "40")]
    pub product_language: ::std::option::Option<::std::string::String>,
    /// Merchant ID of the product.
    #[prost(message, optional, tag = "41")]
    pub product_merchant_id: ::std::option::Option<u64>,
    /// Store ID of the product.
    #[prost(message, optional, tag = "42")]
    pub product_store_id: ::std::option::Option<::std::string::String>,
    ...
    #[prost(message, optional, tag = "21")]
    pub quarter: ::std::option::Option<::std::string::String>,
    ...
    #[prost(message, optional, tag = "66")]
    pub webpage: ::std::option::Option<::std::string::String>,
    /// Week as defined as Monday through Sunday, and represented by the date of
    /// Monday. Formatted as yyyy-MM-dd.
    #[prost(message, optional, tag = "24")]
    pub week: ::std::option::Option<::std::string::String>,
...
pub struct Keyword {
    ...
    /// Keyword info.
    #[prost(message, optional, tag = "2")]
    pub info: ::std::option::Option<KeywordInfo>,
}
...
pub struct KeywordPlanHistoricalMetrics {
    ...
    #[prost(message, repeated, tag = "6")]
    pub monthly_search_volumes: ::std::vec::Vec<MonthlySearchVolume>,
    ...
    #[prost(message, optional, tag = "3")]
    pub competition_index: ::std::option::Option<i64>,
    /// Top of page bid low range (20th percentile) in micros for the keyword.
    #[prost(message, optional, tag = "4")]
    pub low_top_of_page_bid_micros: ::std::option::Option<i64>,
    /// Top of page bid high range (80th percentile) in micros for the keyword.
    #[prost(message, optional, tag = "5")]
    pub high_top_of_page_bid_micros: ::std::option::Option<i64>,
}
...
pub struct MonthlySearchVolume {
    ...
    /// that month.
    #[prost(message, optional, tag = "3")]
    pub monthly_searches: ::std::option::Option<i64>,
}
