...
pub mod user_data_service_client {
    ...
    #[doc = " Any uploads made to a Customer Match list via this service will be eligible"]
    #[doc = " for matching as per the customer matching process. Please see"]
    #[doc = " https://support.google.com/google-ads/answer/7474263. However, the uploads"]
    #[doc = " made via this service will not be visible under the 'Segment members' section"]
    #[doc = " for the Customer Match List in the Google Ads UI."]
    #[derive(Debug, Clone)]
