...
pub struct AuditLog {
    ...
    pub resource_location: ::std::option::Option<ResourceLocation>,
    ...
    pub resource_original_state: ::std::option::Option<::prost_types::Struct>,
...
pub struct AuthenticationInfo {
    ...
    /// name will be indicated in the `@type` property.
    #[prost(message, optional, tag = "4")]
    pub third_party_principal: ::std::option::Option<::prost_types::Struct>,
...
pub struct AuthorizationInfo {
    ...
    pub resource_attributes:
        ::std::option::Option<super::super::rpc::context::attribute_context::Resource>,
}
...
pub struct RequestMetadata {
    ...
    pub request_attributes:
        ::std::option::Option<super::super::rpc::context::attribute_context::Request>,
    ...
    pub destination_attributes:
        ::std::option::Option<super::super::rpc::context::attribute_context::Peer>,
}
...
pub struct ServiceAccountDelegationInfo {
    ...
    pub authority: ::std::option::Option<service_account_delegation_info::Authority>,
}
pub mod service_account_delegation_info {
    ...
    pub struct FirstPartyPrincipal {
        ...
        #[prost(message, optional, tag = "2")]
        pub service_metadata: ::std::option::Option<::prost_types::Struct>,
    }
    ...
    pub struct ThirdPartyPrincipal {
        ...
        pub third_party_claims: ::std::option::Option<::prost_types::Struct>,
    }
    /// Entity that creates credentials for service account and assumes its
    /// identity for authentication.
