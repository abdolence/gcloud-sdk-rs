...
pub struct GapicMetadata {
    ...
    #[prost(string, tag = "4")]
    pub proto_package: std::string::String,
    ...
    pub services:
        ::std::collections::HashMap<std::string::String, gapic_metadata::ServiceForTransport>,
}
pub mod gapic_metadata {
    ...
    pub struct ServiceForTransport {
        ...
        pub clients: ::std::collections::HashMap<std::string::String, ServiceAsClient>,
    }
    ...
    pub struct ServiceAsClient {
        ...
        #[prost(string, tag = "1")]
        pub library_client: std::string::String,
        ...
        pub rpcs: ::std::collections::HashMap<std::string::String, MethodList>,
    }
