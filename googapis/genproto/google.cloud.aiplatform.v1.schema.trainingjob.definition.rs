...
pub struct AutoMlForecastingInputs {
    ...
    pub static_columns: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    ...
    pub time_variant_past_only_columns: ::prost::alloc::vec::Vec<::prost::alloc::string::String>,
    ...
    pub time_variant_past_and_future_columns:
    ...
    pub period: ::core::option::Option<auto_ml_forecasting_inputs::Period>,
