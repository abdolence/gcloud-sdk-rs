...
pub struct StaticCardPrompt {
    ...
    pub image: ::std::option::Option<StaticImagePrompt>,
    ...
    pub button: ::std::option::Option<StaticLinkPrompt>,
}
...
pub struct StaticCollectionBrowsePrompt {
    ...
    pub items: ::std::vec::Vec<static_collection_browse_prompt::CollectionBrowseItem>,
...
pub mod static_collection_browse_prompt {
    ...
    pub struct CollectionBrowseItem {
        ...
        #[prost(message, optional, tag = "4")]
        pub image: ::std::option::Option<super::StaticImagePrompt>,
        /// Required. URI to open if the item selected.
        #[prost(message, optional, tag = "5")]
        pub open_uri_action: ::std::option::Option<super::OpenUrl>,
    }
}
...
pub struct StaticCollectionPrompt {
    ...
    pub items: ::std::vec::Vec<static_collection_prompt::CollectionItem>,
...
pub struct StaticListPrompt {
    ...
    /// Required. List items.
    #[prost(message, repeated, tag = "3")]
    pub items: ::std::vec::Vec<static_list_prompt::ListItem>,
}
...
pub struct StaticContentPrompt {
    ...
    pub content: ::std::option::Option<static_content_prompt::Content>,
}
...
pub struct StaticSimplePrompt {
    ...
    #[prost(message, repeated, tag = "1")]
    pub variants: ::std::vec::Vec<static_simple_prompt::Variant>,
}
...
pub struct StaticPrompt {
    ...
    #[prost(message, repeated, tag = "1")]
    pub candidates: ::std::vec::Vec<static_prompt::StaticPromptCandidate>,
}
pub mod static_prompt {
    ...
    pub struct StaticPromptCandidate {
        ...
        pub selector: ::std::option::Option<Selector>,
        /// The prompt response associated with the selector.
        #[prost(message, optional, tag = "2")]
        pub prompt_response: ::std::option::Option<static_prompt_candidate::StaticPromptResponse>,
    }
    pub mod static_prompt_candidate {
        ...
        pub struct StaticPromptResponse {
            ...
            #[prost(message, optional, tag = "2")]
            pub first_simple: ::std::option::Option<super::super::StaticSimplePrompt>,
            /// Optional. A content like a card, list or media to display to the user.
            #[prost(message, optional, tag = "3")]
            pub content: ::std::option::Option<super::super::StaticContentPrompt>,
            /// Optional. The last voice and text-only response.
            #[prost(message, optional, tag = "4")]
            pub last_simple: ::std::option::Option<super::super::StaticSimplePrompt>,
            ...
            #[prost(message, repeated, tag = "5")]
            pub suggestions: ::std::vec::Vec<super::super::Suggestion>,
            ...
            #[prost(message, optional, tag = "6")]
            pub link: ::std::option::Option<super::super::StaticLinkPrompt>,
            ...
            pub canvas: ::std::option::Option<super::super::StaticCanvasPrompt>,
        }
    }
    ...
    pub struct Selector {
        ...
        #[prost(message, optional, tag = "1")]
        pub surface_capabilities: ::std::option::Option<super::SurfaceCapabilities>,
    }
}
