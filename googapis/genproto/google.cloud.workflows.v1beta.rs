...
pub struct Workflow {
    ...
    pub revision_create_time: ::std::option::Option<::prost_types::Timestamp>,
    ...
    pub source_code: ::std::option::Option<workflow::SourceCode>,
}
pub mod workflow {
...
pub struct CreateWorkflowRequest {
    ...
    pub workflow: ::std::option::Option<Workflow>,
...
pub mod workflows_client {
    ...
    impl<T> std::fmt::Debug for WorkflowsClient<T> {
        fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
            write!(f, "WorkflowsClient {{ ... }}")
        }
    }
}
